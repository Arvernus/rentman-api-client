...
T = TypeVar("T", bound="MateriaalCatCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class MateriaalCatCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        materiaal_cat_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_cat_collectionpost_response_schema_data_item.additional_properties = d
