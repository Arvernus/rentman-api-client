...
T = TypeVar("T", bound="AccessoireCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class AccessoireCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        accessoire_collectionget_response_schema_data_item.additional_properties = d
