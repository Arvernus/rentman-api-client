...
T = TypeVar("T", bound="AccessoireCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class AccessoireCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        accessoire_collectionput_response_schema_data_item.additional_properties = d
        return accessoire_collectionput_response_schema_data_item
