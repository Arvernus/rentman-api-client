...
from ..models.cost_itemput_response_schema_data_custom import CostItemputResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CostItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class CostItemputResponseSchemaData:
    ...
    custom: Union[Unset, CostItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = CostItemputResponseSchemaDataCustom.from_dict(_custom)

        cost_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        cost_itemput_response_schema_data.additional_properties = d
        return cost_itemput_response_schema_data
