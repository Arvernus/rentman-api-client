...
T = TypeVar("T", bound="FactuurItempostRequestSchema")


@attr.s(auto_attribs=True)
class FactuurItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factuur_itempost_request_schema = cls(
            customer=customer,
        ...
        factuur_itempost_request_schema.additional_properties = d
        return factuur_itempost_request_schema
