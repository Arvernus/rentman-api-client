...
T = TypeVar("T", bound="InhuurmateriaalItemputRequestSchema")


@attr.s(auto_attribs=True)
class InhuurmateriaalItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_itemput_request_schema = cls(
            equipment=equipment,
            parent=parent,
        ...
        inhuurmateriaal_itemput_request_schema.additional_properties = d
        return inhuurmateriaal_itemput_request_schema
