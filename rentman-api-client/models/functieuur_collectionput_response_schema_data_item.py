...
T = TypeVar("T", bound="FunctieuurCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FunctieuurCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        functieuur_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        functieuur_collectionput_response_schema_data_item.additional_properties = d
