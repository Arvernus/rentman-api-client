...
T = TypeVar("T", bound="RateFactorItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class RateFactorItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rate_factor_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        rate_factor_itempost_response_schema_data.additional_properties = d
        return rate_factor_itempost_response_schema_data
