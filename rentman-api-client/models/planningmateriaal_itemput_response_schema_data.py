...
from ..models.planningmateriaal_itemput_response_schema_data_custom import (
    PlanningmateriaalItemputResponseSchemaDataCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningmateriaalItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class PlanningmateriaalItemputResponseSchemaData:
    ...
    custom: Union[Unset, PlanningmateriaalItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningmateriaalItemputResponseSchemaDataCustom.from_dict(_custom)

        planningmateriaal_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningmateriaal_itemput_response_schema_data.additional_properties = d
        return planningmateriaal_itemput_response_schema_data
