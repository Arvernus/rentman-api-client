...
from ..models.setinhoud_collectionpost_response_schema_data_item_is_fixed import (
    SetinhoudCollectionpostResponseSchemaDataItemIsFixed,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetinhoudCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class SetinhoudCollectionpostResponseSchemaDataItem:
    """ """
    ...
    is_fixed: Union[Unset, SetinhoudCollectionpostResponseSchemaDataItemIsFixed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_fixed, Unset):
            is_fixed = SetinhoudCollectionpostResponseSchemaDataItemIsFixed(_is_fixed)

        setinhoud_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        setinhoud_collectionpost_response_schema_data_item.additional_properties = d
        return setinhoud_collectionpost_response_schema_data_item
