...
T = TypeVar("T", bound="AfspraakmedewerkerItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class AfspraakmedewerkerItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        afspraakmedewerker_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        afspraakmedewerker_itemput_response_schema_data.additional_properties = d
