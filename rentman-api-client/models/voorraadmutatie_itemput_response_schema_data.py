...
T = TypeVar("T", bound="VoorraadmutatieItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class VoorraadmutatieItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voorraadmutatie_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voorraadmutatie_itemput_response_schema_data.additional_properties = d
