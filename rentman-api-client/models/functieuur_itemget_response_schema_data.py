...
T = TypeVar("T", bound="FunctieuurItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class FunctieuurItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        functieuur_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        functieuur_itemget_response_schema_data.additional_properties = d
