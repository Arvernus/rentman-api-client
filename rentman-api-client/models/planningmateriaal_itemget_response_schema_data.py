...
from ..models.planningmateriaal_itemget_response_schema_data_custom import (
    PlanningmateriaalItemgetResponseSchemaDataCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningmateriaalItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class PlanningmateriaalItemgetResponseSchemaData:
    ...
    custom: Union[Unset, PlanningmateriaalItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningmateriaalItemgetResponseSchemaDataCustom.from_dict(_custom)

        planningmateriaal_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningmateriaal_itemget_response_schema_data.additional_properties = d
        return planningmateriaal_itemget_response_schema_data
