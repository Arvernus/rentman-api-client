...
from ..models.medewerker_itemget_request_schema_country import MedewerkerItemgetRequestSchemaCountry
from ..models.medewerker_itemget_request_schema_custom import MedewerkerItemgetRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="MedewerkerItemgetRequestSchema")


@attr.s(auto_attribs=True)
class MedewerkerItemgetRequestSchema:
    """ """
    ...
    country: Union[Unset, MedewerkerItemgetRequestSchemaCountry] = UNSET
    ...
    custom: Union[Unset, MedewerkerItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = MedewerkerItemgetRequestSchemaCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = MedewerkerItemgetRequestSchemaCustom.from_dict(_custom)

        medewerker_itemget_request_schema = cls(
            folder=folder,
            street=street,
        ...
        medewerker_itemget_request_schema.additional_properties = d
        return medewerker_itemget_request_schema
