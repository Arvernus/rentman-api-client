...
T = TypeVar("T", bound="AfspraakmedewerkerCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class AfspraakmedewerkerCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        afspraakmedewerker_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        afspraakmedewerker_collectionput_response_schema_data_item.additional_properties = d
