...
from ..models.exemplaar_itemget_request_schema_custom import ExemplaarItemgetRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExemplaarItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ExemplaarItemgetRequestSchema:
    """ """
    ...
    custom: Union[Unset, ExemplaarItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ExemplaarItemgetRequestSchemaCustom.from_dict(_custom)

        exemplaar_itemget_request_schema = cls(
            serial=serial,
        ...
        exemplaar_itemget_request_schema.additional_properties = d
        return exemplaar_itemget_request_schema
