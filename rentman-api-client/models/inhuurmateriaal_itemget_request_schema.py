...
T = TypeVar("T", bound="InhuurmateriaalItemgetRequestSchema")


@attr.s(auto_attribs=True)
class InhuurmateriaalItemgetRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_itemget_request_schema = cls(
            equipment=equipment,
            parent=parent,
        ...
        inhuurmateriaal_itemget_request_schema.additional_properties = d
        return inhuurmateriaal_itemget_request_schema
