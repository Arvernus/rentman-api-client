...
T = TypeVar("T", bound="OfferteCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class OfferteCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        offerte_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        offerte_collectionget_response_schema_data_item.additional_properties = d
        return offerte_collectionget_response_schema_data_item
