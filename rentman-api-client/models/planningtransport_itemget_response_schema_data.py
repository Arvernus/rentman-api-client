...
from ..models.planningtransport_itemget_response_schema_data_custom import (
    PlanningtransportItemgetResponseSchemaDataCustom,
)
from ..models.planningtransport_itemget_response_schema_data_transport import (
    PlanningtransportItemgetResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningtransportItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class PlanningtransportItemgetResponseSchemaData:
    ...
    transport: Union[Unset, PlanningtransportItemgetResponseSchemaDataTransport] = UNSET
    ...
    custom: Union[Unset, PlanningtransportItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningtransportItemgetResponseSchemaDataTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningtransportItemgetResponseSchemaDataCustom.from_dict(_custom)

        planningtransport_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningtransport_itemget_response_schema_data.additional_properties = d
        return planningtransport_itemget_response_schema_data
