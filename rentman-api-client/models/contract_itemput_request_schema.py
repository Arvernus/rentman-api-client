...
T = TypeVar("T", bound="ContractItemputRequestSchema")


@attr.s(auto_attribs=True)
class ContractItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_itemput_request_schema = cls(
            number=number,
            customer=customer,
            contact=contact,
            date=date,
        ...
        contract_itemput_request_schema.additional_properties = d
        return contract_itemput_request_schema
