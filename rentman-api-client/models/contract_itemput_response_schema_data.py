...
T = TypeVar("T", bound="ContractItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class ContractItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        contract_itemput_response_schema_data.additional_properties = d
        return contract_itemput_response_schema_data
