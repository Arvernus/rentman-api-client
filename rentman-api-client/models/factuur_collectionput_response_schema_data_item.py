...
T = TypeVar("T", bound="FactuurCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FactuurCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factuur_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        factuur_collectionput_response_schema_data_item.additional_properties = d
        return factuur_collectionput_response_schema_data_item
