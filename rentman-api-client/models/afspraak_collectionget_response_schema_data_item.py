...
from ..models.afspraak_collectionget_response_schema_data_item_recurrence_interval_unit import (
    AfspraakCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AfspraakCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class AfspraakCollectiongetResponseSchemaDataItem:
    """ """
    ...
    recurrence_interval_unit: Union[Unset, AfspraakCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        recurrence_interval_unit: Union[
            Unset, AfspraakCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit
        ] = UNSET
        _recurrence_interval_unit = d.pop("recurrence_interval_unit", UNSET)
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = AfspraakCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit(
        ...
        afspraak_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        afspraak_collectionget_response_schema_data_item.additional_properties = d
        return afspraak_collectionget_response_schema_data_item
