...
T = TypeVar("T", bound="OfferteItemputRequestSchema")


@attr.s(auto_attribs=True)
class OfferteItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        offerte_itemput_request_schema = cls(
            number=number,
            customer=customer,
            contact=contact,
            date=date,
        ...
        offerte_itemput_request_schema.additional_properties = d
        return offerte_itemput_request_schema
