...
T = TypeVar("T", bound="RateFactorItemgetRequestSchema")


@attr.s(auto_attribs=True)
class RateFactorItemgetRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rate_factor_itemget_request_schema = cls(
            from_=from_,
            to=to,
            variable=variable,
            fixed=fixed,
        ...
        rate_factor_itemget_request_schema.additional_properties = d
        return rate_factor_itemget_request_schema
