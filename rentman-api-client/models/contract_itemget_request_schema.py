...
T = TypeVar("T", bound="ContractItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ContractItemgetRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_itemget_request_schema = cls(
            number=number,
            customer=customer,
            contact=contact,
            date=date,
        ...
        contract_itemget_request_schema.additional_properties = d
        return contract_itemget_request_schema
