...
from ..models.exemplaar_itemget_response_schema_data_custom import ExemplaarItemgetResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExemplaarItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ExemplaarItemgetResponseSchemaData:
    ...
    custom: Union[Unset, ExemplaarItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ExemplaarItemgetResponseSchemaDataCustom.from_dict(_custom)

        exemplaar_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        exemplaar_itemget_response_schema_data.additional_properties = d
