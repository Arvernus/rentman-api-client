...
T = TypeVar("T", bound="FactuurItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class FactuurItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factuur_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        factuur_itempost_response_schema_data.additional_properties = d
        return factuur_itempost_response_schema_data
