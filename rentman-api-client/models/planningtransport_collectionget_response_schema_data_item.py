...
from ..models.planningtransport_collectionget_response_schema_data_item_custom import (
    PlanningtransportCollectiongetResponseSchemaDataItemCustom,
)
from ..models.planningtransport_collectionget_response_schema_data_item_transport import (
    PlanningtransportCollectiongetResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningtransportCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PlanningtransportCollectiongetResponseSchemaDataItem:
    """ """
    ...
    transport: Union[Unset, PlanningtransportCollectiongetResponseSchemaDataItemTransport] = UNSET
    ...
    custom: Union[Unset, PlanningtransportCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningtransportCollectiongetResponseSchemaDataItemTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningtransportCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        planningtransport_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningtransport_collectionget_response_schema_data_item.additional_properties = d
        return planningtransport_collectionget_response_schema_data_item
