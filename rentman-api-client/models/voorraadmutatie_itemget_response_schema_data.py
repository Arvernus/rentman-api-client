...
from ..models.voorraadmutatie_itemget_response_schema_data_type import VoorraadmutatieItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoorraadmutatieItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class VoorraadmutatieItemgetResponseSchemaData:
    ...
    type: Union[Unset, VoorraadmutatieItemgetResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = VoorraadmutatieItemgetResponseSchemaDataType(_type)

        stock_location = d.pop("stock_location", UNSET)

        voorraadmutatie_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voorraadmutatie_itemget_response_schema_data.additional_properties = d
        return voorraadmutatie_itemget_response_schema_data
