...
T = TypeVar("T", bound="InhuurmateriaalCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InhuurmateriaalCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurmateriaal_collectionput_response_schema_data_item.additional_properties = d
        return inhuurmateriaal_collectionput_response_schema_data_item
