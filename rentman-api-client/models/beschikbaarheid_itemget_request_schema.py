...
from ..models.beschikbaarheid_itemget_request_schema_recurrence_interval_unit import (
    BeschikbaarheidItemgetRequestSchemaRecurrenceIntervalUnit,
)
from ..models.beschikbaarheid_itemget_request_schema_status import BeschikbaarheidItemgetRequestSchemaStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="BeschikbaarheidItemgetRequestSchema")


@attr.s(auto_attribs=True)
class BeschikbaarheidItemgetRequestSchema:
    """ """
    ...
    status: Union[Unset, BeschikbaarheidItemgetRequestSchemaStatus] = UNSET
    remark: Union[Unset, str] = UNSET
    recurrence_interval_unit: Union[Unset, BeschikbaarheidItemgetRequestSchemaRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = BeschikbaarheidItemgetRequestSchemaStatus(_status)
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = BeschikbaarheidItemgetRequestSchemaRecurrenceIntervalUnit(
        ...
        beschikbaarheid_itemget_request_schema = cls(
        ...
        beschikbaarheid_itemget_request_schema.additional_properties = d
