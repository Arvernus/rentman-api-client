...
from ..models.uren_collectionpost_response_schema_data_item_custom import UrenCollectionpostResponseSchemaDataItemCustom
from ..models.uren_collectionpost_response_schema_data_item_type import UrenCollectionpostResponseSchemaDataItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UrenCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class UrenCollectionpostResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, UrenCollectionpostResponseSchemaDataItemType] = UNSET
    ...
    custom: Union[Unset, UrenCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = UrenCollectionpostResponseSchemaDataItemType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = UrenCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        uren_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        uren_collectionpost_response_schema_data_item.additional_properties = d
        return uren_collectionpost_response_schema_data_item
