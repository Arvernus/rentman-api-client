...
from ..models.uren_itempost_response_schema_data_custom import UrenItempostResponseSchemaDataCustom
from ..models.uren_itempost_response_schema_data_type import UrenItempostResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UrenItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class UrenItempostResponseSchemaData:
    ...
    type: Union[Unset, UrenItempostResponseSchemaDataType] = UNSET
    ...
    custom: Union[Unset, UrenItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = UrenItempostResponseSchemaDataType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = UrenItempostResponseSchemaDataCustom.from_dict(_custom)

        uren_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        uren_itempost_response_schema_data.additional_properties = d
        return uren_itempost_response_schema_data
