...
from ..models.medewerker_collectionput_response_schema_data_item_country import (
    MedewerkerCollectionputResponseSchemaDataItemCountry,
)
from ..models.medewerker_collectionput_response_schema_data_item_custom import (
    MedewerkerCollectionputResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MedewerkerCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class MedewerkerCollectionputResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, MedewerkerCollectionputResponseSchemaDataItemCountry] = UNSET
    ...
    custom: Union[Unset, MedewerkerCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = MedewerkerCollectionputResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = MedewerkerCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        medewerker_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        medewerker_collectionput_response_schema_data_item.additional_properties = d
        return medewerker_collectionput_response_schema_data_item
