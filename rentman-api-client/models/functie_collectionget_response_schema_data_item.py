...
from ..models.functie_collectionget_response_schema_data_item_custom import (
    FunctieCollectiongetResponseSchemaDataItemCustom,
)
from ..models.functie_collectionget_response_schema_data_item_planperiod_end_schedule_is_start import (
    FunctieCollectiongetResponseSchemaDataItemPlanperiodEndScheduleIsStart,
)
from ..models.functie_collectionget_response_schema_data_item_planperiod_start_schedule_is_start import (
    FunctieCollectiongetResponseSchemaDataItemPlanperiodStartScheduleIsStart,
)
from ..models.functie_collectionget_response_schema_data_item_type import FunctieCollectiongetResponseSchemaDataItemType
from ..models.functie_collectionget_response_schema_data_item_usageperiod_end_schedule_is_start import (
    FunctieCollectiongetResponseSchemaDataItemUsageperiodEndScheduleIsStart,
)
from ..models.functie_collectionget_response_schema_data_item_usageperiod_start_schedule_is_start import (
    FunctieCollectiongetResponseSchemaDataItemUsageperiodStartScheduleIsStart,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FunctieCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FunctieCollectiongetResponseSchemaDataItem:
    """ """
    ...
    planperiod_start_schedule_is_start: Union[
        Unset, FunctieCollectiongetResponseSchemaDataItemPlanperiodStartScheduleIsStart
    ] = UNSET
    usageperiod_start_schedule_is_start: Union[
        Unset, FunctieCollectiongetResponseSchemaDataItemUsageperiodStartScheduleIsStart
    ] = UNSET
    planperiod_end_schedule_is_start: Union[
        Unset, FunctieCollectiongetResponseSchemaDataItemPlanperiodEndScheduleIsStart
    ] = UNSET
    usageperiod_end_schedule_is_start: Union[
        Unset, FunctieCollectiongetResponseSchemaDataItemUsageperiodEndScheduleIsStart
    ] = UNSET
    ...
    type: Union[Unset, FunctieCollectiongetResponseSchemaDataItemType] = UNSET
    ...
    custom: Union[Unset, FunctieCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_planperiod_end_schedule_is_start, Unset):
            planperiod_end_schedule_is_start = FunctieCollectiongetResponseSchemaDataItemPlanperiodEndScheduleIsStart(
        ...
        if not isinstance(_usageperiod_end_schedule_is_start, Unset):
            usageperiod_end_schedule_is_start = FunctieCollectiongetResponseSchemaDataItemUsageperiodEndScheduleIsStart(
        ...
        if not isinstance(_type, Unset):
            type = FunctieCollectiongetResponseSchemaDataItemType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = FunctieCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        functie_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        functie_collectionget_response_schema_data_item.additional_properties = d
