...
from ..models.setinhoud_itempost_response_schema_data_is_fixed import SetinhoudItempostResponseSchemaDataIsFixed
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetinhoudItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class SetinhoudItempostResponseSchemaData:
    ...
    is_fixed: Union[Unset, SetinhoudItempostResponseSchemaDataIsFixed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_fixed, Unset):
            is_fixed = SetinhoudItempostResponseSchemaDataIsFixed(_is_fixed)

        setinhoud_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        setinhoud_itempost_response_schema_data.additional_properties = d
        return setinhoud_itempost_response_schema_data
