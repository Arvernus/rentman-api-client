...
T = TypeVar("T", bound="OfferteCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class OfferteCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        offerte_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        offerte_collectionput_response_schema_data_item.additional_properties = d
        return offerte_collectionput_response_schema_data_item
