...
T = TypeVar("T", bound="AfspraakItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class AfspraakItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        afspraak_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        afspraak_itempost_response_schema_data.additional_properties = d
        return afspraak_itempost_response_schema_data
