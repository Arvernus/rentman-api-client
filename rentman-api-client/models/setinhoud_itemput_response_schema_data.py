...
from ..models.setinhoud_itemput_response_schema_data_is_fixed import SetinhoudItemputResponseSchemaDataIsFixed
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetinhoudItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class SetinhoudItemputResponseSchemaData:
    ...
    is_fixed: Union[Unset, SetinhoudItemputResponseSchemaDataIsFixed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_fixed, Unset):
            is_fixed = SetinhoudItemputResponseSchemaDataIsFixed(_is_fixed)

        setinhoud_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        setinhoud_itemput_response_schema_data.additional_properties = d
