...
from ..models.medewerker_collectionpost_response_schema_data_item_country import (
    MedewerkerCollectionpostResponseSchemaDataItemCountry,
)
from ..models.medewerker_collectionpost_response_schema_data_item_custom import (
    MedewerkerCollectionpostResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MedewerkerCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class MedewerkerCollectionpostResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, MedewerkerCollectionpostResponseSchemaDataItemCountry] = UNSET
    ...
    custom: Union[Unset, MedewerkerCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = MedewerkerCollectionpostResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = MedewerkerCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        medewerker_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        medewerker_collectionpost_response_schema_data_item.additional_properties = d
        return medewerker_collectionpost_response_schema_data_item
