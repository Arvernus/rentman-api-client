...
T = TypeVar("T", bound="InhuurgroepItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class InhuurgroepItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurgroep_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurgroep_itemget_response_schema_data.additional_properties = d
