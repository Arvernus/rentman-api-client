...
from ..models.asset_location_itemget_request_schema_country import AssetLocationItemgetRequestSchemaCountry
from ..models.asset_location_itemget_request_schema_type import AssetLocationItemgetRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssetLocationItemgetRequestSchema")


@attr.s(auto_attribs=True)
class AssetLocationItemgetRequestSchema:
    """ """
    ...
    country: Union[Unset, AssetLocationItemgetRequestSchemaCountry] = UNSET
    active: Union[Unset, bool] = UNSET
    type: Union[Unset, AssetLocationItemgetRequestSchemaType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = AssetLocationItemgetRequestSchemaCountry(_country)
        ...
        if not isinstance(_type, Unset):
            type = AssetLocationItemgetRequestSchemaType(_type)

        color = d.pop("color", UNSET)

        in_archive = d.pop("in_archive", UNSET)

        asset_location_itemget_request_schema = cls(
            name=name,
            city=city,
            street=street,
