...
from ..models.reparatie_itemput_request_schema_custom import ReparatieItemputRequestSchemaCustom
from ..models.reparatie_itemput_request_schema_is_usable import ReparatieItemputRequestSchemaIsUsable
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReparatieItemputRequestSchema")


@attr.s(auto_attribs=True)
class ReparatieItemputRequestSchema:
    """ """
    ...
    is_usable: Union[Unset, ReparatieItemputRequestSchemaIsUsable] = UNSET
    ...
    custom: Union[Unset, ReparatieItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = ReparatieItemputRequestSchemaIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = ReparatieItemputRequestSchemaCustom.from_dict(_custom)

        reparatie_itemput_request_schema = cls(
        ...
        reparatie_itemput_request_schema.additional_properties = d
        return reparatie_itemput_request_schema
