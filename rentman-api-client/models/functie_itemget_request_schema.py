...
from ..models.functie_itemget_request_schema_custom import FunctieItemgetRequestSchemaCustom
from ..models.functie_itemget_request_schema_planperiod_end_schedule_is_start import (
    FunctieItemgetRequestSchemaPlanperiodEndScheduleIsStart,
)
from ..models.functie_itemget_request_schema_planperiod_start_schedule_is_start import (
    FunctieItemgetRequestSchemaPlanperiodStartScheduleIsStart,
)
from ..models.functie_itemget_request_schema_type import FunctieItemgetRequestSchemaType
from ..models.functie_itemget_request_schema_usageperiod_end_schedule_is_start import (
    FunctieItemgetRequestSchemaUsageperiodEndScheduleIsStart,
)
from ..models.functie_itemget_request_schema_usageperiod_start_schedule_is_start import (
    FunctieItemgetRequestSchemaUsageperiodStartScheduleIsStart,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FunctieItemgetRequestSchema")


@attr.s(auto_attribs=True)
class FunctieItemgetRequestSchema:
    """ """
    ...
    planperiod_start_schedule_is_start: Union[Unset, FunctieItemgetRequestSchemaPlanperiodStartScheduleIsStart] = UNSET
    usageperiod_start_schedule_is_start: Union[
        Unset, FunctieItemgetRequestSchemaUsageperiodStartScheduleIsStart
    ] = UNSET
    planperiod_end_schedule_is_start: Union[Unset, FunctieItemgetRequestSchemaPlanperiodEndScheduleIsStart] = UNSET
    usageperiod_end_schedule_is_start: Union[Unset, FunctieItemgetRequestSchemaUsageperiodEndScheduleIsStart] = UNSET
    ...
    type: Union[Unset, FunctieItemgetRequestSchemaType] = UNSET
    ...
    custom: Union[Unset, FunctieItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        planperiod_start_schedule_is_start: Union[
            Unset, FunctieItemgetRequestSchemaPlanperiodStartScheduleIsStart
        ] = UNSET
        ...
        if not isinstance(_planperiod_start_schedule_is_start, Unset):
            planperiod_start_schedule_is_start = FunctieItemgetRequestSchemaPlanperiodStartScheduleIsStart(
        ...
        if not isinstance(_usageperiod_start_schedule_is_start, Unset):
            usageperiod_start_schedule_is_start = FunctieItemgetRequestSchemaUsageperiodStartScheduleIsStart(
        ...
        if not isinstance(_planperiod_end_schedule_is_start, Unset):
            planperiod_end_schedule_is_start = FunctieItemgetRequestSchemaPlanperiodEndScheduleIsStart(
                _planperiod_end_schedule_is_start
            )

        usageperiod_end_schedule_is_start: Union[
            Unset, FunctieItemgetRequestSchemaUsageperiodEndScheduleIsStart
        ] = UNSET
        ...
        if not isinstance(_usageperiod_end_schedule_is_start, Unset):
            usageperiod_end_schedule_is_start = FunctieItemgetRequestSchemaUsageperiodEndScheduleIsStart(
        ...
        if not isinstance(_type, Unset):
            type = FunctieItemgetRequestSchemaType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = FunctieItemgetRequestSchemaCustom.from_dict(_custom)

        functie_itemget_request_schema = cls(
            cost_rate=cost_rate,
            price_rate=price_rate,
            subproject=subproject,
        ...
        functie_itemget_request_schema.additional_properties = d
