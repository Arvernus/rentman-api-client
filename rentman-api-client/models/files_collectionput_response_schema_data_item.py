...
from ..models.files_collectionput_response_schema_data_item_previewstatus import (
    FilesCollectionputResponseSchemaDataItemPreviewstatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FilesCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FilesCollectionputResponseSchemaDataItem:
    """ """
    ...
    previewstatus: Union[Unset, FilesCollectionputResponseSchemaDataItemPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FilesCollectionputResponseSchemaDataItemPreviewstatus(_previewstatus)
        ...
        files_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        files_collectionput_response_schema_data_item.additional_properties = d
        return files_collectionput_response_schema_data_item
