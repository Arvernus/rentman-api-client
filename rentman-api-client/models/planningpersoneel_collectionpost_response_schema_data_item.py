...
from ..models.planningpersoneel_collectionpost_response_schema_data_item_custom import (
    PlanningpersoneelCollectionpostResponseSchemaDataItemCustom,
)
from ..models.planningpersoneel_collectionpost_response_schema_data_item_transport import (
    PlanningpersoneelCollectionpostResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningpersoneelCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PlanningpersoneelCollectionpostResponseSchemaDataItem:
    """ """
    ...
    transport: Union[Unset, PlanningpersoneelCollectionpostResponseSchemaDataItemTransport] = UNSET
    ...
    custom: Union[Unset, PlanningpersoneelCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningpersoneelCollectionpostResponseSchemaDataItemTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningpersoneelCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        planningpersoneel_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningpersoneel_collectionpost_response_schema_data_item.additional_properties = d
        return planningpersoneel_collectionpost_response_schema_data_item
