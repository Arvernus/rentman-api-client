...
T = TypeVar("T", bound="BtwbedragItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class BtwbedragItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        btwbedrag_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        btwbedrag_itemput_response_schema_data.additional_properties = d
        return btwbedrag_itemput_response_schema_data
