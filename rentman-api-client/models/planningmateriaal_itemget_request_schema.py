...
from ..models.planningmateriaal_itemget_request_schema_custom import PlanningmateriaalItemgetRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningmateriaalItemgetRequestSchema")


@attr.s(auto_attribs=True)
class PlanningmateriaalItemgetRequestSchema:
    """ """
    ...
    custom: Union[Unset, PlanningmateriaalItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningmateriaalItemgetRequestSchemaCustom.from_dict(_custom)

        planningmateriaal_itemget_request_schema = cls(
            equipment=equipment,
            parent=parent,
            ledger=ledger,
            quantity=quantity,
        ...
        planningmateriaal_itemget_request_schema.additional_properties = d
