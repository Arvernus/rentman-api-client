...
from ..models.files_itemput_request_schema_previewstatus import FilesItemputRequestSchemaPreviewstatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="FilesItemputRequestSchema")


@attr.s(auto_attribs=True)
class FilesItemputRequestSchema:
    """ """
    ...
    previewstatus: Union[Unset, FilesItemputRequestSchemaPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FilesItemputRequestSchemaPreviewstatus(_previewstatus)

        file_item = d.pop("file_item", UNSET)

        file_itemtype = d.pop("file_itemtype", UNSET)

        files_itemput_request_schema = cls(
        ...
        files_itemput_request_schema.additional_properties = d
        return files_itemput_request_schema
