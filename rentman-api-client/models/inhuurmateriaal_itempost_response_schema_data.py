...
T = TypeVar("T", bound="InhuurmateriaalItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class InhuurmateriaalItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurmateriaal_itempost_response_schema_data.additional_properties = d
        return inhuurmateriaal_itempost_response_schema_data
