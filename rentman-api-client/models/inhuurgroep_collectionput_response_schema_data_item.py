...
T = TypeVar("T", bound="InhuurgroepCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InhuurgroepCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurgroep_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurgroep_collectionput_response_schema_data_item.additional_properties = d
