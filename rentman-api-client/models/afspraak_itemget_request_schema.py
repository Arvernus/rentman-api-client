...
from ..models.afspraak_itemget_request_schema_recurrence_interval_unit import (
    AfspraakItemgetRequestSchemaRecurrenceIntervalUnit,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AfspraakItemgetRequestSchema")


@attr.s(auto_attribs=True)
class AfspraakItemgetRequestSchema:
    """ """
    ...
    recurrence_interval_unit: Union[Unset, AfspraakItemgetRequestSchemaRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = AfspraakItemgetRequestSchemaRecurrenceIntervalUnit(_recurrence_interval_unit)
        ...
        afspraak_itemget_request_schema = cls(
            start=start,
            end=end,
            name=name,
            color=color,
        ...
        afspraak_itemget_request_schema.additional_properties = d
        return afspraak_itemget_request_schema
