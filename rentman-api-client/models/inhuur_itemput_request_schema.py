...
from ..models.inhuur_itemput_request_schema_custom import InhuurItemputRequestSchemaCustom
from ..models.inhuur_itemput_request_schema_type import InhuurItemputRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="InhuurItemputRequestSchema")


@attr.s(auto_attribs=True)
class InhuurItemputRequestSchema:
    """ """
    ...
    type: Union[Unset, InhuurItemputRequestSchemaType] = UNSET
    ...
    custom: Union[Unset, InhuurItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = InhuurItemputRequestSchemaType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = InhuurItemputRequestSchemaCustom.from_dict(_custom)

        inhuur_itemput_request_schema = cls(
            name=name,
        ...
        inhuur_itemput_request_schema.additional_properties = d
        return inhuur_itemput_request_schema
