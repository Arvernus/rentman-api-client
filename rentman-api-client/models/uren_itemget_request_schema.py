...
from ..models.uren_itemget_request_schema_custom import UrenItemgetRequestSchemaCustom
from ..models.uren_itemget_request_schema_type import UrenItemgetRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UrenItemgetRequestSchema")


@attr.s(auto_attribs=True)
class UrenItemgetRequestSchema:
    """ """
    ...
    type: Union[Unset, UrenItemgetRequestSchemaType] = UNSET
    ...
    custom: Union[Unset, UrenItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = UrenItemgetRequestSchemaType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = UrenItemgetRequestSchemaCustom.from_dict(_custom)

        uren_itemget_request_schema = cls(
        ...
        uren_itemget_request_schema.additional_properties = d
        return uren_itemget_request_schema
