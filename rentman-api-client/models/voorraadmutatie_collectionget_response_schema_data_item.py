...
from ..models.voorraadmutatie_collectionget_response_schema_data_item_type import (
    VoorraadmutatieCollectiongetResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoorraadmutatieCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class VoorraadmutatieCollectiongetResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, VoorraadmutatieCollectiongetResponseSchemaDataItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = VoorraadmutatieCollectiongetResponseSchemaDataItemType(_type)

        stock_location = d.pop("stock_location", UNSET)

        voorraadmutatie_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voorraadmutatie_collectionget_response_schema_data_item.additional_properties = d
