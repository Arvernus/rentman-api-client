...
from ..models.materiaal_itemget_request_schema_country_of_origin import MateriaalItemgetRequestSchemaCountryOfOrigin
from ..models.materiaal_itemget_request_schema_custom import MateriaalItemgetRequestSchemaCustom
from ..models.materiaal_itemget_request_schema_is_physical import MateriaalItemgetRequestSchemaIsPhysical
from ..models.materiaal_itemget_request_schema_rental_sales import MateriaalItemgetRequestSchemaRentalSales
from ..models.materiaal_itemget_request_schema_stock_management import MateriaalItemgetRequestSchemaStockManagement
from ..models.materiaal_itemget_request_schema_type import MateriaalItemgetRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="MateriaalItemgetRequestSchema")


@attr.s(auto_attribs=True)
class MateriaalItemgetRequestSchema:
    """ """
    ...
    type: Union[Unset, MateriaalItemgetRequestSchemaType] = UNSET
    rental_sales: Union[Unset, MateriaalItemgetRequestSchemaRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, MateriaalItemgetRequestSchemaStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, MateriaalItemgetRequestSchemaCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, MateriaalItemgetRequestSchemaIsPhysical] = UNSET
    ...
    custom: Union[Unset, MateriaalItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = MateriaalItemgetRequestSchemaType(_type)

        rental_sales: Union[Unset, MateriaalItemgetRequestSchemaRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = MateriaalItemgetRequestSchemaRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = MateriaalItemgetRequestSchemaStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = MateriaalItemgetRequestSchemaCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = MateriaalItemgetRequestSchemaIsPhysical(_is_physical)
        ...
        if not isinstance(_custom, Unset):
            custom = MateriaalItemgetRequestSchemaCustom.from_dict(_custom)

        materiaal_itemget_request_schema = cls(
            folder=folder,
            code=code,
            name=name,
        ...
        materiaal_itemget_request_schema.additional_properties = d
        return materiaal_itemget_request_schema
