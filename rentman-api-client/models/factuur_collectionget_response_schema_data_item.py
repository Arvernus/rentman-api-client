...
T = TypeVar("T", bound="FactuurCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FactuurCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factuur_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        factuur_collectionget_response_schema_data_item.additional_properties = d
