...
T = TypeVar("T", bound="ContractCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ContractCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        contract_collectionget_response_schema_data_item.additional_properties = d
        return contract_collectionget_response_schema_data_item
