...
from ..models.medewerker_collectionget_response_schema_data_item_country import (
    MedewerkerCollectiongetResponseSchemaDataItemCountry,
)
from ..models.medewerker_collectionget_response_schema_data_item_custom import (
    MedewerkerCollectiongetResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MedewerkerCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class MedewerkerCollectiongetResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, MedewerkerCollectiongetResponseSchemaDataItemCountry] = UNSET
    ...
    custom: Union[Unset, MedewerkerCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = MedewerkerCollectiongetResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = MedewerkerCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        medewerker_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        medewerker_collectionget_response_schema_data_item.additional_properties = d
        return medewerker_collectionget_response_schema_data_item
