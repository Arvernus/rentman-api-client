...
from ..models.inhuur_collectionput_response_schema_data_item_custom import (
    InhuurCollectionputResponseSchemaDataItemCustom,
)
from ..models.inhuur_collectionput_response_schema_data_item_type import InhuurCollectionputResponseSchemaDataItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="InhuurCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InhuurCollectionputResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, InhuurCollectionputResponseSchemaDataItemType] = UNSET
    ...
    custom: Union[Unset, InhuurCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = InhuurCollectionputResponseSchemaDataItemType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = InhuurCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        inhuur_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuur_collectionput_response_schema_data_item.additional_properties = d
