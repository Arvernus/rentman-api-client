...
from ..models.files_collectionget_response_schema_data_item_previewstatus import (
    FilesCollectiongetResponseSchemaDataItemPreviewstatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FilesCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FilesCollectiongetResponseSchemaDataItem:
    """ """
    ...
    previewstatus: Union[Unset, FilesCollectiongetResponseSchemaDataItemPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FilesCollectiongetResponseSchemaDataItemPreviewstatus(_previewstatus)
        ...
        files_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        files_collectionget_response_schema_data_item.additional_properties = d
        return files_collectionget_response_schema_data_item
