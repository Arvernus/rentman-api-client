...
from ..models.person_itempost_response_schema_data_country import PersonItempostResponseSchemaDataCountry
from ..models.person_itempost_response_schema_data_custom import PersonItempostResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class PersonItempostResponseSchemaData:
    ...
    country: Union[Unset, PersonItempostResponseSchemaDataCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    tags: Union[Unset, str] = UNSET
    custom: Union[Unset, PersonItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = PersonItempostResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = PersonItempostResponseSchemaDataCustom.from_dict(_custom)

        person_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        person_itempost_response_schema_data.additional_properties = d
        return person_itempost_response_schema_data
