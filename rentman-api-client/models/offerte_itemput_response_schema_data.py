...
T = TypeVar("T", bound="OfferteItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class OfferteItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        offerte_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        offerte_itemput_response_schema_data.additional_properties = d
        return offerte_itemput_response_schema_data
