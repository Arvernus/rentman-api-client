...
from ..models.medewerker_itemput_response_schema_data_country import MedewerkerItemputResponseSchemaDataCountry
from ..models.medewerker_itemput_response_schema_data_custom import MedewerkerItemputResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="MedewerkerItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class MedewerkerItemputResponseSchemaData:
    ...
    country: Union[Unset, MedewerkerItemputResponseSchemaDataCountry] = UNSET
    ...
    custom: Union[Unset, MedewerkerItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = MedewerkerItemputResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = MedewerkerItemputResponseSchemaDataCustom.from_dict(_custom)

        medewerker_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        medewerker_itemput_response_schema_data.additional_properties = d
