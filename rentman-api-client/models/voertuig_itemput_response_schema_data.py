...
from ..models.voertuig_itemput_response_schema_data_custom import VoertuigItemputResponseSchemaDataCustom
from ..models.voertuig_itemput_response_schema_data_multiple import VoertuigItemputResponseSchemaDataMultiple
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class VoertuigItemputResponseSchemaData:
    ...
    multiple: Union[Unset, VoertuigItemputResponseSchemaDataMultiple] = UNSET
    ...
    custom: Union[Unset, VoertuigItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigItemputResponseSchemaDataMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigItemputResponseSchemaDataCustom.from_dict(_custom)

        voertuig_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voertuig_itemput_response_schema_data.additional_properties = d
        return voertuig_itemput_response_schema_data
