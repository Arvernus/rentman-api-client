...
from ..models.uren_itemget_response_schema_data_custom import UrenItemgetResponseSchemaDataCustom
from ..models.uren_itemget_response_schema_data_type import UrenItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UrenItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class UrenItemgetResponseSchemaData:
    ...
    type: Union[Unset, UrenItemgetResponseSchemaDataType] = UNSET
    ...
    custom: Union[Unset, UrenItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = UrenItemgetResponseSchemaDataType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = UrenItemgetResponseSchemaDataCustom.from_dict(_custom)

        uren_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        uren_itemget_response_schema_data.additional_properties = d
        return uren_itemget_response_schema_data
