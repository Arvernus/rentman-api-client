...
T = TypeVar("T", bound="MedewerkertariefItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class MedewerkertariefItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        medewerkertarief_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return medewerkertarief_itemget_response_schema_data
