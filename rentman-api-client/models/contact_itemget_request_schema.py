...
from ..models.contact_itemget_request_schema_country import ContactItemgetRequestSchemaCountry
from ..models.contact_itemget_request_schema_custom import ContactItemgetRequestSchemaCustom
from ..models.contact_itemget_request_schema_invoice_country import ContactItemgetRequestSchemaInvoiceCountry
from ..models.contact_itemget_request_schema_mailing_country import ContactItemgetRequestSchemaMailingCountry
from ..models.contact_itemget_request_schema_type import ContactItemgetRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ContactItemgetRequestSchema:
    """ """

    folder: Union[Unset, None, str] = UNSET
    type: Union[Unset, ContactItemgetRequestSchemaType] = UNSET
    ...
    mailing_country: Union[Unset, ContactItemgetRequestSchemaMailingCountry] = UNSET
    ...
    country: Union[Unset, ContactItemgetRequestSchemaCountry] = UNSET
    ...
    invoice_country: Union[Unset, ContactItemgetRequestSchemaInvoiceCountry] = UNSET
    ...
    custom: Union[Unset, ContactItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = ContactItemgetRequestSchemaType(_type)
        ...
        if not isinstance(_mailing_country, Unset):
            mailing_country = ContactItemgetRequestSchemaMailingCountry(_mailing_country)
        ...
        if not isinstance(_country, Unset):
            country = ContactItemgetRequestSchemaCountry(_country)
        ...
        if not isinstance(_invoice_country, Unset):
            invoice_country = ContactItemgetRequestSchemaInvoiceCountry(_invoice_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactItemgetRequestSchemaCustom.from_dict(_custom)

        contact_itemget_request_schema = cls(
            folder=folder,
            type=type,
        ...
        contact_itemget_request_schema.additional_properties = d
        return contact_itemget_request_schema
