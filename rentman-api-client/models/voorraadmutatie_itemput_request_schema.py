...
T = TypeVar("T", bound="VoorraadmutatieItemputRequestSchema")


@attr.s(auto_attribs=True)
class VoorraadmutatieItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voorraadmutatie_itemput_request_schema = cls(
            amount=amount,
        ...
        voorraadmutatie_itemput_request_schema.additional_properties = d
