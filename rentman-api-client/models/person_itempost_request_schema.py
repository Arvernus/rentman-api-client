...
from ..models.person_itempost_request_schema_country import PersonItempostRequestSchemaCountry
from ..models.person_itempost_request_schema_custom import PersonItempostRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonItempostRequestSchema")


@attr.s(auto_attribs=True)
class PersonItempostRequestSchema:
    """ """
    ...
    country: Union[Unset, PersonItempostRequestSchemaCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    custom: Union[Unset, PersonItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = PersonItempostRequestSchemaCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = PersonItempostRequestSchemaCustom.from_dict(_custom)

        person_itempost_request_schema = cls(
            firstname=firstname,
        ...
        person_itempost_request_schema.additional_properties = d
        return person_itempost_request_schema
