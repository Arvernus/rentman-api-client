...
from ..models.project_request_itemget_response_schema_data_source import ProjectRequestItemgetResponseSchemaDataSource
from ..models.project_request_itemget_response_schema_data_status import ProjectRequestItemgetResponseSchemaDataStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectRequestItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectRequestItemgetResponseSchemaData:
    ...
    source: Union[Unset, ProjectRequestItemgetResponseSchemaDataSource] = UNSET
    status: Union[Unset, ProjectRequestItemgetResponseSchemaDataStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_source, Unset):
            source = ProjectRequestItemgetResponseSchemaDataSource(_source)

        status: Union[Unset, ProjectRequestItemgetResponseSchemaDataStatus] = UNSET
        _status = d.pop("status", UNSET)
        if not isinstance(_status, Unset):
            status = ProjectRequestItemgetResponseSchemaDataStatus(_status)

        project_request_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        project_request_itemget_response_schema_data.additional_properties = d
        return project_request_itemget_response_schema_data
