...
from ..models.materiaal_itempost_request_schema_country_of_origin import MateriaalItempostRequestSchemaCountryOfOrigin
from ..models.materiaal_itempost_request_schema_custom import MateriaalItempostRequestSchemaCustom
from ..models.materiaal_itempost_request_schema_is_physical import MateriaalItempostRequestSchemaIsPhysical
from ..models.materiaal_itempost_request_schema_rental_sales import MateriaalItempostRequestSchemaRentalSales
from ..models.materiaal_itempost_request_schema_stock_management import MateriaalItempostRequestSchemaStockManagement
from ..models.materiaal_itempost_request_schema_type import MateriaalItempostRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="MateriaalItempostRequestSchema")


@attr.s(auto_attribs=True)
class MateriaalItempostRequestSchema:
    """ """
    ...
    type: Union[Unset, MateriaalItempostRequestSchemaType] = UNSET
    rental_sales: Union[Unset, MateriaalItempostRequestSchemaRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, MateriaalItempostRequestSchemaStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, MateriaalItempostRequestSchemaCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, MateriaalItempostRequestSchemaIsPhysical] = UNSET
    ...
    custom: Union[Unset, MateriaalItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = MateriaalItempostRequestSchemaType(_type)

        rental_sales: Union[Unset, MateriaalItempostRequestSchemaRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = MateriaalItempostRequestSchemaRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = MateriaalItempostRequestSchemaStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = MateriaalItempostRequestSchemaCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = MateriaalItempostRequestSchemaIsPhysical(_is_physical)
        ...
        if not isinstance(_custom, Unset):
            custom = MateriaalItempostRequestSchemaCustom.from_dict(_custom)

        materiaal_itempost_request_schema = cls(
            folder=folder,
            code=code,
            name=name,
        ...
        materiaal_itempost_request_schema.additional_properties = d
        return materiaal_itempost_request_schema
