...
from ..models.voertuig_collectionget_response_schema_data_item_custom import (
    VoertuigCollectiongetResponseSchemaDataItemCustom,
)
from ..models.voertuig_collectionget_response_schema_data_item_multiple import (
    VoertuigCollectiongetResponseSchemaDataItemMultiple,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class VoertuigCollectiongetResponseSchemaDataItem:
    """ """
    ...
    multiple: Union[Unset, VoertuigCollectiongetResponseSchemaDataItemMultiple] = UNSET
    ...
    custom: Union[Unset, VoertuigCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigCollectiongetResponseSchemaDataItemMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        voertuig_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voertuig_collectionget_response_schema_data_item.additional_properties = d
