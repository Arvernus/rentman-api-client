...
T = TypeVar("T", bound="VoorraadmutatieCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class VoorraadmutatieCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voorraadmutatie_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voorraadmutatie_collectionput_response_schema_data_item.additional_properties = d
        return voorraadmutatie_collectionput_response_schema_data_item
