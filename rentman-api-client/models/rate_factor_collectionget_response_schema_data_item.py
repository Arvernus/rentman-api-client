...
T = TypeVar("T", bound="RateFactorCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class RateFactorCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rate_factor_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        rate_factor_collectionget_response_schema_data_item.additional_properties = d
        return rate_factor_collectionget_response_schema_data_item
