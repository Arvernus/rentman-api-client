...
from ..models.planningtransport_itemput_response_schema_data_custom import (
    PlanningtransportItemputResponseSchemaDataCustom,
)
from ..models.planningtransport_itemput_response_schema_data_transport import (
    PlanningtransportItemputResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningtransportItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class PlanningtransportItemputResponseSchemaData:
    ...
    transport: Union[Unset, PlanningtransportItemputResponseSchemaDataTransport] = UNSET
    ...
    custom: Union[Unset, PlanningtransportItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningtransportItemputResponseSchemaDataTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningtransportItemputResponseSchemaDataCustom.from_dict(_custom)

        planningtransport_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningtransport_itemput_response_schema_data.additional_properties = d
        return planningtransport_itemput_response_schema_data
