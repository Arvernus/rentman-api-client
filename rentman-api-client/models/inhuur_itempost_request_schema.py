...
from ..models.inhuur_itempost_request_schema_custom import InhuurItempostRequestSchemaCustom
from ..models.inhuur_itempost_request_schema_type import InhuurItempostRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="InhuurItempostRequestSchema")


@attr.s(auto_attribs=True)
class InhuurItempostRequestSchema:
    """ """
    ...
    type: Union[Unset, InhuurItempostRequestSchemaType] = UNSET
    ...
    custom: Union[Unset, InhuurItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = InhuurItempostRequestSchemaType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = InhuurItempostRequestSchemaCustom.from_dict(_custom)

        inhuur_itempost_request_schema = cls(
            name=name,
        ...
        inhuur_itempost_request_schema.additional_properties = d
        return inhuur_itempost_request_schema
