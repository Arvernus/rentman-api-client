...
T = TypeVar("T", bound="FunctieuurItempostRequestSchema")


@attr.s(auto_attribs=True)
class FunctieuurItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        functieuur_itempost_request_schema = cls(
            project_function=project_function,
            description=description,
            duration=duration,
        )

        functieuur_itempost_request_schema.additional_properties = d
        return functieuur_itempost_request_schema
