...
from ..models.setinhoud_collectionput_response_schema_data_item_is_fixed import (
    SetinhoudCollectionputResponseSchemaDataItemIsFixed,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetinhoudCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class SetinhoudCollectionputResponseSchemaDataItem:
    """ """
    ...
    is_fixed: Union[Unset, SetinhoudCollectionputResponseSchemaDataItemIsFixed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_fixed, Unset):
            is_fixed = SetinhoudCollectionputResponseSchemaDataItemIsFixed(_is_fixed)

        setinhoud_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        setinhoud_collectionput_response_schema_data_item.additional_properties = d
