...
from ..models.reparatie_itemget_request_schema_custom import ReparatieItemgetRequestSchemaCustom
from ..models.reparatie_itemget_request_schema_is_usable import ReparatieItemgetRequestSchemaIsUsable
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReparatieItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ReparatieItemgetRequestSchema:
    """ """
    ...
    is_usable: Union[Unset, ReparatieItemgetRequestSchemaIsUsable] = UNSET
    ...
    custom: Union[Unset, ReparatieItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = ReparatieItemgetRequestSchemaIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = ReparatieItemgetRequestSchemaCustom.from_dict(_custom)

        reparatie_itemget_request_schema = cls(
        ...
        reparatie_itemget_request_schema.additional_properties = d
