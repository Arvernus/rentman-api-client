...
from ..models.beschikbaarheid_itemget_response_schema_data_recurrence_interval_unit import (
    BeschikbaarheidItemgetResponseSchemaDataRecurrenceIntervalUnit,
)
from ..models.beschikbaarheid_itemget_response_schema_data_status import BeschikbaarheidItemgetResponseSchemaDataStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="BeschikbaarheidItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class BeschikbaarheidItemgetResponseSchemaData:
    ...
    status: Union[Unset, BeschikbaarheidItemgetResponseSchemaDataStatus] = UNSET
    remark: Union[Unset, str] = UNSET
    recurrence_interval_unit: Union[Unset, BeschikbaarheidItemgetResponseSchemaDataRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = BeschikbaarheidItemgetResponseSchemaDataStatus(_status)
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = BeschikbaarheidItemgetResponseSchemaDataRecurrenceIntervalUnit(
        ...
        beschikbaarheid_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        beschikbaarheid_itemget_response_schema_data.additional_properties = d
        return beschikbaarheid_itemget_response_schema_data
