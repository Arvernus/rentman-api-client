...
from ..models.planningpersoneel_itemget_request_schema_custom import PlanningpersoneelItemgetRequestSchemaCustom
from ..models.planningpersoneel_itemget_request_schema_transport import PlanningpersoneelItemgetRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningpersoneelItemgetRequestSchema")


@attr.s(auto_attribs=True)
class PlanningpersoneelItemgetRequestSchema:
    """ """
    ...
    transport: Union[Unset, PlanningpersoneelItemgetRequestSchemaTransport] = UNSET
    ...
    custom: Union[Unset, PlanningpersoneelItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningpersoneelItemgetRequestSchemaTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningpersoneelItemgetRequestSchemaCustom.from_dict(_custom)

        planningpersoneel_itemget_request_schema = cls(
            crewmember=crewmember,
            cost_rate=cost_rate,
            visible=visible,
        ...
        planningpersoneel_itemget_request_schema.additional_properties = d
        return planningpersoneel_itemget_request_schema
