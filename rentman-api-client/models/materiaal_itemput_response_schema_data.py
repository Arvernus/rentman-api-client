...
from ..models.materiaal_itemput_response_schema_data_country_of_origin import (
    MateriaalItemputResponseSchemaDataCountryOfOrigin,
)
from ..models.materiaal_itemput_response_schema_data_custom import MateriaalItemputResponseSchemaDataCustom
from ..models.materiaal_itemput_response_schema_data_is_physical import MateriaalItemputResponseSchemaDataIsPhysical
from ..models.materiaal_itemput_response_schema_data_rental_sales import MateriaalItemputResponseSchemaDataRentalSales
from ..models.materiaal_itemput_response_schema_data_stock_management import (
    MateriaalItemputResponseSchemaDataStockManagement,
)
from ..models.materiaal_itemput_response_schema_data_type import MateriaalItemputResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="MateriaalItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class MateriaalItemputResponseSchemaData:
    ...
    type: Union[Unset, MateriaalItemputResponseSchemaDataType] = UNSET
    rental_sales: Union[Unset, MateriaalItemputResponseSchemaDataRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, MateriaalItemputResponseSchemaDataStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, MateriaalItemputResponseSchemaDataCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, MateriaalItemputResponseSchemaDataIsPhysical] = UNSET
    ...
    custom: Union[Unset, MateriaalItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = MateriaalItemputResponseSchemaDataType(_type)

        rental_sales: Union[Unset, MateriaalItemputResponseSchemaDataRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = MateriaalItemputResponseSchemaDataRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = MateriaalItemputResponseSchemaDataStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = MateriaalItemputResponseSchemaDataCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = MateriaalItemputResponseSchemaDataIsPhysical(_is_physical)
        ...
        if not isinstance(_custom, Unset):
            custom = MateriaalItemputResponseSchemaDataCustom.from_dict(_custom)

        materiaal_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_itemput_response_schema_data.additional_properties = d
        return materiaal_itemput_response_schema_data
