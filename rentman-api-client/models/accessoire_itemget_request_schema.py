...
T = TypeVar("T", bound="AccessoireItemgetRequestSchema")


@attr.s(auto_attribs=True)
class AccessoireItemgetRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_itemget_request_schema = cls(
            equipment=equipment,
            quantity=quantity,
            automatic=automatic,
            skip=skip,
        ...
        accessoire_itemget_request_schema.additional_properties = d
        return accessoire_itemget_request_schema
