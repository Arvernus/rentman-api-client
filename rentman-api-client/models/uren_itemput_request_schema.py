...
from ..models.uren_itemput_request_schema_custom import UrenItemputRequestSchemaCustom
from ..models.uren_itemput_request_schema_type import UrenItemputRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UrenItemputRequestSchema")


@attr.s(auto_attribs=True)
class UrenItemputRequestSchema:
    """ """
    ...
    type: Union[Unset, UrenItemputRequestSchemaType] = UNSET
    ...
    custom: Union[Unset, UrenItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = UrenItemputRequestSchemaType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = UrenItemputRequestSchemaCustom.from_dict(_custom)

        uren_itemput_request_schema = cls(
        ...
        uren_itemput_request_schema.additional_properties = d
