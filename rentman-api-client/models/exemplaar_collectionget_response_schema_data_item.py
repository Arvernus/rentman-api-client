...
from ..models.exemplaar_collectionget_response_schema_data_item_custom import (
    ExemplaarCollectiongetResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExemplaarCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ExemplaarCollectiongetResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, ExemplaarCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ExemplaarCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        exemplaar_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        exemplaar_collectionget_response_schema_data_item.additional_properties = d
