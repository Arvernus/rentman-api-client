...
from ..models.uren_itemput_response_schema_data_custom import UrenItemputResponseSchemaDataCustom
from ..models.uren_itemput_response_schema_data_type import UrenItemputResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UrenItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class UrenItemputResponseSchemaData:
    ...
    type: Union[Unset, UrenItemputResponseSchemaDataType] = UNSET
    ...
    custom: Union[Unset, UrenItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = UrenItemputResponseSchemaDataType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = UrenItemputResponseSchemaDataCustom.from_dict(_custom)

        uren_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        uren_itemput_response_schema_data.additional_properties = d
