...
T = TypeVar("T", bound="InhuurmateriaalCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InhuurmateriaalCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurmateriaal_collectionpost_response_schema_data_item.additional_properties = d
        return inhuurmateriaal_collectionpost_response_schema_data_item
