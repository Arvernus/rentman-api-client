...
T = TypeVar("T", bound="InhuurmateriaalCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InhuurmateriaalCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurmateriaal_collectionget_response_schema_data_item.additional_properties = d
        return inhuurmateriaal_collectionget_response_schema_data_item
