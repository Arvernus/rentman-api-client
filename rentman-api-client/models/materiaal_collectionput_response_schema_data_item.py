...
from ..models.materiaal_collectionput_response_schema_data_item_country_of_origin import (
    MateriaalCollectionputResponseSchemaDataItemCountryOfOrigin,
)
from ..models.materiaal_collectionput_response_schema_data_item_custom import (
    MateriaalCollectionputResponseSchemaDataItemCustom,
)
from ..models.materiaal_collectionput_response_schema_data_item_is_physical import (
    MateriaalCollectionputResponseSchemaDataItemIsPhysical,
)
from ..models.materiaal_collectionput_response_schema_data_item_rental_sales import (
    MateriaalCollectionputResponseSchemaDataItemRentalSales,
)
from ..models.materiaal_collectionput_response_schema_data_item_stock_management import (
    MateriaalCollectionputResponseSchemaDataItemStockManagement,
)
from ..models.materiaal_collectionput_response_schema_data_item_type import (
    MateriaalCollectionputResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MateriaalCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class MateriaalCollectionputResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, MateriaalCollectionputResponseSchemaDataItemType] = UNSET
    rental_sales: Union[Unset, MateriaalCollectionputResponseSchemaDataItemRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, MateriaalCollectionputResponseSchemaDataItemStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, MateriaalCollectionputResponseSchemaDataItemCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, MateriaalCollectionputResponseSchemaDataItemIsPhysical] = UNSET
    ...
    custom: Union[Unset, MateriaalCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = MateriaalCollectionputResponseSchemaDataItemType(_type)

        rental_sales: Union[Unset, MateriaalCollectionputResponseSchemaDataItemRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = MateriaalCollectionputResponseSchemaDataItemRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = MateriaalCollectionputResponseSchemaDataItemStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = MateriaalCollectionputResponseSchemaDataItemCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = MateriaalCollectionputResponseSchemaDataItemIsPhysical(_is_physical)
        ...
        if not isinstance(_custom, Unset):
            custom = MateriaalCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        materiaal_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_collectionput_response_schema_data_item.additional_properties = d
