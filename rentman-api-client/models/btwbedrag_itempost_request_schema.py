...
T = TypeVar("T", bound="BtwbedragItempostRequestSchema")


@attr.s(auto_attribs=True)
class BtwbedragItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        btwbedrag_itempost_request_schema = cls(
            base=base,
            ledger=ledger,
        )

        btwbedrag_itempost_request_schema.additional_properties = d
