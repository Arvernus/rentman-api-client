...
T = TypeVar("T", bound="AfspraakmedewerkerCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class AfspraakmedewerkerCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        afspraakmedewerker_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        afspraakmedewerker_collectionget_response_schema_data_item.additional_properties = d
