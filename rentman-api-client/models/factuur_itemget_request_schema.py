...
T = TypeVar("T", bound="FactuurItemgetRequestSchema")


@attr.s(auto_attribs=True)
class FactuurItemgetRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factuur_itemget_request_schema = cls(
            customer=customer,
        ...
        factuur_itemget_request_schema.additional_properties = d
        return factuur_itemget_request_schema
