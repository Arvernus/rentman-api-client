...
from ..models.cost_collectionpost_response_schema_data_item_custom import CostCollectionpostResponseSchemaDataItemCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CostCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class CostCollectionpostResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, CostCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = CostCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        cost_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        cost_collectionpost_response_schema_data_item.additional_properties = d
        return cost_collectionpost_response_schema_data_item
