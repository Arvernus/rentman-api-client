...
from ..models.person_collectionput_response_schema_data_item_country import (
    PersonCollectionputResponseSchemaDataItemCountry,
)
from ..models.person_collectionput_response_schema_data_item_custom import (
    PersonCollectionputResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PersonCollectionputResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, PersonCollectionputResponseSchemaDataItemCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    tags: Union[Unset, str] = UNSET
    custom: Union[Unset, PersonCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = PersonCollectionputResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = PersonCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        person_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        person_collectionput_response_schema_data_item.additional_properties = d
