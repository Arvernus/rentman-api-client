...
from ..models.uren_collectionput_response_schema_data_item_custom import UrenCollectionputResponseSchemaDataItemCustom
from ..models.uren_collectionput_response_schema_data_item_type import UrenCollectionputResponseSchemaDataItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UrenCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class UrenCollectionputResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, UrenCollectionputResponseSchemaDataItemType] = UNSET
    ...
    custom: Union[Unset, UrenCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = UrenCollectionputResponseSchemaDataItemType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = UrenCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        uren_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        uren_collectionput_response_schema_data_item.additional_properties = d
        return uren_collectionput_response_schema_data_item
