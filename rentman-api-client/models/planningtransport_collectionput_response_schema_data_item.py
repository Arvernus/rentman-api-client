...
from ..models.planningtransport_collectionput_response_schema_data_item_custom import (
    PlanningtransportCollectionputResponseSchemaDataItemCustom,
)
from ..models.planningtransport_collectionput_response_schema_data_item_transport import (
    PlanningtransportCollectionputResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningtransportCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PlanningtransportCollectionputResponseSchemaDataItem:
    """ """
    ...
    transport: Union[Unset, PlanningtransportCollectionputResponseSchemaDataItemTransport] = UNSET
    ...
    custom: Union[Unset, PlanningtransportCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningtransportCollectionputResponseSchemaDataItemTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningtransportCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        planningtransport_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningtransport_collectionput_response_schema_data_item.additional_properties = d
        return planningtransport_collectionput_response_schema_data_item
