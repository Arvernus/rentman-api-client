...
T = TypeVar("T", bound="BtwbedragCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class BtwbedragCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        btwbedrag_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        btwbedrag_collectionput_response_schema_data_item.additional_properties = d
        return btwbedrag_collectionput_response_schema_data_item
