...
from ..models.setinhoud_collectionget_response_schema_data_item_is_fixed import (
    SetinhoudCollectiongetResponseSchemaDataItemIsFixed,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetinhoudCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class SetinhoudCollectiongetResponseSchemaDataItem:
    """ """
    ...
    is_fixed: Union[Unset, SetinhoudCollectiongetResponseSchemaDataItemIsFixed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_fixed, Unset):
            is_fixed = SetinhoudCollectiongetResponseSchemaDataItemIsFixed(_is_fixed)

        setinhoud_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        setinhoud_collectionget_response_schema_data_item.additional_properties = d
        return setinhoud_collectionget_response_schema_data_item
