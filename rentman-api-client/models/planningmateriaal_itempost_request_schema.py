...
from ..models.planningmateriaal_itempost_request_schema_custom import PlanningmateriaalItempostRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningmateriaalItempostRequestSchema")


@attr.s(auto_attribs=True)
class PlanningmateriaalItempostRequestSchema:
    """ """
    ...
    custom: Union[Unset, PlanningmateriaalItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningmateriaalItempostRequestSchemaCustom.from_dict(_custom)

        planningmateriaal_itempost_request_schema = cls(
            equipment=equipment,
            parent=parent,
            ledger=ledger,
            quantity=quantity,
        ...
        planningmateriaal_itempost_request_schema.additional_properties = d
