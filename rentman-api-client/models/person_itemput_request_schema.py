...
from ..models.person_itemput_request_schema_country import PersonItemputRequestSchemaCountry
from ..models.person_itemput_request_schema_custom import PersonItemputRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonItemputRequestSchema")


@attr.s(auto_attribs=True)
class PersonItemputRequestSchema:
    """ """
    ...
    country: Union[Unset, PersonItemputRequestSchemaCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    custom: Union[Unset, PersonItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = PersonItemputRequestSchemaCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = PersonItemputRequestSchemaCustom.from_dict(_custom)

        person_itemput_request_schema = cls(
            firstname=firstname,
        ...
        person_itemput_request_schema.additional_properties = d
        return person_itemput_request_schema
