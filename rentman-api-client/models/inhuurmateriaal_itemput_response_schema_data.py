...
T = TypeVar("T", bound="InhuurmateriaalItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class InhuurmateriaalItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurmateriaal_itemput_response_schema_data.additional_properties = d
        return inhuurmateriaal_itemput_response_schema_data
