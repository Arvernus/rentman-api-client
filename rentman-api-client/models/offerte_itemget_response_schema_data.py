...
T = TypeVar("T", bound="OfferteItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class OfferteItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        offerte_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        offerte_itemget_response_schema_data.additional_properties = d
