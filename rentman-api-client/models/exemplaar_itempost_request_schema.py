...
from ..models.exemplaar_itempost_request_schema_custom import ExemplaarItempostRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExemplaarItempostRequestSchema")


@attr.s(auto_attribs=True)
class ExemplaarItempostRequestSchema:
    """ """
    ...
    custom: Union[Unset, ExemplaarItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ExemplaarItempostRequestSchemaCustom.from_dict(_custom)

        exemplaar_itempost_request_schema = cls(
            serial=serial,
        ...
        exemplaar_itempost_request_schema.additional_properties = d
        return exemplaar_itempost_request_schema
