...
T = TypeVar("T", bound="InhuurmateriaalItempostRequestSchema")


@attr.s(auto_attribs=True)
class InhuurmateriaalItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_itempost_request_schema = cls(
            equipment=equipment,
            parent=parent,
        ...
        inhuurmateriaal_itempost_request_schema.additional_properties = d
        return inhuurmateriaal_itempost_request_schema
