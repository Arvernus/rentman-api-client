...
from ..models.exemplaar_itemput_request_schema_custom import ExemplaarItemputRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExemplaarItemputRequestSchema")


@attr.s(auto_attribs=True)
class ExemplaarItemputRequestSchema:
    """ """
    ...
    custom: Union[Unset, ExemplaarItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ExemplaarItemputRequestSchemaCustom.from_dict(_custom)

        exemplaar_itemput_request_schema = cls(
            serial=serial,
        ...
        exemplaar_itemput_request_schema.additional_properties = d
        return exemplaar_itemput_request_schema
