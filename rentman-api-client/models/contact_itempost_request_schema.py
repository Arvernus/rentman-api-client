...
from ..models.contact_itempost_request_schema_country import ContactItempostRequestSchemaCountry
from ..models.contact_itempost_request_schema_custom import ContactItempostRequestSchemaCustom
from ..models.contact_itempost_request_schema_invoice_country import ContactItempostRequestSchemaInvoiceCountry
from ..models.contact_itempost_request_schema_mailing_country import ContactItempostRequestSchemaMailingCountry
from ..models.contact_itempost_request_schema_type import ContactItempostRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactItempostRequestSchema")


@attr.s(auto_attribs=True)
class ContactItempostRequestSchema:
    """ """

    folder: Union[Unset, None, str] = UNSET
    type: Union[Unset, ContactItempostRequestSchemaType] = UNSET
    ...
    mailing_country: Union[Unset, ContactItempostRequestSchemaMailingCountry] = UNSET
    ...
    country: Union[Unset, ContactItempostRequestSchemaCountry] = UNSET
    ...
    invoice_country: Union[Unset, ContactItempostRequestSchemaInvoiceCountry] = UNSET
    ...
    custom: Union[Unset, ContactItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = ContactItempostRequestSchemaType(_type)
        ...
        if not isinstance(_mailing_country, Unset):
            mailing_country = ContactItempostRequestSchemaMailingCountry(_mailing_country)
        ...
        if not isinstance(_country, Unset):
            country = ContactItempostRequestSchemaCountry(_country)
        ...
        if not isinstance(_invoice_country, Unset):
            invoice_country = ContactItempostRequestSchemaInvoiceCountry(_invoice_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactItempostRequestSchemaCustom.from_dict(_custom)

        contact_itempost_request_schema = cls(
            folder=folder,
            type=type,
        ...
        contact_itempost_request_schema.additional_properties = d
        return contact_itempost_request_schema
