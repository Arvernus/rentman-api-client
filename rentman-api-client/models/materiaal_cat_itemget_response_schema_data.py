...
T = TypeVar("T", bound="MateriaalCatItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class MateriaalCatItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        materiaal_cat_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_cat_itemget_response_schema_data.additional_properties = d
        return materiaal_cat_itemget_response_schema_data
