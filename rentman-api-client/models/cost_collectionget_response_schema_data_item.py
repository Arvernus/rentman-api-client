...
from ..models.cost_collectionget_response_schema_data_item_custom import CostCollectiongetResponseSchemaDataItemCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CostCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class CostCollectiongetResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, CostCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = CostCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        cost_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        cost_collectionget_response_schema_data_item.additional_properties = d
        return cost_collectionget_response_schema_data_item
