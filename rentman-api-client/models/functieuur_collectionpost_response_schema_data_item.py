...
T = TypeVar("T", bound="FunctieuurCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FunctieuurCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        functieuur_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        functieuur_collectionpost_response_schema_data_item.additional_properties = d
        return functieuur_collectionpost_response_schema_data_item
