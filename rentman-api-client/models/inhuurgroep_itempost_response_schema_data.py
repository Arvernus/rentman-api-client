...
T = TypeVar("T", bound="InhuurgroepItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class InhuurgroepItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurgroep_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurgroep_itempost_response_schema_data.additional_properties = d
        return inhuurgroep_itempost_response_schema_data
