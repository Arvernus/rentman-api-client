...
from ..models.planningmateriaal_collectionput_response_schema_data_item_custom import (
    PlanningmateriaalCollectionputResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningmateriaalCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PlanningmateriaalCollectionputResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, PlanningmateriaalCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningmateriaalCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        planningmateriaal_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningmateriaal_collectionput_response_schema_data_item.additional_properties = d
        return planningmateriaal_collectionput_response_schema_data_item
