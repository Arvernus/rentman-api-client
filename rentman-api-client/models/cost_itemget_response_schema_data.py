...
from ..models.cost_itemget_response_schema_data_custom import CostItemgetResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CostItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class CostItemgetResponseSchemaData:
    ...
    custom: Union[Unset, CostItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = CostItemgetResponseSchemaDataCustom.from_dict(_custom)

        cost_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        cost_itemget_response_schema_data.additional_properties = d
        return cost_itemget_response_schema_data
