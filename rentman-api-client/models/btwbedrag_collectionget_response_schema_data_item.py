...
T = TypeVar("T", bound="BtwbedragCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class BtwbedragCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        btwbedrag_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        btwbedrag_collectionget_response_schema_data_item.additional_properties = d
        return btwbedrag_collectionget_response_schema_data_item
