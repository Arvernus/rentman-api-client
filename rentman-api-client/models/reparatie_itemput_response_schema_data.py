...
from ..models.reparatie_itemput_response_schema_data_custom import ReparatieItemputResponseSchemaDataCustom
from ..models.reparatie_itemput_response_schema_data_is_usable import ReparatieItemputResponseSchemaDataIsUsable
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReparatieItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class ReparatieItemputResponseSchemaData:
    ...
    is_usable: Union[Unset, ReparatieItemputResponseSchemaDataIsUsable] = UNSET
    ...
    custom: Union[Unset, ReparatieItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = ReparatieItemputResponseSchemaDataIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = ReparatieItemputResponseSchemaDataCustom.from_dict(_custom)

        reparatie_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        reparatie_itemput_response_schema_data.additional_properties = d
