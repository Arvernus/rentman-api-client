...
T = TypeVar("T", bound="AccessoireCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class AccessoireCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        accessoire_collectionpost_response_schema_data_item.additional_properties = d
