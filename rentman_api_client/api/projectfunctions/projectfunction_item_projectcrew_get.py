...
from ...models.projectcrew_collectionget_response_schema import ProjectcrewCollectiongetResponseSchema
...
def _get_kwargs(
    *,
    ...
    url = "{}/projectfunctions/{id}/projectcrew".format(client.base_url, id=id)
