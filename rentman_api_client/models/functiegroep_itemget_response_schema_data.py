...
from ..models.functiegroep_itemget_response_schema_data_planperiod_end_schedule_is_start import (
    FunctiegroepItemgetResponseSchemaDataPlanperiodEndScheduleIsStart,
)
from ..models.functiegroep_itemget_response_schema_data_planperiod_start_schedule_is_start import (
    FunctiegroepItemgetResponseSchemaDataPlanperiodStartScheduleIsStart,
)
from ..models.functiegroep_itemget_response_schema_data_usageperiod_end_schedule_is_start import (
    FunctiegroepItemgetResponseSchemaDataUsageperiodEndScheduleIsStart,
)
from ..models.functiegroep_itemget_response_schema_data_usageperiod_start_schedule_is_start import (
    FunctiegroepItemgetResponseSchemaDataUsageperiodStartScheduleIsStart,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FunctiegroepItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class FunctiegroepItemgetResponseSchemaData:
    ...
    planperiod_start_schedule_is_start: Union[
        Unset, FunctiegroepItemgetResponseSchemaDataPlanperiodStartScheduleIsStart
    ] = UNSET
    usageperiod_start_schedule_is_start: Union[
        Unset, FunctiegroepItemgetResponseSchemaDataUsageperiodStartScheduleIsStart
    ] = UNSET
    planperiod_end_schedule_is_start: Union[
        Unset, FunctiegroepItemgetResponseSchemaDataPlanperiodEndScheduleIsStart
    ] = UNSET
    usageperiod_end_schedule_is_start: Union[
        Unset, FunctiegroepItemgetResponseSchemaDataUsageperiodEndScheduleIsStart
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_planperiod_start_schedule_is_start, Unset):
            planperiod_start_schedule_is_start = FunctiegroepItemgetResponseSchemaDataPlanperiodStartScheduleIsStart(
        ...
        if not isinstance(_usageperiod_start_schedule_is_start, Unset):
            usageperiod_start_schedule_is_start = FunctiegroepItemgetResponseSchemaDataUsageperiodStartScheduleIsStart(
        ...
        if not isinstance(_planperiod_end_schedule_is_start, Unset):
            planperiod_end_schedule_is_start = FunctiegroepItemgetResponseSchemaDataPlanperiodEndScheduleIsStart(
        ...
        if not isinstance(_usageperiod_end_schedule_is_start, Unset):
            usageperiod_end_schedule_is_start = FunctiegroepItemgetResponseSchemaDataUsageperiodEndScheduleIsStart(
        ...
        functiegroep_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        functiegroep_itemget_response_schema_data.additional_properties = d
        return functiegroep_itemget_response_schema_data
