...
from ..models.voertuig_collectionput_response_schema_data_item_custom import (
    VoertuigCollectionputResponseSchemaDataItemCustom,
)
from ..models.voertuig_collectionput_response_schema_data_item_multiple import (
    VoertuigCollectionputResponseSchemaDataItemMultiple,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class VoertuigCollectionputResponseSchemaDataItem:
    """ """
    ...
    multiple: Union[Unset, VoertuigCollectionputResponseSchemaDataItemMultiple] = UNSET
    ...
    custom: Union[Unset, VoertuigCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigCollectionputResponseSchemaDataItemMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        voertuig_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voertuig_collectionput_response_schema_data_item.additional_properties = d
