...
from ..models.stock_location_collectionget_response_schema_data_item_country import (
    StockLocationCollectiongetResponseSchemaDataItemCountry,
)
from ..models.stock_location_collectionget_response_schema_data_item_type import (
    StockLocationCollectiongetResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StockLocationCollectiongetResponseSchemaDataItem")
...
class StockLocationCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return stock_location_collectionget_response_schema_data_item
