...
from ..models.timeregistration_collectionpost_response_schema_data_item_custom import (
    TimeregistrationCollectionpostResponseSchemaDataItemCustom,
)
from ..models.timeregistration_collectionpost_response_schema_data_item_type import (
...
class TimeregistrationCollectionpostResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        timeregistration_collectionpost_response_schema_data_item.additional_properties = d
