...
from ..models.voertuig_itempost_request_schema_custom import VoertuigItempostRequestSchemaCustom
from ..models.voertuig_itempost_request_schema_multiple import VoertuigItempostRequestSchemaMultiple
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigItempostRequestSchema")


@attr.s(auto_attribs=True)
class VoertuigItempostRequestSchema:
    """ """
    ...
    multiple: Union[Unset, VoertuigItempostRequestSchemaMultiple] = UNSET
    image: Union[Unset, None, str] = UNSET
    custom: Union[Unset, VoertuigItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigItempostRequestSchemaMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigItempostRequestSchemaCustom.from_dict(_custom)

        voertuig_itempost_request_schema = cls(
            folder=folder,
            name=name,
            cost_rate=cost_rate,
        ...
        voertuig_itempost_request_schema.additional_properties = d
