...
from ..models.reparatie_itempost_response_schema_data_custom import ReparatieItempostResponseSchemaDataCustom
from ..models.reparatie_itempost_response_schema_data_is_usable import ReparatieItempostResponseSchemaDataIsUsable
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReparatieItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ReparatieItempostResponseSchemaData:
    ...
    is_usable: Union[Unset, ReparatieItempostResponseSchemaDataIsUsable] = UNSET
    ...
    custom: Union[Unset, ReparatieItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = ReparatieItempostResponseSchemaDataIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = ReparatieItempostResponseSchemaDataCustom.from_dict(_custom)

        reparatie_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        reparatie_itempost_response_schema_data.additional_properties = d
        return reparatie_itempost_response_schema_data
