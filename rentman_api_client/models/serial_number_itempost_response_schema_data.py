...
from ..models.serial_number_itempost_response_schema_data_custom import SerialNumberItempostResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="SerialNumberItempostResponseSchemaData")
...
class SerialNumberItempostResponseSchemaData:
    ...
    custom: Union[Unset, SerialNumberItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = SerialNumberItempostResponseSchemaDataCustom.from_dict(_custom)
        ...
        serial_number_itempost_response_schema_data = cls(
            active=active,
        ...
        serial_number_itempost_response_schema_data.additional_properties = d
        return serial_number_itempost_response_schema_data
