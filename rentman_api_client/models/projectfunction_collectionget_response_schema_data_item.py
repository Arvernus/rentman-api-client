...
from ..models.projectfunction_collectionget_response_schema_data_item_custom import (
    ProjectfunctionCollectiongetResponseSchemaDataItemCustom,
)
from ..models.projectfunction_collectionget_response_schema_data_item_planperiod_end_schedule_is_start import (
    ProjectfunctionCollectiongetResponseSchemaDataItemPlanperiodEndScheduleIsStart,
)
from ..models.projectfunction_collectionget_response_schema_data_item_planperiod_start_schedule_is_start import (
    ProjectfunctionCollectiongetResponseSchemaDataItemPlanperiodStartScheduleIsStart,
)
from ..models.projectfunction_collectionget_response_schema_data_item_type import (
    ProjectfunctionCollectiongetResponseSchemaDataItemType,
)
from ..models.projectfunction_collectionget_response_schema_data_item_usageperiod_end_schedule_is_start import (
    ProjectfunctionCollectiongetResponseSchemaDataItemUsageperiodEndScheduleIsStart,
)
from ..models.projectfunction_collectionget_response_schema_data_item_usageperiod_start_schedule_is_start import (
...
class ProjectfunctionCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectfunction_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectfunction_collectionget_response_schema_data_item.additional_properties = d
        return projectfunction_collectionget_response_schema_data_item
