...
T = TypeVar("T", bound="ProjectRequestItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectRequestItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_request_itemput_response_schema_data = cls(
        ...
        project_request_itemput_response_schema_data.additional_properties = d
        return project_request_itemput_response_schema_data
