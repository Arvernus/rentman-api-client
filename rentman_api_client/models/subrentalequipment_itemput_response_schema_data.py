...
class SubrentalequipmentItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrentalequipment_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        subrentalequipment_itemput_response_schema_data.additional_properties = d
        return subrentalequipment_itemput_response_schema_data
