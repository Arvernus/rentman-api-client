...
T = TypeVar("T", bound="AppointmentItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class AppointmentItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        appointment_itemput_response_schema_data = cls(
            color=color,
            created=created,
            creator=creator,
        ...
        appointment_itemput_response_schema_data.additional_properties = d
        return appointment_itemput_response_schema_data
