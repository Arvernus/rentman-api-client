...
from ..models.functiegroep_collectionget_response_schema_data_item_planperiod_end_schedule_is_start import (
    FunctiegroepCollectiongetResponseSchemaDataItemPlanperiodEndScheduleIsStart,
)
from ..models.functiegroep_collectionget_response_schema_data_item_planperiod_start_schedule_is_start import (
    FunctiegroepCollectiongetResponseSchemaDataItemPlanperiodStartScheduleIsStart,
)
from ..models.functiegroep_collectionget_response_schema_data_item_usageperiod_end_schedule_is_start import (
    FunctiegroepCollectiongetResponseSchemaDataItemUsageperiodEndScheduleIsStart,
)
from ..models.functiegroep_collectionget_response_schema_data_item_usageperiod_start_schedule_is_start import (
    FunctiegroepCollectiongetResponseSchemaDataItemUsageperiodStartScheduleIsStart,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FunctiegroepCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FunctiegroepCollectiongetResponseSchemaDataItem:
    """ """
    ...
    planperiod_start_schedule_is_start: Union[
        Unset, FunctiegroepCollectiongetResponseSchemaDataItemPlanperiodStartScheduleIsStart
    ] = UNSET
    usageperiod_start_schedule_is_start: Union[
        Unset, FunctiegroepCollectiongetResponseSchemaDataItemUsageperiodStartScheduleIsStart
    ] = UNSET
    planperiod_end_schedule_is_start: Union[
        Unset, FunctiegroepCollectiongetResponseSchemaDataItemPlanperiodEndScheduleIsStart
    ] = UNSET
    usageperiod_end_schedule_is_start: Union[
        Unset, FunctiegroepCollectiongetResponseSchemaDataItemUsageperiodEndScheduleIsStart
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        functiegroep_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        functiegroep_collectionget_response_schema_data_item.additional_properties = d
        return functiegroep_collectionget_response_schema_data_item
