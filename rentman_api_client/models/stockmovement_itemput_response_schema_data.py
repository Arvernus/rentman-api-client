...
class StockmovementItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stockmovement_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        stockmovement_itemput_response_schema_data.additional_properties = d
        return stockmovement_itemput_response_schema_data
