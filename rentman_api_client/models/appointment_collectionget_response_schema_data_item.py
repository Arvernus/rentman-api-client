...
from ..models.appointment_collectionget_response_schema_data_item_recurrence_interval_unit import (
    AppointmentCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AppointmentCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class AppointmentCollectiongetResponseSchemaDataItem:
    """ """
    ...
    recurrence_interval_unit: Union[Unset, AppointmentCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        recurrence_interval_unit: Union[
            Unset, AppointmentCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit
        ] = UNSET
        _recurrence_interval_unit = d.pop("recurrence_interval_unit", UNSET)
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = AppointmentCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit(
        ...
        appointment_collectionget_response_schema_data_item = cls(
            color=color,
            created=created,
            creator=creator,
        ...
        appointment_collectionget_response_schema_data_item.additional_properties = d
