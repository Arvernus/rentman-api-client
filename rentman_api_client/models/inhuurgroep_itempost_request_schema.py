...
T = TypeVar("T", bound="InhuurgroepItempostRequestSchema")


@attr.s(auto_attribs=True)
class InhuurgroepItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurgroep_itempost_request_schema = cls(
            name=name,
            order=order,
            supplier_category=supplier_category,
        )

        inhuurgroep_itempost_request_schema.additional_properties = d
