...
from ..models.inhuur_collectionpost_response_schema_data_item_custom import (
    InhuurCollectionpostResponseSchemaDataItemCustom,
)
from ..models.inhuur_collectionpost_response_schema_data_item_type import InhuurCollectionpostResponseSchemaDataItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="InhuurCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InhuurCollectionpostResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, InhuurCollectionpostResponseSchemaDataItemType] = UNSET
    ...
    custom: Union[Unset, InhuurCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = InhuurCollectionpostResponseSchemaDataItemType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = InhuurCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        inhuur_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuur_collectionpost_response_schema_data_item.additional_properties = d
