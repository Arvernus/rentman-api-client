...
from ..models.project_crew_itemput_response_schema_data_custom import ProjectCrewItemputResponseSchemaDataCustom
from ..models.project_crew_itemput_response_schema_data_transport import ProjectCrewItemputResponseSchemaDataTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCrewItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectCrewItemputResponseSchemaData:
    ...
    custom: Union[Unset, ProjectCrewItemputResponseSchemaDataCustom] = UNSET
    ...
    transport: Union[Unset, ProjectCrewItemputResponseSchemaDataTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectCrewItemputResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectCrewItemputResponseSchemaDataTransport(_transport)

        visible = d.pop("visible", UNSET)

        project_crew_itemput_response_schema_data = cls(
        ...
        project_crew_itemput_response_schema_data.additional_properties = d
        return project_crew_itemput_response_schema_data
