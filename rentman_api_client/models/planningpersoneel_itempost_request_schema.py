...
from ..models.planningpersoneel_itempost_request_schema_custom import PlanningpersoneelItempostRequestSchemaCustom
from ..models.planningpersoneel_itempost_request_schema_transport import PlanningpersoneelItempostRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningpersoneelItempostRequestSchema")


@attr.s(auto_attribs=True)
class PlanningpersoneelItempostRequestSchema:
    """ """
    ...
    transport: Union[Unset, PlanningpersoneelItempostRequestSchemaTransport] = UNSET
    ...
    custom: Union[Unset, PlanningpersoneelItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningpersoneelItempostRequestSchemaTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningpersoneelItempostRequestSchemaCustom.from_dict(_custom)

        planningpersoneel_itempost_request_schema = cls(
            crewmember=crewmember,
            cost_rate=cost_rate,
            visible=visible,
        ...
        planningpersoneel_itempost_request_schema.additional_properties = d
        return planningpersoneel_itempost_request_schema
