...
from ..models.serial_number_itemput_response_schema_data_custom import SerialNumberItemputResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="SerialNumberItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class SerialNumberItemputResponseSchemaData:
    ...
    custom: Union[Unset, SerialNumberItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = SerialNumberItemputResponseSchemaDataCustom.from_dict(_custom)
        ...
        serial_number_itemput_response_schema_data = cls(
            active=active,
        ...
        serial_number_itemput_response_schema_data.additional_properties = d
        return serial_number_itemput_response_schema_data
