...
class StockmovementCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stockmovement_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        stockmovement_collectionput_response_schema_data_item.additional_properties = d
        return stockmovement_collectionput_response_schema_data_item
