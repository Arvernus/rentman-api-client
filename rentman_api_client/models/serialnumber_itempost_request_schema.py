...
from ..models.serialnumber_itempost_request_schema_custom import SerialnumberItempostRequestSchemaCustom
...
class SerialnumberItempostRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialnumber_itempost_request_schema = cls(
            serial=serial,
        ...
        serialnumber_itempost_request_schema.additional_properties = d
        return serialnumber_itempost_request_schema
