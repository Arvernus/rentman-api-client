...
from ..models.files_itemget_request_schema_previewstatus import FilesItemgetRequestSchemaPreviewstatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="FilesItemgetRequestSchema")


@attr.s(auto_attribs=True)
class FilesItemgetRequestSchema:
    """ """
    ...
    previewstatus: Union[Unset, FilesItemgetRequestSchemaPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FilesItemgetRequestSchemaPreviewstatus(_previewstatus)

        file_item = d.pop("file_item", UNSET)

        file_itemtype = d.pop("file_itemtype", UNSET)

        files_itemget_request_schema = cls(
        ...
        files_itemget_request_schema.additional_properties = d
        return files_itemget_request_schema
