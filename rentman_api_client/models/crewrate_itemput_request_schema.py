...
T = TypeVar("T", bound="CrewrateItemputRequestSchema")


@attr.s(auto_attribs=True)
class CrewrateItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        crewrate_itemput_request_schema = cls(
            naam=naam,
            cost_rate=cost_rate,
        )

        crewrate_itemput_request_schema.additional_properties = d
        return crewrate_itemput_request_schema
