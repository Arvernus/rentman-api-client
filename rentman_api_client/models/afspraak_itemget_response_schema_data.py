...
from ..models.afspraak_itemget_response_schema_data_recurrence_interval_unit import (
    AfspraakItemgetResponseSchemaDataRecurrenceIntervalUnit,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AfspraakItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class AfspraakItemgetResponseSchemaData:
    ...
    recurrence_interval_unit: Union[Unset, AfspraakItemgetResponseSchemaDataRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = AfspraakItemgetResponseSchemaDataRecurrenceIntervalUnit(
        ...
        afspraak_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        afspraak_itemget_response_schema_data.additional_properties = d
        return afspraak_itemget_response_schema_data
