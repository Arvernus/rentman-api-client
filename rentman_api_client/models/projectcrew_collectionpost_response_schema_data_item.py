...
from ..models.projectcrew_collectionpost_response_schema_data_item_custom import (
    ProjectcrewCollectionpostResponseSchemaDataItemCustom,
)
from ..models.projectcrew_collectionpost_response_schema_data_item_transport import (
...
class ProjectcrewCollectionpostResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectcrew_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectcrew_collectionpost_response_schema_data_item.additional_properties = d
        return projectcrew_collectionpost_response_schema_data_item
