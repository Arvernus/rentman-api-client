...
from ..models.project_request_collectionget_response_schema_data_item_source import (
    ProjectRequestCollectiongetResponseSchemaDataItemSource,
)
from ..models.project_request_collectionget_response_schema_data_item_status import (
    ProjectRequestCollectiongetResponseSchemaDataItemStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectRequestCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectRequestCollectiongetResponseSchemaDataItem:
    """ """
    ...
    source: Union[Unset, ProjectRequestCollectiongetResponseSchemaDataItemSource] = UNSET
    status: Union[Unset, ProjectRequestCollectiongetResponseSchemaDataItemStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_source, Unset):
            source = ProjectRequestCollectiongetResponseSchemaDataItemSource(_source)

        status: Union[Unset, ProjectRequestCollectiongetResponseSchemaDataItemStatus] = UNSET
        _status = d.pop("status", UNSET)
        if not isinstance(_status, Unset):
            status = ProjectRequestCollectiongetResponseSchemaDataItemStatus(_status)
        ...
        project_request_collectionget_response_schema_data_item = cls(
        ...
        project_request_collectionget_response_schema_data_item.additional_properties = d
        return project_request_collectionget_response_schema_data_item
