...
from ..models.reparatie_collectionpost_response_schema_data_item_custom import (
    ReparatieCollectionpostResponseSchemaDataItemCustom,
)
from ..models.reparatie_collectionpost_response_schema_data_item_is_usable import (
    ReparatieCollectionpostResponseSchemaDataItemIsUsable,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReparatieCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ReparatieCollectionpostResponseSchemaDataItem:
    """ """
    ...
    is_usable: Union[Unset, ReparatieCollectionpostResponseSchemaDataItemIsUsable] = UNSET
    ...
    custom: Union[Unset, ReparatieCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = ReparatieCollectionpostResponseSchemaDataItemIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = ReparatieCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        reparatie_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        reparatie_collectionpost_response_schema_data_item.additional_properties = d
