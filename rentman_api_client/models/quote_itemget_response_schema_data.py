...
T = TypeVar("T", bound="QuoteItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class QuoteItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        quote_itemget_response_schema_data = cls(
            contact=contact,
            created=created,
            creator=creator,
            customer=customer,
        ...
        quote_itemget_response_schema_data.additional_properties = d
        return quote_itemget_response_schema_data
