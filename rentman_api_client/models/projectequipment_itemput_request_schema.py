...
from ..models.projectequipment_itemput_request_schema_custom import ProjectequipmentItemputRequestSchemaCustom
...
class ProjectequipmentItemputRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipment_itemput_request_schema = cls(
            equipment=equipment,
            parent=parent,
            ledger=ledger,
            quantity=quantity,
        ...
        return projectequipment_itemput_request_schema
