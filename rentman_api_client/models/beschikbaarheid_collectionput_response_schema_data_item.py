...
from ..models.beschikbaarheid_collectionput_response_schema_data_item_recurrence_interval_unit import (
    BeschikbaarheidCollectionputResponseSchemaDataItemRecurrenceIntervalUnit,
)
from ..models.beschikbaarheid_collectionput_response_schema_data_item_status import (
    BeschikbaarheidCollectionputResponseSchemaDataItemStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BeschikbaarheidCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class BeschikbaarheidCollectionputResponseSchemaDataItem:
    """ """
    ...
    status: Union[Unset, BeschikbaarheidCollectionputResponseSchemaDataItemStatus] = UNSET
    remark: Union[Unset, str] = UNSET
    recurrence_interval_unit: Union[
        Unset, BeschikbaarheidCollectionputResponseSchemaDataItemRecurrenceIntervalUnit
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = BeschikbaarheidCollectionputResponseSchemaDataItemStatus(_status)
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = BeschikbaarheidCollectionputResponseSchemaDataItemRecurrenceIntervalUnit(
        ...
        beschikbaarheid_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        beschikbaarheid_collectionput_response_schema_data_item.additional_properties = d
