...
from ..models.reparatie_collectionput_response_schema_data_item_custom import (
    ReparatieCollectionputResponseSchemaDataItemCustom,
)
from ..models.reparatie_collectionput_response_schema_data_item_is_usable import (
    ReparatieCollectionputResponseSchemaDataItemIsUsable,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReparatieCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ReparatieCollectionputResponseSchemaDataItem:
    """ """
    ...
    is_usable: Union[Unset, ReparatieCollectionputResponseSchemaDataItemIsUsable] = UNSET
    ...
    custom: Union[Unset, ReparatieCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = ReparatieCollectionputResponseSchemaDataItemIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = ReparatieCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        reparatie_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        reparatie_collectionput_response_schema_data_item.additional_properties = d
