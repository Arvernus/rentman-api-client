...
from ..models.projectequipment_collectionpost_response_schema_data_item_custom import (
...
class ProjectequipmentCollectionpostResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipment_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectequipment_collectionpost_response_schema_data_item.additional_properties = d
