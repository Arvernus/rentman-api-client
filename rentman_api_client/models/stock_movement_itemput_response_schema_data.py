...
T = TypeVar("T", bound="StockMovementItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class StockMovementItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stock_movement_itemput_response_schema_data = cls(
            amount=amount,
            created=created,
            creator=creator,
            date=date,
        ...
        stock_movement_itemput_response_schema_data.additional_properties = d
        return stock_movement_itemput_response_schema_data
