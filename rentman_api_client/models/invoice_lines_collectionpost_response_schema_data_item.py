...
T = TypeVar("T", bound="InvoiceLinesCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InvoiceLinesCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_lines_collectionpost_response_schema_data_item = cls(
            base=base,
            created=created,
            creator=creator,
        ...
        invoice_lines_collectionpost_response_schema_data_item.additional_properties = d
        return invoice_lines_collectionpost_response_schema_data_item
