...
from ..models.time_registration_itemget_request_schema_custom import TimeRegistrationItemgetRequestSchemaCustom
from ..models.time_registration_itemget_request_schema_type import TimeRegistrationItemgetRequestSchemaType
...
class TimeRegistrationItemgetRequestSchema:
    """ """
    ...
    custom: Union[Unset, TimeRegistrationItemgetRequestSchemaCustom] = UNSET
    ...
    type: Union[Unset, TimeRegistrationItemgetRequestSchemaType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = TimeRegistrationItemgetRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = TimeRegistrationItemgetRequestSchemaType(_type)

        time_registration_itemget_request_schema = cls(
        ...
        time_registration_itemget_request_schema.additional_properties = d
        return time_registration_itemget_request_schema
