...
from ..models.equipmentsetscontent_itempost_response_schema_data_is_fixed import (
...
class EquipmentsetscontentItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        equipmentsetscontent_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        equipmentsetscontent_itempost_response_schema_data.additional_properties = d
