...
from ..models.projectcrew_itempost_response_schema_data_custom import ProjectcrewItempostResponseSchemaDataCustom
from ..models.projectcrew_itempost_response_schema_data_transport import ProjectcrewItempostResponseSchemaDataTransport
...
class ProjectcrewItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectcrew_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectcrew_itempost_response_schema_data.additional_properties = d
