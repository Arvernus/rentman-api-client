...
T = TypeVar("T", bound="MateriaalCatCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class MateriaalCatCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        materiaal_cat_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_cat_collectionget_response_schema_data_item.additional_properties = d
