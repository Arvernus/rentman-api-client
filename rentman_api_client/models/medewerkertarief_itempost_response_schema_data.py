...
T = TypeVar("T", bound="MedewerkertariefItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class MedewerkertariefItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        medewerkertarief_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
