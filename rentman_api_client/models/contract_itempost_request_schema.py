...
T = TypeVar("T", bound="ContractItempostRequestSchema")


@attr.s(auto_attribs=True)
class ContractItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_itempost_request_schema = cls(
            number=number,
            customer=customer,
            contact=contact,
            date=date,
        ...
        contract_itempost_request_schema.additional_properties = d
        return contract_itempost_request_schema
