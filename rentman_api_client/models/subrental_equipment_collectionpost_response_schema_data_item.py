...
T = TypeVar("T", bound="SubrentalEquipmentCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class SubrentalEquipmentCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrental_equipment_collectionpost_response_schema_data_item = cls(
            created=created,
            creator=creator,
            discount=discount,
        ...
        subrental_equipment_collectionpost_response_schema_data_item.additional_properties = d
        return subrental_equipment_collectionpost_response_schema_data_item
