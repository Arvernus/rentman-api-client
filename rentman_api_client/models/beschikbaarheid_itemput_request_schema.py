...
from ..models.beschikbaarheid_itemput_request_schema_recurrence_interval_unit import (
    BeschikbaarheidItemputRequestSchemaRecurrenceIntervalUnit,
)
from ..models.beschikbaarheid_itemput_request_schema_status import BeschikbaarheidItemputRequestSchemaStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="BeschikbaarheidItemputRequestSchema")


@attr.s(auto_attribs=True)
class BeschikbaarheidItemputRequestSchema:
    """ """
    ...
    status: Union[Unset, BeschikbaarheidItemputRequestSchemaStatus] = UNSET
    remark: Union[Unset, str] = UNSET
    recurrence_interval_unit: Union[Unset, BeschikbaarheidItemputRequestSchemaRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = BeschikbaarheidItemputRequestSchemaStatus(_status)
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = BeschikbaarheidItemputRequestSchemaRecurrenceIntervalUnit(
        ...
        beschikbaarheid_itemput_request_schema = cls(
        ...
        beschikbaarheid_itemput_request_schema.additional_properties = d
