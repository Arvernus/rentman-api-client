...
T = TypeVar("T", bound="QuoteCollectiongetResponseSchemaDataItem")
...
class QuoteCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        quote_collectionget_response_schema_data_item = cls(
            contact=contact,
            created=created,
            creator=creator,
            customer=customer,
        ...
        quote_collectionget_response_schema_data_item.additional_properties = d
