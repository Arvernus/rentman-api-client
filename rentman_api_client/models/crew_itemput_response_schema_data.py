...
from ..models.crew_itemput_response_schema_data_country import CrewItemputResponseSchemaDataCountry
from ..models.crew_itemput_response_schema_data_custom import CrewItemputResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class CrewItemputResponseSchemaData:
    ...
    country: Union[Unset, CrewItemputResponseSchemaDataCountry] = UNSET
    ...
    custom: Union[Unset, CrewItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = CrewItemputResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = CrewItemputResponseSchemaDataCustom.from_dict(_custom)

        crew_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        crew_itemput_response_schema_data.additional_properties = d
