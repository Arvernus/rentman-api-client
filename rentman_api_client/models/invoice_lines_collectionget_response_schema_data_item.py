...
T = TypeVar("T", bound="InvoiceLinesCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InvoiceLinesCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_lines_collectionget_response_schema_data_item = cls(
            base=base,
            created=created,
            creator=creator,
        ...
        invoice_lines_collectionget_response_schema_data_item.additional_properties = d
        return invoice_lines_collectionget_response_schema_data_item
