...
T = TypeVar("T", bound="FunctieuurItemputRequestSchema")


@attr.s(auto_attribs=True)
class FunctieuurItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        functieuur_itemput_request_schema = cls(
            project_function=project_function,
            description=description,
            duration=duration,
        )

        functieuur_itemput_request_schema.additional_properties = d
