...
from ..models.equipment_collectionpost_response_schema_data_item_country_of_origin import (
    EquipmentCollectionpostResponseSchemaDataItemCountryOfOrigin,
)
from ..models.equipment_collectionpost_response_schema_data_item_custom import (
    EquipmentCollectionpostResponseSchemaDataItemCustom,
)
from ..models.equipment_collectionpost_response_schema_data_item_is_physical import (
    EquipmentCollectionpostResponseSchemaDataItemIsPhysical,
)
from ..models.equipment_collectionpost_response_schema_data_item_rental_sales import (
    EquipmentCollectionpostResponseSchemaDataItemRentalSales,
)
from ..models.equipment_collectionpost_response_schema_data_item_stock_management import (
    EquipmentCollectionpostResponseSchemaDataItemStockManagement,
)
from ..models.equipment_collectionpost_response_schema_data_item_type import (
    EquipmentCollectionpostResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class EquipmentCollectionpostResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, EquipmentCollectionpostResponseSchemaDataItemType] = UNSET
    rental_sales: Union[Unset, EquipmentCollectionpostResponseSchemaDataItemRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, EquipmentCollectionpostResponseSchemaDataItemStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, EquipmentCollectionpostResponseSchemaDataItemCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, EquipmentCollectionpostResponseSchemaDataItemIsPhysical] = UNSET
    ...
    custom: Union[Unset, EquipmentCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = EquipmentCollectionpostResponseSchemaDataItemType(_type)

        rental_sales: Union[Unset, EquipmentCollectionpostResponseSchemaDataItemRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = EquipmentCollectionpostResponseSchemaDataItemRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = EquipmentCollectionpostResponseSchemaDataItemStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = EquipmentCollectionpostResponseSchemaDataItemCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = EquipmentCollectionpostResponseSchemaDataItemIsPhysical(_is_physical)
        ...
        if not isinstance(_custom, Unset):
            custom = EquipmentCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        equipment_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return equipment_collectionpost_response_schema_data_item
