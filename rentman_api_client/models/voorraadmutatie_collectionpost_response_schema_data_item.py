...
T = TypeVar("T", bound="VoorraadmutatieCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class VoorraadmutatieCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voorraadmutatie_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voorraadmutatie_collectionpost_response_schema_data_item.additional_properties = d
        return voorraadmutatie_collectionpost_response_schema_data_item
