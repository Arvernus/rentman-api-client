...
T = TypeVar("T", bound="CrewrateItemgetResponseSchema")


@attr.s(auto_attribs=True)
class CrewrateItemgetResponseSchema:
    """ """

    data: Union[Unset, CrewrateItemgetResponseSchemaData] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_data, Unset):
            data = CrewrateItemgetResponseSchemaData.from_dict(_data)
        ...
        crewrate_itemget_response_schema = cls(
            data=data,
