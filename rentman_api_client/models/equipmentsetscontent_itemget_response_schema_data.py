...
from ..models.equipmentsetscontent_itemget_response_schema_data_is_fixed import (
...
class EquipmentsetscontentItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        equipmentsetscontent_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return equipmentsetscontent_itemget_response_schema_data
