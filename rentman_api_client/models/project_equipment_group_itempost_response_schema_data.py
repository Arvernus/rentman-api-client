...
T = TypeVar("T", bound="ProjectEquipmentGroupItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectEquipmentGroupItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_equipment_group_itempost_response_schema_data = cls(
        ...
        project_equipment_group_itempost_response_schema_data.additional_properties = d
        return project_equipment_group_itempost_response_schema_data
