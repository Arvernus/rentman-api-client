...
from ..models.file_collectionpost_response_schema_data_item_previewstatus import (
...
class FileCollectionpostResponseSchemaDataItem:
    """ """
    ...
    previewstatus: Union[Unset, FileCollectionpostResponseSchemaDataItemPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FileCollectionpostResponseSchemaDataItemPreviewstatus(_previewstatus)
        ...
        file_collectionpost_response_schema_data_item = cls(
        ...
        file_collectionpost_response_schema_data_item.additional_properties = d
        return file_collectionpost_response_schema_data_item
