...
T = TypeVar("T", bound="ProjectRequestCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectRequestCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_request_collectionpost_response_schema_data_item = cls(
        ...
        project_request_collectionpost_response_schema_data_item.additional_properties = d
        return project_request_collectionpost_response_schema_data_item
