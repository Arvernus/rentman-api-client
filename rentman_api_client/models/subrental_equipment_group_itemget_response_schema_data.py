...
T = TypeVar("T", bound="SubrentalEquipmentGroupItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class SubrentalEquipmentGroupItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrental_equipment_group_itemget_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        subrental_equipment_group_itemget_response_schema_data.additional_properties = d
        return subrental_equipment_group_itemget_response_schema_data
