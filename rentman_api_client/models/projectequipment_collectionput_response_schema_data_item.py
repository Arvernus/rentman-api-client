...
from ..models.projectequipment_collectionput_response_schema_data_item_custom import (
...
class ProjectequipmentCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipment_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectequipment_collectionput_response_schema_data_item.additional_properties = d
