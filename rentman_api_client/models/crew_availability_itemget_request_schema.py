...
from ..models.crew_availability_itemget_request_schema_recurrence_interval_unit import (
    CrewAvailabilityItemgetRequestSchemaRecurrenceIntervalUnit,
)
from ..models.crew_availability_itemget_request_schema_status import CrewAvailabilityItemgetRequestSchemaStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewAvailabilityItemgetRequestSchema")


@attr.s(auto_attribs=True)
class CrewAvailabilityItemgetRequestSchema:
    """ """
    ...
    recurrence_interval_unit: Union[Unset, CrewAvailabilityItemgetRequestSchemaRecurrenceIntervalUnit] = UNSET
    recurrent_group: Union[Unset, int] = UNSET
    remark: Union[Unset, str] = UNSET
    start: Union[Unset, None, datetime.datetime] = UNSET
    status: Union[Unset, CrewAvailabilityItemgetRequestSchemaStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = CrewAvailabilityItemgetRequestSchemaRecurrenceIntervalUnit(
        ...
        if not isinstance(_status, Unset):
            status = CrewAvailabilityItemgetRequestSchemaStatus(_status)

        crew_availability_itemget_request_schema = cls(
            end=end,
        ...
        crew_availability_itemget_request_schema.additional_properties = d
        return crew_availability_itemget_request_schema
