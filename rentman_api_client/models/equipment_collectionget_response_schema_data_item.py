...
from ..models.equipment_collectionget_response_schema_data_item_country_of_origin import (
    EquipmentCollectiongetResponseSchemaDataItemCountryOfOrigin,
)
from ..models.equipment_collectionget_response_schema_data_item_custom import (
    EquipmentCollectiongetResponseSchemaDataItemCustom,
)
from ..models.equipment_collectionget_response_schema_data_item_is_physical import (
    EquipmentCollectiongetResponseSchemaDataItemIsPhysical,
)
from ..models.equipment_collectionget_response_schema_data_item_rental_sales import (
    EquipmentCollectiongetResponseSchemaDataItemRentalSales,
)
from ..models.equipment_collectionget_response_schema_data_item_stock_management import (
    EquipmentCollectiongetResponseSchemaDataItemStockManagement,
)
from ..models.equipment_collectionget_response_schema_data_item_type import (
    EquipmentCollectiongetResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class EquipmentCollectiongetResponseSchemaDataItem:
    """ """

    can_edit_content_during_planning: Union[Unset, bool] = UNSET
    code: Union[Unset, str] = UNSET
    country_of_origin: Union[Unset, EquipmentCollectiongetResponseSchemaDataItemCountryOfOrigin] = UNSET
    ...
    custom: Union[Unset, EquipmentCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    is_physical: Union[Unset, EquipmentCollectiongetResponseSchemaDataItemIsPhysical] = UNSET
    ...
    rental_sales: Union[Unset, EquipmentCollectiongetResponseSchemaDataItemRentalSales] = UNSET
    ...
    stock_management: Union[Unset, EquipmentCollectiongetResponseSchemaDataItemStockManagement] = UNSET
    ...
    type: Union[Unset, EquipmentCollectiongetResponseSchemaDataItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = EquipmentCollectiongetResponseSchemaDataItemCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_custom, Unset):
            custom = EquipmentCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = EquipmentCollectiongetResponseSchemaDataItemIsPhysical(_is_physical)
        ...
        if not isinstance(_rental_sales, Unset):
            rental_sales = EquipmentCollectiongetResponseSchemaDataItemRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = EquipmentCollectiongetResponseSchemaDataItemStockManagement(_stock_management)
        ...
        if not isinstance(_type, Unset):
            type = EquipmentCollectiongetResponseSchemaDataItemType(_type)
        ...
        equipment_collectionget_response_schema_data_item = cls(
        ...
        equipment_collectionget_response_schema_data_item.additional_properties = d
        return equipment_collectionget_response_schema_data_item
