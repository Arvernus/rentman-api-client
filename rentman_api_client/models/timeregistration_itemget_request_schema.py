...
from ..models.timeregistration_itemget_request_schema_custom import TimeregistrationItemgetRequestSchemaCustom
from ..models.timeregistration_itemget_request_schema_type import TimeregistrationItemgetRequestSchemaType
...
class TimeregistrationItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_itemget_request_schema = cls(
        ...
        timeregistration_itemget_request_schema.additional_properties = d
