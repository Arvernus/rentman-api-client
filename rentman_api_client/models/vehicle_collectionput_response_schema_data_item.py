...
from ..models.vehicle_collectionput_response_schema_data_item_custom import (
    VehicleCollectionputResponseSchemaDataItemCustom,
)
from ..models.vehicle_collectionput_response_schema_data_item_multiple import (
    VehicleCollectionputResponseSchemaDataItemMultiple,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VehicleCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class VehicleCollectionputResponseSchemaDataItem:
    """ """
    ...
    multiple: Union[Unset, VehicleCollectionputResponseSchemaDataItemMultiple] = UNSET
    ...
    custom: Union[Unset, VehicleCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VehicleCollectionputResponseSchemaDataItemMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VehicleCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        vehicle_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        vehicle_collectionput_response_schema_data_item.additional_properties = d
        return vehicle_collectionput_response_schema_data_item
