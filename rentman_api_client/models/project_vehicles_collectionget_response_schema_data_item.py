...
from ..models.project_vehicles_collectionget_response_schema_data_item_custom import (
    ProjectVehiclesCollectiongetResponseSchemaDataItemCustom,
)
from ..models.project_vehicles_collectionget_response_schema_data_item_transport import (
    ProjectVehiclesCollectiongetResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectVehiclesCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectVehiclesCollectiongetResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, ProjectVehiclesCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    transport: Union[Unset, ProjectVehiclesCollectiongetResponseSchemaDataItemTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectVehiclesCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectVehiclesCollectiongetResponseSchemaDataItemTransport(_transport)

        vehicle = d.pop("vehicle", UNSET)

        project_vehicles_collectionget_response_schema_data_item = cls(
            cost_rate=cost_rate,
            costs=costs,
            created=created,
            creator=creator,
        ...
        project_vehicles_collectionget_response_schema_data_item.additional_properties = d
        return project_vehicles_collectionget_response_schema_data_item
