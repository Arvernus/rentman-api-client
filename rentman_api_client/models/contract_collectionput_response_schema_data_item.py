...
T = TypeVar("T", bound="ContractCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ContractCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_collectionput_response_schema_data_item = cls(
            contact=contact,
            created=created,
            creator=creator,
            customer=customer,
        ...
        contract_collectionput_response_schema_data_item.additional_properties = d
        return contract_collectionput_response_schema_data_item
