...
class ProjectequipmentgroupItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipmentgroup_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectequipmentgroup_itemput_response_schema_data.additional_properties = d
        return projectequipmentgroup_itemput_response_schema_data
