...
from ..models.contact_itemget_response_schema_data_country import ContactItemgetResponseSchemaDataCountry
from ..models.contact_itemget_response_schema_data_custom import ContactItemgetResponseSchemaDataCustom
from ..models.contact_itemget_response_schema_data_invoice_country import ContactItemgetResponseSchemaDataInvoiceCountry
from ..models.contact_itemget_response_schema_data_mailing_country import ContactItemgetResponseSchemaDataMailingCountry
from ..models.contact_itemget_response_schema_data_type import ContactItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ContactItemgetResponseSchemaData:
    ...
    country: Union[Unset, ContactItemgetResponseSchemaDataCountry] = UNSET
    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ContactItemgetResponseSchemaDataCustom] = UNSET
    ...
    invoice_country: Union[Unset, ContactItemgetResponseSchemaDataInvoiceCountry] = UNSET
    ...
    mailing_country: Union[Unset, ContactItemgetResponseSchemaDataMailingCountry] = UNSET
    ...
    type: Union[Unset, ContactItemgetResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = ContactItemgetResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_invoice_country, Unset):
            invoice_country = ContactItemgetResponseSchemaDataInvoiceCountry(_invoice_country)
        ...
        if not isinstance(_mailing_country, Unset):
            mailing_country = ContactItemgetResponseSchemaDataMailingCountry(_mailing_country)
        ...
        if not isinstance(_type, Unset):
            type = ContactItemgetResponseSchemaDataType(_type)
        ...
        contact_itemget_response_schema_data = cls(
        ...
        contact_itemget_response_schema_data.additional_properties = d
        return contact_itemget_response_schema_data
