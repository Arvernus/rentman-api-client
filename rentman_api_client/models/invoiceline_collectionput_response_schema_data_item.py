...
T = TypeVar("T", bound="InvoicelineCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InvoicelineCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoiceline_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        invoiceline_collectionput_response_schema_data_item.additional_properties = d
