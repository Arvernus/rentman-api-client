...
from ..models.materiaal_collectionget_response_schema_data_item_country_of_origin import (
    MateriaalCollectiongetResponseSchemaDataItemCountryOfOrigin,
)
from ..models.materiaal_collectionget_response_schema_data_item_custom import (
    MateriaalCollectiongetResponseSchemaDataItemCustom,
)
from ..models.materiaal_collectionget_response_schema_data_item_is_physical import (
    MateriaalCollectiongetResponseSchemaDataItemIsPhysical,
)
from ..models.materiaal_collectionget_response_schema_data_item_rental_sales import (
    MateriaalCollectiongetResponseSchemaDataItemRentalSales,
)
from ..models.materiaal_collectionget_response_schema_data_item_stock_management import (
    MateriaalCollectiongetResponseSchemaDataItemStockManagement,
)
from ..models.materiaal_collectionget_response_schema_data_item_type import (
    MateriaalCollectiongetResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MateriaalCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class MateriaalCollectiongetResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, MateriaalCollectiongetResponseSchemaDataItemType] = UNSET
    rental_sales: Union[Unset, MateriaalCollectiongetResponseSchemaDataItemRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, MateriaalCollectiongetResponseSchemaDataItemStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, MateriaalCollectiongetResponseSchemaDataItemCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, MateriaalCollectiongetResponseSchemaDataItemIsPhysical] = UNSET
    ...
    custom: Union[Unset, MateriaalCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = MateriaalCollectiongetResponseSchemaDataItemType(_type)

        rental_sales: Union[Unset, MateriaalCollectiongetResponseSchemaDataItemRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = MateriaalCollectiongetResponseSchemaDataItemRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = MateriaalCollectiongetResponseSchemaDataItemStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = MateriaalCollectiongetResponseSchemaDataItemCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = MateriaalCollectiongetResponseSchemaDataItemIsPhysical(_is_physical)
        ...
        if not isinstance(_custom, Unset):
            custom = MateriaalCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        materiaal_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_collectionget_response_schema_data_item.additional_properties = d
        return materiaal_collectionget_response_schema_data_item
