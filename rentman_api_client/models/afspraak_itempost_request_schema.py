...
T = TypeVar("T", bound="AfspraakItempostRequestSchema")


@attr.s(auto_attribs=True)
class AfspraakItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        afspraak_itempost_request_schema = cls(
            start=start,
            end=end,
            name=name,
            color=color,
        ...
        afspraak_itempost_request_schema.additional_properties = d
        return afspraak_itempost_request_schema
