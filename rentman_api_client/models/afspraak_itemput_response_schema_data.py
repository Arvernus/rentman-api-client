...
T = TypeVar("T", bound="AfspraakItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class AfspraakItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        afspraak_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        afspraak_itemput_response_schema_data.additional_properties = d
        return afspraak_itemput_response_schema_data
