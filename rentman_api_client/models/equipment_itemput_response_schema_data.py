...
from ..models.equipment_itemput_response_schema_data_country_of_origin import (
    EquipmentItemputResponseSchemaDataCountryOfOrigin,
)
from ..models.equipment_itemput_response_schema_data_custom import EquipmentItemputResponseSchemaDataCustom
from ..models.equipment_itemput_response_schema_data_is_physical import EquipmentItemputResponseSchemaDataIsPhysical
from ..models.equipment_itemput_response_schema_data_rental_sales import EquipmentItemputResponseSchemaDataRentalSales
from ..models.equipment_itemput_response_schema_data_stock_management import (
    EquipmentItemputResponseSchemaDataStockManagement,
)
from ..models.equipment_itemput_response_schema_data_type import EquipmentItemputResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentItemputResponseSchemaData")
...
class EquipmentItemputResponseSchemaData:
    ...
    country_of_origin: Union[Unset, EquipmentItemputResponseSchemaDataCountryOfOrigin] = UNSET
    ...
    custom: Union[Unset, EquipmentItemputResponseSchemaDataCustom] = UNSET
    ...
    is_physical: Union[Unset, EquipmentItemputResponseSchemaDataIsPhysical] = UNSET
    ...
    rental_sales: Union[Unset, EquipmentItemputResponseSchemaDataRentalSales] = UNSET
    ...
    stock_management: Union[Unset, EquipmentItemputResponseSchemaDataStockManagement] = UNSET
    ...
    type: Union[Unset, EquipmentItemputResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = EquipmentItemputResponseSchemaDataCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_custom, Unset):
            custom = EquipmentItemputResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = EquipmentItemputResponseSchemaDataIsPhysical(_is_physical)
        ...
        if not isinstance(_rental_sales, Unset):
            rental_sales = EquipmentItemputResponseSchemaDataRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = EquipmentItemputResponseSchemaDataStockManagement(_stock_management)
        ...
        if not isinstance(_type, Unset):
            type = EquipmentItemputResponseSchemaDataType(_type)
        ...
        equipment_itemput_response_schema_data = cls(
        ...
        equipment_itemput_response_schema_data.additional_properties = d
