...
from ..models.repair_itemput_request_schema_custom import RepairItemputRequestSchemaCustom
from ..models.repair_itemput_request_schema_is_usable import RepairItemputRequestSchemaIsUsable
from ..types import UNSET, Unset

T = TypeVar("T", bound="RepairItemputRequestSchema")


@attr.s(auto_attribs=True)
class RepairItemputRequestSchema:
    """ """
    ...
    is_usable: Union[Unset, RepairItemputRequestSchemaIsUsable] = UNSET
    ...
    custom: Union[Unset, RepairItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = RepairItemputRequestSchemaIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = RepairItemputRequestSchemaCustom.from_dict(_custom)

        repair_itemput_request_schema = cls(
        ...
        repair_itemput_request_schema.additional_properties = d
        return repair_itemput_request_schema
