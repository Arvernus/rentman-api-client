...
from ..models.time_registration_collectionput_response_schema_data_item_custom import (
    TimeRegistrationCollectionputResponseSchemaDataItemCustom,
)
from ..models.time_registration_collectionput_response_schema_data_item_type import (
    TimeRegistrationCollectionputResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimeRegistrationCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class TimeRegistrationCollectionputResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, TimeRegistrationCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    type: Union[Unset, TimeRegistrationCollectionputResponseSchemaDataItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = TimeRegistrationCollectionputResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = TimeRegistrationCollectionputResponseSchemaDataItemType(_type)

        time_registration_collectionput_response_schema_data_item = cls(
        ...
        time_registration_collectionput_response_schema_data_item.additional_properties = d
        return time_registration_collectionput_response_schema_data_item
