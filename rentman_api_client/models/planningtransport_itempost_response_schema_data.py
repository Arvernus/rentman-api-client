...
from ..models.planningtransport_itempost_response_schema_data_custom import (
    PlanningtransportItempostResponseSchemaDataCustom,
)
from ..models.planningtransport_itempost_response_schema_data_transport import (
    PlanningtransportItempostResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningtransportItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class PlanningtransportItempostResponseSchemaData:
    ...
    transport: Union[Unset, PlanningtransportItempostResponseSchemaDataTransport] = UNSET
    ...
    custom: Union[Unset, PlanningtransportItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningtransportItempostResponseSchemaDataTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningtransportItempostResponseSchemaDataCustom.from_dict(_custom)

        planningtransport_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningtransport_itempost_response_schema_data.additional_properties = d
        return planningtransport_itempost_response_schema_data
