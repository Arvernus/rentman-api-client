...
T = TypeVar("T", bound="InvoiceItempostRequestSchema")
...
class InvoiceItempostRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_itempost_request_schema = cls(
            customer=customer,
        ...
        invoice_itempost_request_schema.additional_properties = d
        return invoice_itempost_request_schema
