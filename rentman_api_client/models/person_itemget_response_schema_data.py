...
from ..models.person_itemget_response_schema_data_country import PersonItemgetResponseSchemaDataCountry
from ..models.person_itemget_response_schema_data_custom import PersonItemgetResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class PersonItemgetResponseSchemaData:
    ...
    country: Union[Unset, PersonItemgetResponseSchemaDataCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    tags: Union[Unset, str] = UNSET
    custom: Union[Unset, PersonItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = PersonItemgetResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = PersonItemgetResponseSchemaDataCustom.from_dict(_custom)

        person_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        person_itemget_response_schema_data.additional_properties = d
        return person_itemget_response_schema_data
