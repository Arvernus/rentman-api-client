...
from ..models.inhuur_itempost_response_schema_data_custom import InhuurItempostResponseSchemaDataCustom
from ..models.inhuur_itempost_response_schema_data_type import InhuurItempostResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="InhuurItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class InhuurItempostResponseSchemaData:
    ...
    type: Union[Unset, InhuurItempostResponseSchemaDataType] = UNSET
    ...
    custom: Union[Unset, InhuurItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = InhuurItempostResponseSchemaDataType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = InhuurItempostResponseSchemaDataCustom.from_dict(_custom)

        inhuur_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuur_itempost_response_schema_data.additional_properties = d
        return inhuur_itempost_response_schema_data
