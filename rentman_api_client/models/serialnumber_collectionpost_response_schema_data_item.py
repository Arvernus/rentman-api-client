...
from ..models.serialnumber_collectionpost_response_schema_data_item_custom import (
...
class SerialnumberCollectionpostResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialnumber_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        serialnumber_collectionpost_response_schema_data_item.additional_properties = d
        return serialnumber_collectionpost_response_schema_data_item
