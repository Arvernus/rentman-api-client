...
from ..models.serialnumber_collectionget_response_schema_data_item_custom import (
...
class SerialnumberCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialnumber_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        serialnumber_collectionget_response_schema_data_item.additional_properties = d
        return serialnumber_collectionget_response_schema_data_item
