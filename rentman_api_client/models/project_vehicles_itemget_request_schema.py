...
from ..models.project_vehicles_itemget_request_schema_custom import ProjectVehiclesItemgetRequestSchemaCustom
from ..models.project_vehicles_itemget_request_schema_transport import ProjectVehiclesItemgetRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectVehiclesItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ProjectVehiclesItemgetRequestSchema:
    """ """

    vehicle: str
    cost_rate: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ProjectVehiclesItemgetRequestSchemaCustom] = UNSET
    ...
    transport: Union[Unset, ProjectVehiclesItemgetRequestSchemaTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectVehiclesItemgetRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectVehiclesItemgetRequestSchemaTransport(_transport)

        project_vehicles_itemget_request_schema = cls(
            vehicle=vehicle,
            cost_rate=cost_rate,
            custom=custom,
        ...
        project_vehicles_itemget_request_schema.additional_properties = d
        return project_vehicles_itemget_request_schema
