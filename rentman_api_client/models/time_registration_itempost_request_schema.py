...
from ..models.time_registration_itempost_request_schema_custom import TimeRegistrationItempostRequestSchemaCustom
from ..models.time_registration_itempost_request_schema_type import TimeRegistrationItempostRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimeRegistrationItempostRequestSchema")


@attr.s(auto_attribs=True)
class TimeRegistrationItempostRequestSchema:
    """ """
    ...
    custom: Union[Unset, TimeRegistrationItempostRequestSchemaCustom] = UNSET
    ...
    type: Union[Unset, TimeRegistrationItempostRequestSchemaType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = TimeRegistrationItempostRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = TimeRegistrationItempostRequestSchemaType(_type)

        time_registration_itempost_request_schema = cls(
        ...
        time_registration_itempost_request_schema.additional_properties = d
        return time_registration_itempost_request_schema
