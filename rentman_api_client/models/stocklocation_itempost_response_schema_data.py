...
from ..models.stocklocation_itempost_response_schema_data_country import StocklocationItempostResponseSchemaDataCountry
...
class StocklocationItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stocklocation_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        stocklocation_itempost_response_schema_data.additional_properties = d
