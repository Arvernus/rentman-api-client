...
from ..models.beschikbaarheid_collectionpost_response_schema_data_item_recurrence_interval_unit import (
    BeschikbaarheidCollectionpostResponseSchemaDataItemRecurrenceIntervalUnit,
)
from ..models.beschikbaarheid_collectionpost_response_schema_data_item_status import (
    BeschikbaarheidCollectionpostResponseSchemaDataItemStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BeschikbaarheidCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class BeschikbaarheidCollectionpostResponseSchemaDataItem:
    """ """
    ...
    status: Union[Unset, BeschikbaarheidCollectionpostResponseSchemaDataItemStatus] = UNSET
    remark: Union[Unset, str] = UNSET
    recurrence_interval_unit: Union[
        Unset, BeschikbaarheidCollectionpostResponseSchemaDataItemRecurrenceIntervalUnit
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = BeschikbaarheidCollectionpostResponseSchemaDataItemStatus(_status)
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = BeschikbaarheidCollectionpostResponseSchemaDataItemRecurrenceIntervalUnit(
        ...
        beschikbaarheid_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        beschikbaarheid_collectionpost_response_schema_data_item.additional_properties = d
