...
T = TypeVar("T", bound="ProjectEquipmentGroupCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectEquipmentGroupCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_equipment_group_collectionput_response_schema_data_item = cls(
        ...
        project_equipment_group_collectionput_response_schema_data_item.additional_properties = d
        return project_equipment_group_collectionput_response_schema_data_item
