...
from ..models.functiegroep_itemget_request_schema_planperiod_end_schedule_is_start import (
    FunctiegroepItemgetRequestSchemaPlanperiodEndScheduleIsStart,
)
from ..models.functiegroep_itemget_request_schema_planperiod_start_schedule_is_start import (
    FunctiegroepItemgetRequestSchemaPlanperiodStartScheduleIsStart,
)
from ..models.functiegroep_itemget_request_schema_usageperiod_end_schedule_is_start import (
    FunctiegroepItemgetRequestSchemaUsageperiodEndScheduleIsStart,
)
from ..models.functiegroep_itemget_request_schema_usageperiod_start_schedule_is_start import (
    FunctiegroepItemgetRequestSchemaUsageperiodStartScheduleIsStart,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FunctiegroepItemgetRequestSchema")


@attr.s(auto_attribs=True)
class FunctiegroepItemgetRequestSchema:
    """ """
    ...
    planperiod_start_schedule_is_start: Union[
        Unset, FunctiegroepItemgetRequestSchemaPlanperiodStartScheduleIsStart
    ] = UNSET
    usageperiod_start_schedule_is_start: Union[
        Unset, FunctiegroepItemgetRequestSchemaUsageperiodStartScheduleIsStart
    ] = UNSET
    planperiod_end_schedule_is_start: Union[Unset, FunctiegroepItemgetRequestSchemaPlanperiodEndScheduleIsStart] = UNSET
    usageperiod_end_schedule_is_start: Union[
        Unset, FunctiegroepItemgetRequestSchemaUsageperiodEndScheduleIsStart
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_planperiod_start_schedule_is_start, Unset):
            planperiod_start_schedule_is_start = FunctiegroepItemgetRequestSchemaPlanperiodStartScheduleIsStart(
        ...
        if not isinstance(_usageperiod_start_schedule_is_start, Unset):
            usageperiod_start_schedule_is_start = FunctiegroepItemgetRequestSchemaUsageperiodStartScheduleIsStart(
                _usageperiod_start_schedule_is_start
            )

        planperiod_end_schedule_is_start: Union[
            Unset, FunctiegroepItemgetRequestSchemaPlanperiodEndScheduleIsStart
        ] = UNSET
        ...
        if not isinstance(_planperiod_end_schedule_is_start, Unset):
            planperiod_end_schedule_is_start = FunctiegroepItemgetRequestSchemaPlanperiodEndScheduleIsStart(
        ...
        if not isinstance(_usageperiod_end_schedule_is_start, Unset):
            usageperiod_end_schedule_is_start = FunctiegroepItemgetRequestSchemaUsageperiodEndScheduleIsStart(
        ...
        functiegroep_itemget_request_schema = cls(
            subproject=subproject,
            name=name,
            duration=duration,
        ...
        functiegroep_itemget_request_schema.additional_properties = d
        return functiegroep_itemget_request_schema
