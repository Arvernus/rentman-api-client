...
from ..models.repair_collectionget_response_schema_data_item_custom import (
    RepairCollectiongetResponseSchemaDataItemCustom,
)
from ..models.repair_collectionget_response_schema_data_item_is_usable import (
    RepairCollectiongetResponseSchemaDataItemIsUsable,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RepairCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class RepairCollectiongetResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, RepairCollectiongetResponseSchemaDataItemCustom] = UNSET
    displayname: Union[Unset, str] = UNSET
    equipment: Union[Unset, str] = UNSET
    external_repairer: Union[Unset, None, str] = UNSET
    id: Union[Unset, int] = UNSET
    is_usable: Union[Unset, RepairCollectiongetResponseSchemaDataItemIsUsable] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = RepairCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = RepairCollectiongetResponseSchemaDataItemIsUsable(_is_usable)
        ...
        repair_collectionget_response_schema_data_item = cls(
            amount=amount,
            assignee=assignee,
