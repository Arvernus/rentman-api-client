...
from ..models.serial_number_collectionpost_response_schema_data_item_custom import (
    SerialNumberCollectionpostResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SerialNumberCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class SerialNumberCollectionpostResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, SerialNumberCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = SerialNumberCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        serial_number_collectionpost_response_schema_data_item = cls(
            active=active,
        ...
        serial_number_collectionpost_response_schema_data_item.additional_properties = d
        return serial_number_collectionpost_response_schema_data_item
