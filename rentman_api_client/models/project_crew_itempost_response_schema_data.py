...
from ..models.project_crew_itempost_response_schema_data_custom import ProjectCrewItempostResponseSchemaDataCustom
from ..models.project_crew_itempost_response_schema_data_transport import ProjectCrewItempostResponseSchemaDataTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCrewItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectCrewItempostResponseSchemaData:
    ...
    custom: Union[Unset, ProjectCrewItempostResponseSchemaDataCustom] = UNSET
    ...
    transport: Union[Unset, ProjectCrewItempostResponseSchemaDataTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectCrewItempostResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectCrewItempostResponseSchemaDataTransport(_transport)

        visible = d.pop("visible", UNSET)

        project_crew_itempost_response_schema_data = cls(
        ...
        project_crew_itempost_response_schema_data.additional_properties = d
        return project_crew_itempost_response_schema_data
