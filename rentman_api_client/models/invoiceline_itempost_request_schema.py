...
T = TypeVar("T", bound="InvoicelineItempostRequestSchema")


@attr.s(auto_attribs=True)
class InvoicelineItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoiceline_itempost_request_schema = cls(
            base=base,
            ledger=ledger,
        )

        invoiceline_itempost_request_schema.additional_properties = d
        return invoiceline_itempost_request_schema
