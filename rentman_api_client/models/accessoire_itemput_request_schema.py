...
T = TypeVar("T", bound="AccessoireItemputRequestSchema")


@attr.s(auto_attribs=True)
class AccessoireItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_itemput_request_schema = cls(
            equipment=equipment,
            quantity=quantity,
            automatic=automatic,
            skip=skip,
        ...
        accessoire_itemput_request_schema.additional_properties = d
        return accessoire_itemput_request_schema
