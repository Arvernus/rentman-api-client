...
from ..models.projectequipment_itemget_response_schema_data_custom import (
...
class ProjectequipmentItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipment_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectequipment_itemget_response_schema_data.additional_properties = d
