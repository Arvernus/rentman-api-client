...
from ..models.project_vehicles_itempost_response_schema_data_custom import (
    ProjectVehiclesItempostResponseSchemaDataCustom,
)
from ..models.project_vehicles_itempost_response_schema_data_transport import (
    ProjectVehiclesItempostResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectVehiclesItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectVehiclesItempostResponseSchemaData:
    ...
    custom: Union[Unset, ProjectVehiclesItempostResponseSchemaDataCustom] = UNSET
    ...
    transport: Union[Unset, ProjectVehiclesItempostResponseSchemaDataTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectVehiclesItempostResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectVehiclesItempostResponseSchemaDataTransport(_transport)

        vehicle = d.pop("vehicle", UNSET)

        project_vehicles_itempost_response_schema_data = cls(
            cost_rate=cost_rate,
            costs=costs,
            created=created,
            creator=creator,
        ...
        project_vehicles_itempost_response_schema_data.additional_properties = d
        return project_vehicles_itempost_response_schema_data
