...
from ..models.crewavailability_itempost_request_schema_recurrence_interval_unit import (
    CrewavailabilityItempostRequestSchemaRecurrenceIntervalUnit,
)
from ..models.crewavailability_itempost_request_schema_status import CrewavailabilityItempostRequestSchemaStatus
...
class CrewavailabilityItempostRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        crewavailability_itempost_request_schema = cls(
        ...
        crewavailability_itempost_request_schema.additional_properties = d
        return crewavailability_itempost_request_schema
