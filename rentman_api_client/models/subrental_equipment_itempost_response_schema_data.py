...
T = TypeVar("T", bound="SubrentalEquipmentItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class SubrentalEquipmentItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrental_equipment_itempost_response_schema_data = cls(
            created=created,
            creator=creator,
            discount=discount,
        ...
        subrental_equipment_itempost_response_schema_data.additional_properties = d
        return subrental_equipment_itempost_response_schema_data
