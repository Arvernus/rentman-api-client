...
from ..models.voertuig_itempost_response_schema_data_custom import VoertuigItempostResponseSchemaDataCustom
from ..models.voertuig_itempost_response_schema_data_multiple import VoertuigItempostResponseSchemaDataMultiple
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class VoertuigItempostResponseSchemaData:
    ...
    multiple: Union[Unset, VoertuigItempostResponseSchemaDataMultiple] = UNSET
    ...
    custom: Union[Unset, VoertuigItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigItempostResponseSchemaDataMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigItempostResponseSchemaDataCustom.from_dict(_custom)

        voertuig_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voertuig_itempost_response_schema_data.additional_properties = d
        return voertuig_itempost_response_schema_data
