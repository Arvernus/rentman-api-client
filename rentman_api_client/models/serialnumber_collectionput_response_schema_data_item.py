...
from ..models.serialnumber_collectionput_response_schema_data_item_custom import (
...
class SerialnumberCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialnumber_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return serialnumber_collectionput_response_schema_data_item
