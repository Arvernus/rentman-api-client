...
from ..models.files_itempost_response_schema_data_previewstatus import FilesItempostResponseSchemaDataPreviewstatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="FilesItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class FilesItempostResponseSchemaData:
    ...
    previewstatus: Union[Unset, FilesItempostResponseSchemaDataPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FilesItempostResponseSchemaDataPreviewstatus(_previewstatus)
        ...
        files_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        files_itempost_response_schema_data.additional_properties = d
        return files_itempost_response_schema_data
