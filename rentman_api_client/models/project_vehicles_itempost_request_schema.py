...
from ..models.project_vehicles_itempost_request_schema_custom import ProjectVehiclesItempostRequestSchemaCustom
from ..models.project_vehicles_itempost_request_schema_transport import ProjectVehiclesItempostRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectVehiclesItempostRequestSchema")


@attr.s(auto_attribs=True)
class ProjectVehiclesItempostRequestSchema:
    """ """

    vehicle: str
    cost_rate: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ProjectVehiclesItempostRequestSchemaCustom] = UNSET
    ...
    transport: Union[Unset, ProjectVehiclesItempostRequestSchemaTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectVehiclesItempostRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectVehiclesItempostRequestSchemaTransport(_transport)

        project_vehicles_itempost_request_schema = cls(
            vehicle=vehicle,
            cost_rate=cost_rate,
            custom=custom,
        ...
        project_vehicles_itempost_request_schema.additional_properties = d
        return project_vehicles_itempost_request_schema
