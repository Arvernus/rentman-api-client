...
from ..models.planningmateriaal_collectionpost_response_schema_data_item_custom import (
    PlanningmateriaalCollectionpostResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningmateriaalCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PlanningmateriaalCollectionpostResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, PlanningmateriaalCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningmateriaalCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        planningmateriaal_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningmateriaal_collectionpost_response_schema_data_item.additional_properties = d
