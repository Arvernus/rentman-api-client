...
from ..models.projectvehicle_collectionput_response_schema_data_item_custom import (
    ProjectvehicleCollectionputResponseSchemaDataItemCustom,
)
from ..models.projectvehicle_collectionput_response_schema_data_item_transport import (
    ProjectvehicleCollectionputResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectvehicleCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectvehicleCollectionputResponseSchemaDataItem:
    """ """
    ...
    transport: Union[Unset, ProjectvehicleCollectionputResponseSchemaDataItemTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleCollectionputResponseSchemaDataItemTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        projectvehicle_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectvehicle_collectionput_response_schema_data_item.additional_properties = d
        return projectvehicle_collectionput_response_schema_data_item
