...
from ..models.vehicle_itemput_response_schema_data_custom import VehicleItemputResponseSchemaDataCustom
from ..models.vehicle_itemput_response_schema_data_multiple import VehicleItemputResponseSchemaDataMultiple
from ..types import UNSET, Unset

T = TypeVar("T", bound="VehicleItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class VehicleItemputResponseSchemaData:
    """All the data about the requested items"""

    cost_rate: Union[Unset, None, str] = UNSET
    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, VehicleItemputResponseSchemaDataCustom] = UNSET
    ...
    multiple: Union[Unset, VehicleItemputResponseSchemaDataMultiple] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = VehicleItemputResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_multiple, Unset):
            multiple = VehicleItemputResponseSchemaDataMultiple(_multiple)
        ...
        vehicle_itemput_response_schema_data = cls(
            cost_rate=cost_rate,
            created=created,
            creator=creator,
            custom=custom,
        ...
        vehicle_itemput_response_schema_data.additional_properties = d
        return vehicle_itemput_response_schema_data
