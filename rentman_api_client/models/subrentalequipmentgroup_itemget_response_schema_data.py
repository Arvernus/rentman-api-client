...
class SubrentalequipmentgroupItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrentalequipmentgroup_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        subrentalequipmentgroup_itemget_response_schema_data.additional_properties = d
        return subrentalequipmentgroup_itemget_response_schema_data
