...
from ..models.contactperson_itemget_response_schema_data_country import ContactpersonItemgetResponseSchemaDataCountry
from ..models.contactperson_itemget_response_schema_data_custom import ContactpersonItemgetResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactpersonItemgetResponseSchemaData")
...
class ContactpersonItemgetResponseSchemaData:
    ...
    country: Union[Unset, ContactpersonItemgetResponseSchemaDataCountry] = UNSET
    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ContactpersonItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = ContactpersonItemgetResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactpersonItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        contactperson_itemget_response_schema_data = cls(
            city=city,
            contact=contact,
            country=country,
            created=created,
        ...
        contactperson_itemget_response_schema_data.additional_properties = d
        return contactperson_itemget_response_schema_data
