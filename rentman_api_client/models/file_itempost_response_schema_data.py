...
from ..models.file_itempost_response_schema_data_previewstatus import FileItempostResponseSchemaDataPreviewstatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="FileItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class FileItempostResponseSchemaData:
    ...
    previewstatus: Union[Unset, FileItempostResponseSchemaDataPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FileItempostResponseSchemaDataPreviewstatus(_previewstatus)
        ...
        file_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        file_itempost_response_schema_data.additional_properties = d
        return file_itempost_response_schema_data
