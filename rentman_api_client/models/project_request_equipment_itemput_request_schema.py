...
T = TypeVar("T", bound="ProjectRequestEquipmentItemputRequestSchema")


@attr.s(auto_attribs=True)
class ProjectRequestEquipmentItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_request_equipment_itemput_request_schema = cls(
            discount=discount,
        ...
        project_request_equipment_itemput_request_schema.additional_properties = d
        return project_request_equipment_itemput_request_schema
