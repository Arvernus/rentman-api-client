...
T = TypeVar("T", bound="ContractItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ContractItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_itempost_response_schema_data = cls(
            contact=contact,
            created=created,
            creator=creator,
            customer=customer,
        ...
        contract_itempost_response_schema_data.additional_properties = d
        return contract_itempost_response_schema_data
