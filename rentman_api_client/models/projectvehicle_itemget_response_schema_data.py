...
from ..models.projectvehicle_itemget_response_schema_data_transport import (
    ProjectvehicleItemgetResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectvehicleItemgetResponseSchemaData")
...
class ProjectvehicleItemgetResponseSchemaData:
    ...
    transport: Union[Unset, ProjectvehicleItemgetResponseSchemaDataTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleItemgetResponseSchemaDataTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleItemgetResponseSchemaDataCustom.from_dict(_custom)

        projectvehicle_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectvehicle_itemget_response_schema_data.additional_properties = d
        return projectvehicle_itemget_response_schema_data
