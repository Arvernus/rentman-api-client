...
from ..models.stocklocation_itemget_request_schema_country import StocklocationItemgetRequestSchemaCountry
from ..models.stocklocation_itemget_request_schema_type import StocklocationItemgetRequestSchemaType
...
class StocklocationItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stocklocation_itemget_request_schema = cls(
            name=name,
            city=city,
            street=street,
        ...
        stocklocation_itemget_request_schema.additional_properties = d
        return stocklocation_itemget_request_schema
