...
from ..models.timeregistration_itemget_response_schema_data_custom import (
    TimeregistrationItemgetResponseSchemaDataCustom,
)
from ..models.timeregistration_itemget_response_schema_data_type import TimeregistrationItemgetResponseSchemaDataType
...
class TimeregistrationItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        timeregistration_itemget_response_schema_data.additional_properties = d
