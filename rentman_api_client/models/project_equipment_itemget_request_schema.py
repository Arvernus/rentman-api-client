...
from ..models.project_equipment_itemget_request_schema_custom import ProjectEquipmentItemgetRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectEquipmentItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ProjectEquipmentItemgetRequestSchema:
    """ """

    custom: Union[Unset, ProjectEquipmentItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectEquipmentItemgetRequestSchemaCustom.from_dict(_custom)
        ...
        project_equipment_itemget_request_schema = cls(
            custom=custom,
        ...
        project_equipment_itemget_request_schema.additional_properties = d
        return project_equipment_itemget_request_schema
