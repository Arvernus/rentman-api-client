...
T = TypeVar("T", bound="InvoiceCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InvoiceCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_collectionget_response_schema_data_item = cls(
        ...
        invoice_collectionget_response_schema_data_item.additional_properties = d
        return invoice_collectionget_response_schema_data_item
