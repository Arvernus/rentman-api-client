...
from ..models.project_equipment_itemput_response_schema_data_custom import (
...
class ProjectEquipmentItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_equipment_itemput_response_schema_data = cls(
            created=created,
            creator=creator,
            custom=custom,
        ...
        project_equipment_itemput_response_schema_data.additional_properties = d
        return project_equipment_itemput_response_schema_data
