...
T = TypeVar("T", bound="QuoteCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class QuoteCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        quote_collectionpost_response_schema_data_item = cls(
            contact=contact,
            created=created,
            creator=creator,
            customer=customer,
        ...
        quote_collectionpost_response_schema_data_item.additional_properties = d
