...
T = TypeVar("T", bound="InvoicelineItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class InvoicelineItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoiceline_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        invoiceline_itempost_response_schema_data.additional_properties = d
        return invoiceline_itempost_response_schema_data
