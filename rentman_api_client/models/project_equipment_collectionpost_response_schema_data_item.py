...
from ..models.project_equipment_collectionpost_response_schema_data_item_custom import (
    ProjectEquipmentCollectionpostResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectEquipmentCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectEquipmentCollectionpostResponseSchemaDataItem:
    """ """

    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ProjectEquipmentCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectEquipmentCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        project_equipment_collectionpost_response_schema_data_item = cls(
            created=created,
            creator=creator,
            custom=custom,
        ...
        project_equipment_collectionpost_response_schema_data_item.additional_properties = d
        return project_equipment_collectionpost_response_schema_data_item
