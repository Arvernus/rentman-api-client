...
from ..models.setinhoud_itemget_response_schema_data_is_fixed import SetinhoudItemgetResponseSchemaDataIsFixed
from ..types import UNSET, Unset

T = TypeVar("T", bound="SetinhoudItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class SetinhoudItemgetResponseSchemaData:
    ...
    is_fixed: Union[Unset, SetinhoudItemgetResponseSchemaDataIsFixed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_fixed, Unset):
            is_fixed = SetinhoudItemgetResponseSchemaDataIsFixed(_is_fixed)

        setinhoud_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        setinhoud_itemget_response_schema_data.additional_properties = d
        return setinhoud_itemget_response_schema_data
