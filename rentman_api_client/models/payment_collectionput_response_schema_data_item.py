...
from ..models.payment_collectionput_response_schema_data_item_payment_import_source import (
    PaymentCollectionputResponseSchemaDataItemPaymentImportSource,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PaymentCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PaymentCollectionputResponseSchemaDataItem:
    """ """
    ...
    payment_import_source: Union[Unset, PaymentCollectionputResponseSchemaDataItemPaymentImportSource] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_payment_import_source, Unset):
            payment_import_source = PaymentCollectionputResponseSchemaDataItemPaymentImportSource(
                _payment_import_source
            )

        payment_collectionput_response_schema_data_item = cls(
            amount=amount,
            created=created,
            creator=creator,
        ...
        payment_collectionput_response_schema_data_item.additional_properties = d
        return payment_collectionput_response_schema_data_item
