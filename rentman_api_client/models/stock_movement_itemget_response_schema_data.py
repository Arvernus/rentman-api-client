...
from ..models.stock_movement_itemget_response_schema_data_type import StockMovementItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="StockMovementItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class StockMovementItemgetResponseSchemaData:
    ...
    type: Union[Unset, StockMovementItemgetResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = StockMovementItemgetResponseSchemaDataType(_type)

        stock_movement_itemget_response_schema_data = cls(
            amount=amount,
            created=created,
            creator=creator,
            date=date,
        ...
        stock_movement_itemget_response_schema_data.additional_properties = d
        return stock_movement_itemget_response_schema_data
