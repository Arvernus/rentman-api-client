...
from ..models.equipment_itempost_request_schema_country_of_origin import EquipmentItempostRequestSchemaCountryOfOrigin
from ..models.equipment_itempost_request_schema_custom import EquipmentItempostRequestSchemaCustom
from ..models.equipment_itempost_request_schema_is_physical import EquipmentItempostRequestSchemaIsPhysical
from ..models.equipment_itempost_request_schema_rental_sales import EquipmentItempostRequestSchemaRentalSales
from ..models.equipment_itempost_request_schema_stock_management import EquipmentItempostRequestSchemaStockManagement
from ..models.equipment_itempost_request_schema_type import EquipmentItempostRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentItempostRequestSchema")


@attr.s(auto_attribs=True)
class EquipmentItempostRequestSchema:
    """ """

    can_edit_content_during_planning: Union[Unset, bool] = UNSET
    code: Union[Unset, str] = UNSET
    country_of_origin: Union[Unset, EquipmentItempostRequestSchemaCountryOfOrigin] = UNSET
    ...
    custom: Union[Unset, EquipmentItempostRequestSchemaCustom] = UNSET
    ...
    is_physical: Union[Unset, EquipmentItempostRequestSchemaIsPhysical] = UNSET
    ...
    rental_sales: Union[Unset, EquipmentItempostRequestSchemaRentalSales] = UNSET
    ...
    stock_management: Union[Unset, EquipmentItempostRequestSchemaStockManagement] = UNSET
    ...
    type: Union[Unset, EquipmentItempostRequestSchemaType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = EquipmentItempostRequestSchemaCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_custom, Unset):
            custom = EquipmentItempostRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = EquipmentItempostRequestSchemaIsPhysical(_is_physical)
        ...
        if not isinstance(_rental_sales, Unset):
            rental_sales = EquipmentItempostRequestSchemaRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = EquipmentItempostRequestSchemaStockManagement(_stock_management)
        ...
        if not isinstance(_type, Unset):
            type = EquipmentItempostRequestSchemaType(_type)
        ...
        equipment_itempost_request_schema = cls(
        ...
        equipment_itempost_request_schema.additional_properties = d
        return equipment_itempost_request_schema
