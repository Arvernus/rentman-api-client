...
from ..models.time_registration_collectionget_response_schema_data_item_custom import (
    TimeRegistrationCollectiongetResponseSchemaDataItemCustom,
)
from ..models.time_registration_collectionget_response_schema_data_item_type import (
    TimeRegistrationCollectiongetResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimeRegistrationCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class TimeRegistrationCollectiongetResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, TimeRegistrationCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    type: Union[Unset, TimeRegistrationCollectiongetResponseSchemaDataItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = TimeRegistrationCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = TimeRegistrationCollectiongetResponseSchemaDataItemType(_type)

        time_registration_collectionget_response_schema_data_item = cls(
        ...
        time_registration_collectionget_response_schema_data_item.additional_properties = d
        return time_registration_collectionget_response_schema_data_item
