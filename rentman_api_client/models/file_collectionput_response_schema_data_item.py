...
from ..models.file_collectionput_response_schema_data_item_previewstatus import (
    FileCollectionputResponseSchemaDataItemPreviewstatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FileCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FileCollectionputResponseSchemaDataItem:
    """ """
    ...
    previewstatus: Union[Unset, FileCollectionputResponseSchemaDataItemPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FileCollectionputResponseSchemaDataItemPreviewstatus(_previewstatus)
        ...
        file_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        file_collectionput_response_schema_data_item.additional_properties = d
        return file_collectionput_response_schema_data_item
