...
from ..models.file_itempost_request_schema_previewstatus import FileItempostRequestSchemaPreviewstatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="FileItempostRequestSchema")


@attr.s(auto_attribs=True)
class FileItempostRequestSchema:
    """ """
    ...
    previewstatus: Union[Unset, FileItempostRequestSchemaPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FileItempostRequestSchemaPreviewstatus(_previewstatus)
        ...
        file_itempost_request_schema = cls(
        ...
        file_itempost_request_schema.additional_properties = d
        return file_itempost_request_schema
