...
T = TypeVar("T", bound="MateriaalCatItempostRequestSchema")


@attr.s(auto_attribs=True)
class MateriaalCatItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        materiaal_cat_itempost_request_schema = cls(
            subproject=subproject,
        ...
        materiaal_cat_itempost_request_schema.additional_properties = d
        return materiaal_cat_itempost_request_schema
