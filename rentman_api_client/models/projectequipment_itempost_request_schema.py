...
from ..models.projectequipment_itempost_request_schema_custom import ProjectequipmentItempostRequestSchemaCustom
...
class ProjectequipmentItempostRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipment_itempost_request_schema = cls(
            equipment=equipment,
            parent=parent,
            ledger=ledger,
            quantity=quantity,
        ...
        projectequipment_itempost_request_schema.additional_properties = d
        return projectequipment_itempost_request_schema
