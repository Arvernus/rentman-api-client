...
from ..models.crew_itempost_request_schema_country import CrewItempostRequestSchemaCountry
from ..models.crew_itempost_request_schema_custom import CrewItempostRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewItempostRequestSchema")


@attr.s(auto_attribs=True)
class CrewItempostRequestSchema:
    """ """
    ...
    country: Union[Unset, CrewItempostRequestSchemaCountry] = UNSET
    ...
    custom: Union[Unset, CrewItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = CrewItempostRequestSchemaCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = CrewItempostRequestSchemaCustom.from_dict(_custom)

        crew_itempost_request_schema = cls(
            folder=folder,
            street=street,
        ...
        return crew_itempost_request_schema
