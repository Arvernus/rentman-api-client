...
from ..models.files_collectionpost_response_schema_data_item_previewstatus import (
    FilesCollectionpostResponseSchemaDataItemPreviewstatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FilesCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FilesCollectionpostResponseSchemaDataItem:
    """ """
    ...
    previewstatus: Union[Unset, FilesCollectionpostResponseSchemaDataItemPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FilesCollectionpostResponseSchemaDataItemPreviewstatus(_previewstatus)
        ...
        files_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        files_collectionpost_response_schema_data_item.additional_properties = d
