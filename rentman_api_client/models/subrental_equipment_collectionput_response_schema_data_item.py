...
class SubrentalEquipmentCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrental_equipment_collectionput_response_schema_data_item = cls(
            created=created,
            creator=creator,
            discount=discount,
        ...
        subrental_equipment_collectionput_response_schema_data_item.additional_properties = d
        return subrental_equipment_collectionput_response_schema_data_item
