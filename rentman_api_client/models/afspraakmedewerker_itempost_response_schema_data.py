...
T = TypeVar("T", bound="AfspraakmedewerkerItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class AfspraakmedewerkerItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        afspraakmedewerker_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        afspraakmedewerker_itempost_response_schema_data.additional_properties = d
