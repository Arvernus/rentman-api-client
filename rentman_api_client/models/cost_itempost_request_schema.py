...
from ..models.cost_itempost_request_schema_custom import CostItempostRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CostItempostRequestSchema")


@attr.s(auto_attribs=True)
class CostItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return cost_itempost_request_schema
