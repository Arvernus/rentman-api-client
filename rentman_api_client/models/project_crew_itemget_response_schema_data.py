...
from ..models.project_crew_itemget_response_schema_data_custom import ProjectCrewItemgetResponseSchemaDataCustom
from ..models.project_crew_itemget_response_schema_data_transport import ProjectCrewItemgetResponseSchemaDataTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCrewItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectCrewItemgetResponseSchemaData:
    ...
    custom: Union[Unset, ProjectCrewItemgetResponseSchemaDataCustom] = UNSET
    ...
    transport: Union[Unset, ProjectCrewItemgetResponseSchemaDataTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectCrewItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectCrewItemgetResponseSchemaDataTransport(_transport)

        visible = d.pop("visible", UNSET)

        project_crew_itemget_response_schema_data = cls(
        ...
        project_crew_itemget_response_schema_data.additional_properties = d
        return project_crew_itemget_response_schema_data
