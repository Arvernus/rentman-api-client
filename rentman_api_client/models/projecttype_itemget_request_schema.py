...
from ..models.projecttype_itemget_request_schema_type import ProjecttypeItemgetRequestSchemaType
...
class ProjecttypeItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projecttype_itemget_request_schema = cls(
            name=name,
            color=color,
            type=type,
        )

        projecttype_itemget_request_schema.additional_properties = d
