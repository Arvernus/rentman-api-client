...
T = TypeVar("T", bound="InvoiceLinesItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class InvoiceLinesItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_lines_itemget_response_schema_data = cls(
            base=base,
            created=created,
            creator=creator,
        ...
        invoice_lines_itemget_response_schema_data.additional_properties = d
        return invoice_lines_itemget_response_schema_data
