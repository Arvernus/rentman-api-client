...
from ..models.serialnumber_itempost_response_schema_data_custom import SerialnumberItempostResponseSchemaDataCustom
...
class SerialnumberItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialnumber_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        serialnumber_itempost_response_schema_data.additional_properties = d
        return serialnumber_itempost_response_schema_data
