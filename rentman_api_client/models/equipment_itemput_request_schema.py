...
from ..models.equipment_itemput_request_schema_custom import EquipmentItemputRequestSchemaCustom
from ..models.equipment_itemput_request_schema_is_physical import EquipmentItemputRequestSchemaIsPhysical
from ..models.equipment_itemput_request_schema_rental_sales import EquipmentItemputRequestSchemaRentalSales
from ..models.equipment_itemput_request_schema_stock_management import EquipmentItemputRequestSchemaStockManagement
from ..models.equipment_itemput_request_schema_type import EquipmentItemputRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentItemputRequestSchema")


@attr.s(auto_attribs=True)
class EquipmentItemputRequestSchema:
    """ """

    can_edit_content_during_planning: Union[Unset, bool] = UNSET
    code: Union[Unset, str] = UNSET
    country_of_origin: Union[Unset, EquipmentItemputRequestSchemaCountryOfOrigin] = UNSET
    ...
    custom: Union[Unset, EquipmentItemputRequestSchemaCustom] = UNSET
    ...
    is_physical: Union[Unset, EquipmentItemputRequestSchemaIsPhysical] = UNSET
    ...
    rental_sales: Union[Unset, EquipmentItemputRequestSchemaRentalSales] = UNSET
    ...
    stock_management: Union[Unset, EquipmentItemputRequestSchemaStockManagement] = UNSET
    ...
    type: Union[Unset, EquipmentItemputRequestSchemaType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = EquipmentItemputRequestSchemaCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_custom, Unset):
            custom = EquipmentItemputRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = EquipmentItemputRequestSchemaIsPhysical(_is_physical)
        ...
        if not isinstance(_rental_sales, Unset):
            rental_sales = EquipmentItemputRequestSchemaRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = EquipmentItemputRequestSchemaStockManagement(_stock_management)
        ...
        if not isinstance(_type, Unset):
            type = EquipmentItemputRequestSchemaType(_type)
        ...
        equipment_itemput_request_schema = cls(
        ...
        equipment_itemput_request_schema.additional_properties = d
        return equipment_itemput_request_schema
