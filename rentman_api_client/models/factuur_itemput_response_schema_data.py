...
T = TypeVar("T", bound="FactuurItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class FactuurItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        factuur_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        factuur_itemput_response_schema_data.additional_properties = d
        return factuur_itemput_response_schema_data
