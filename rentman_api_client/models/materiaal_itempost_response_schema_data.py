...
from ..models.materiaal_itempost_response_schema_data_country_of_origin import (
    MateriaalItempostResponseSchemaDataCountryOfOrigin,
)
from ..models.materiaal_itempost_response_schema_data_custom import MateriaalItempostResponseSchemaDataCustom
from ..models.materiaal_itempost_response_schema_data_is_physical import MateriaalItempostResponseSchemaDataIsPhysical
from ..models.materiaal_itempost_response_schema_data_rental_sales import MateriaalItempostResponseSchemaDataRentalSales
from ..models.materiaal_itempost_response_schema_data_stock_management import (
    MateriaalItempostResponseSchemaDataStockManagement,
)
from ..models.materiaal_itempost_response_schema_data_type import MateriaalItempostResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="MateriaalItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class MateriaalItempostResponseSchemaData:
    ...
    type: Union[Unset, MateriaalItempostResponseSchemaDataType] = UNSET
    rental_sales: Union[Unset, MateriaalItempostResponseSchemaDataRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, MateriaalItempostResponseSchemaDataStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, MateriaalItempostResponseSchemaDataCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, MateriaalItempostResponseSchemaDataIsPhysical] = UNSET
    ...
    custom: Union[Unset, MateriaalItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = MateriaalItempostResponseSchemaDataType(_type)

        rental_sales: Union[Unset, MateriaalItempostResponseSchemaDataRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = MateriaalItempostResponseSchemaDataRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = MateriaalItempostResponseSchemaDataStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = MateriaalItempostResponseSchemaDataCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = MateriaalItempostResponseSchemaDataIsPhysical(_is_physical)
        ...
        if not isinstance(_custom, Unset):
            custom = MateriaalItempostResponseSchemaDataCustom.from_dict(_custom)

        materiaal_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_itempost_response_schema_data.additional_properties = d
        return materiaal_itempost_response_schema_data
