...
class SubrentalequipmentgroupCollectionpostResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrentalequipmentgroup_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        subrentalequipmentgroup_collectionpost_response_schema_data_item.additional_properties = d
