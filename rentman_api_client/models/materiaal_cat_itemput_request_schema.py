...
T = TypeVar("T", bound="MateriaalCatItemputRequestSchema")


@attr.s(auto_attribs=True)
class MateriaalCatItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        materiaal_cat_itemput_request_schema = cls(
            subproject=subproject,
        ...
        materiaal_cat_itemput_request_schema.additional_properties = d
