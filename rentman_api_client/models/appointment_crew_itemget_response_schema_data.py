...
T = TypeVar("T", bound="AppointmentCrewItemgetResponseSchemaData")
...
class AppointmentCrewItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        appointment_crew_itemget_response_schema_data = cls(
        ...
        appointment_crew_itemget_response_schema_data.additional_properties = d
        return appointment_crew_itemget_response_schema_data
