...
from ..models.projectvehicle_itemget_request_schema_custom import ProjectvehicleItemgetRequestSchemaCustom
from ..models.projectvehicle_itemget_request_schema_transport import ProjectvehicleItemgetRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectvehicleItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ProjectvehicleItemgetRequestSchema:
    """ """

    vehicle: str
    cost_rate: Union[Unset, None, str] = UNSET
    transport: Union[Unset, ProjectvehicleItemgetRequestSchemaTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleItemgetRequestSchemaTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleItemgetRequestSchemaCustom.from_dict(_custom)

        projectvehicle_itemget_request_schema = cls(
            vehicle=vehicle,
            cost_rate=cost_rate,
            transport=transport,
        ...
        projectvehicle_itemget_request_schema.additional_properties = d
        return projectvehicle_itemget_request_schema
