...
from ..models.planningpersoneel_collectionget_response_schema_data_item_custom import (
    PlanningpersoneelCollectiongetResponseSchemaDataItemCustom,
)
from ..models.planningpersoneel_collectionget_response_schema_data_item_transport import (
    PlanningpersoneelCollectiongetResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningpersoneelCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PlanningpersoneelCollectiongetResponseSchemaDataItem:
    """ """
    ...
    transport: Union[Unset, PlanningpersoneelCollectiongetResponseSchemaDataItemTransport] = UNSET
    ...
    custom: Union[Unset, PlanningpersoneelCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningpersoneelCollectiongetResponseSchemaDataItemTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningpersoneelCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        planningpersoneel_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningpersoneel_collectionget_response_schema_data_item.additional_properties = d
