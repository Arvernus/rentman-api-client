...
from ..models.projectequipment_itemget_request_schema_custom import ProjectequipmentItemgetRequestSchemaCustom
...
class ProjectequipmentItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipment_itemget_request_schema = cls(
            equipment=equipment,
            parent=parent,
            ledger=ledger,
            quantity=quantity,
