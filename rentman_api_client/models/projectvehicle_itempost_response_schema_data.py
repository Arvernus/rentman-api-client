...
from ..models.projectvehicle_itempost_response_schema_data_custom import ProjectvehicleItempostResponseSchemaDataCustom
from ..models.projectvehicle_itempost_response_schema_data_transport import (
    ProjectvehicleItempostResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectvehicleItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectvehicleItempostResponseSchemaData:
    ...
    transport: Union[Unset, ProjectvehicleItempostResponseSchemaDataTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleItempostResponseSchemaDataTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleItempostResponseSchemaDataCustom.from_dict(_custom)

        projectvehicle_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectvehicle_itempost_response_schema_data.additional_properties = d
