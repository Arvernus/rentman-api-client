...
T = TypeVar("T", bound="MateriaalCatItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class MateriaalCatItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        materiaal_cat_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_cat_itempost_response_schema_data.additional_properties = d
        return materiaal_cat_itempost_response_schema_data
