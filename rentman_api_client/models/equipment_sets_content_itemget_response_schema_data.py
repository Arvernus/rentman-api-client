...
from ..models.equipment_sets_content_itemget_response_schema_data_is_fixed import (
    EquipmentSetsContentItemgetResponseSchemaDataIsFixed,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentSetsContentItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class EquipmentSetsContentItemgetResponseSchemaData:
    ...
    is_fixed: Union[Unset, EquipmentSetsContentItemgetResponseSchemaDataIsFixed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_fixed, Unset):
            is_fixed = EquipmentSetsContentItemgetResponseSchemaDataIsFixed(_is_fixed)
        ...
        equipment_sets_content_itemget_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        equipment_sets_content_itemget_response_schema_data.additional_properties = d
        return equipment_sets_content_itemget_response_schema_data
