...
from ..models.stockmovement_itemget_response_schema_data_type import StockmovementItemgetResponseSchemaDataType
...
class StockmovementItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stockmovement_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        stockmovement_itemget_response_schema_data.additional_properties = d
        return stockmovement_itemget_response_schema_data
