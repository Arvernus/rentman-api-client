...
T = TypeVar("T", bound="AccessoireItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class AccessoireItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        accessoire_itemget_response_schema_data.additional_properties = d
