...
from ..models.projectvehicle_collectionpost_response_schema_data_item_custom import (
    ProjectvehicleCollectionpostResponseSchemaDataItemCustom,
)
from ..models.projectvehicle_collectionpost_response_schema_data_item_transport import (
...
class ProjectvehicleCollectionpostResponseSchemaDataItem:
    """ """
    ...
    transport: Union[Unset, ProjectvehicleCollectionpostResponseSchemaDataItemTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleCollectionpostResponseSchemaDataItemTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        projectvehicle_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectvehicle_collectionpost_response_schema_data_item.additional_properties = d
        return projectvehicle_collectionpost_response_schema_data_item
