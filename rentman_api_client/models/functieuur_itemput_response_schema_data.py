...
T = TypeVar("T", bound="FunctieuurItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class FunctieuurItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        functieuur_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        functieuur_itemput_response_schema_data.additional_properties = d
        return functieuur_itemput_response_schema_data
