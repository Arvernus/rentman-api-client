...
from ..models.projectcrew_collectionput_response_schema_data_item_custom import (
    ProjectcrewCollectionputResponseSchemaDataItemCustom,
)
from ..models.projectcrew_collectionput_response_schema_data_item_transport import (
...
class ProjectcrewCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectcrew_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectcrew_collectionput_response_schema_data_item.additional_properties = d
        return projectcrew_collectionput_response_schema_data_item
