...
from ..models.project_crew_collectionput_response_schema_data_item_custom import (
    ProjectCrewCollectionputResponseSchemaDataItemCustom,
)
from ..models.project_crew_collectionput_response_schema_data_item_transport import (
    ProjectCrewCollectionputResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCrewCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectCrewCollectionputResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, ProjectCrewCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    transport: Union[Unset, ProjectCrewCollectionputResponseSchemaDataItemTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectCrewCollectionputResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectCrewCollectionputResponseSchemaDataItemTransport(_transport)

        visible = d.pop("visible", UNSET)

        project_crew_collectionput_response_schema_data_item = cls(
        ...
        project_crew_collectionput_response_schema_data_item.additional_properties = d
        return project_crew_collectionput_response_schema_data_item
