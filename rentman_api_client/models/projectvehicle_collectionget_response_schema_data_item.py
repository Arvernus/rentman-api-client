...
from ..models.projectvehicle_collectionget_response_schema_data_item_custom import (
    ProjectvehicleCollectiongetResponseSchemaDataItemCustom,
)
from ..models.projectvehicle_collectionget_response_schema_data_item_transport import (
...
class ProjectvehicleCollectiongetResponseSchemaDataItem:
    """ """
    ...
    transport: Union[Unset, ProjectvehicleCollectiongetResponseSchemaDataItemTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleCollectiongetResponseSchemaDataItemTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        projectvehicle_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectvehicle_collectionget_response_schema_data_item.additional_properties = d
