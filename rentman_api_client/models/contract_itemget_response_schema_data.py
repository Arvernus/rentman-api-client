...
T = TypeVar("T", bound="ContractItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ContractItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        contract_itemget_response_schema_data = cls(
            contact=contact,
            created=created,
            creator=creator,
            customer=customer,
        ...
        contract_itemget_response_schema_data.additional_properties = d
        return contract_itemget_response_schema_data
