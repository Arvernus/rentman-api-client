...
T = TypeVar("T", bound="OfferteCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class OfferteCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        offerte_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        offerte_collectionpost_response_schema_data_item.additional_properties = d
        return offerte_collectionpost_response_schema_data_item
