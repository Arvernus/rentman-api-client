...
T = TypeVar("T", bound="VoorraadmutatieItempostRequestSchema")


@attr.s(auto_attribs=True)
class VoorraadmutatieItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voorraadmutatie_itempost_request_schema = cls(
            amount=amount,
        ...
        voorraadmutatie_itempost_request_schema.additional_properties = d
