...
from ..models.timeregistration_itemput_request_schema_type import TimeregistrationItemputRequestSchemaType
...
class TimeregistrationItemputRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_itemput_request_schema = cls(
        ...
        timeregistration_itemput_request_schema.additional_properties = d
        return timeregistration_itemput_request_schema
