...
from ..models.medewerker_itemput_request_schema_country import MedewerkerItemputRequestSchemaCountry
from ..models.medewerker_itemput_request_schema_custom import MedewerkerItemputRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="MedewerkerItemputRequestSchema")


@attr.s(auto_attribs=True)
class MedewerkerItemputRequestSchema:
    """ """
    ...
    country: Union[Unset, MedewerkerItemputRequestSchemaCountry] = UNSET
    ...
    custom: Union[Unset, MedewerkerItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = MedewerkerItemputRequestSchemaCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = MedewerkerItemputRequestSchemaCustom.from_dict(_custom)

        medewerker_itemput_request_schema = cls(
            folder=folder,
            street=street,
        ...
        medewerker_itemput_request_schema.additional_properties = d
        return medewerker_itemput_request_schema
