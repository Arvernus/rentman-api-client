...
from ..models.files_itemput_response_schema_data_previewstatus import FilesItemputResponseSchemaDataPreviewstatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="FilesItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class FilesItemputResponseSchemaData:
    ...
    previewstatus: Union[Unset, FilesItemputResponseSchemaDataPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FilesItemputResponseSchemaDataPreviewstatus(_previewstatus)
        ...
        files_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        files_itemput_response_schema_data.additional_properties = d
        return files_itemput_response_schema_data
