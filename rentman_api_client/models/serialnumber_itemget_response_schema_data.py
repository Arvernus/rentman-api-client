...
from ..models.serialnumber_itemget_response_schema_data_custom import SerialnumberItemgetResponseSchemaDataCustom
...
class SerialnumberItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialnumber_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        serialnumber_itemget_response_schema_data.additional_properties = d
        return serialnumber_itemget_response_schema_data
