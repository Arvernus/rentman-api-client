...
from ..models.payment_itemput_response_schema_data_payment_import_source import (
    PaymentItemputResponseSchemaDataPaymentImportSource,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PaymentItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class PaymentItemputResponseSchemaData:
    ...
    payment_import_source: Union[Unset, PaymentItemputResponseSchemaDataPaymentImportSource] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_payment_import_source, Unset):
            payment_import_source = PaymentItemputResponseSchemaDataPaymentImportSource(_payment_import_source)

        payment_itemput_response_schema_data = cls(
            amount=amount,
            created=created,
            creator=creator,
        ...
        payment_itemput_response_schema_data.additional_properties = d
        return payment_itemput_response_schema_data
