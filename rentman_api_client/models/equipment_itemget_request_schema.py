...
from ..models.equipment_itemget_request_schema_country_of_origin import EquipmentItemgetRequestSchemaCountryOfOrigin
from ..models.equipment_itemget_request_schema_custom import EquipmentItemgetRequestSchemaCustom
from ..models.equipment_itemget_request_schema_is_physical import EquipmentItemgetRequestSchemaIsPhysical
from ..models.equipment_itemget_request_schema_rental_sales import EquipmentItemgetRequestSchemaRentalSales
from ..models.equipment_itemget_request_schema_stock_management import EquipmentItemgetRequestSchemaStockManagement
from ..models.equipment_itemget_request_schema_type import EquipmentItemgetRequestSchemaType
...
class EquipmentItemgetRequestSchema:
    """ """

    can_edit_content_during_planning: Union[Unset, bool] = UNSET
    code: Union[Unset, str] = UNSET
    country_of_origin: Union[Unset, EquipmentItemgetRequestSchemaCountryOfOrigin] = UNSET
    ...
    custom: Union[Unset, EquipmentItemgetRequestSchemaCustom] = UNSET
    ...
    is_physical: Union[Unset, EquipmentItemgetRequestSchemaIsPhysical] = UNSET
    ...
    rental_sales: Union[Unset, EquipmentItemgetRequestSchemaRentalSales] = UNSET
    ...
    stock_management: Union[Unset, EquipmentItemgetRequestSchemaStockManagement] = UNSET
    ...
    type: Union[Unset, EquipmentItemgetRequestSchemaType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = EquipmentItemgetRequestSchemaCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_custom, Unset):
            custom = EquipmentItemgetRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = EquipmentItemgetRequestSchemaIsPhysical(_is_physical)
        ...
        if not isinstance(_rental_sales, Unset):
            rental_sales = EquipmentItemgetRequestSchemaRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = EquipmentItemgetRequestSchemaStockManagement(_stock_management)
        ...
        if not isinstance(_type, Unset):
            type = EquipmentItemgetRequestSchemaType(_type)
        ...
        equipment_itemget_request_schema = cls(
        ...
        equipment_itemget_request_schema.additional_properties = d
        return equipment_itemget_request_schema
