...
from ..models.project_equipment_itempost_request_schema_custom import ProjectEquipmentItempostRequestSchemaCustom
...
class ProjectEquipmentItempostRequestSchema:
    """ """

    custom: Union[Unset, ProjectEquipmentItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectEquipmentItempostRequestSchemaCustom.from_dict(_custom)
        ...
        project_equipment_itempost_request_schema = cls(
            custom=custom,
        ...
        project_equipment_itempost_request_schema.additional_properties = d
        return project_equipment_itempost_request_schema
