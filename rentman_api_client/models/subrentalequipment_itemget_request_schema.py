...
class SubrentalequipmentItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrentalequipment_itemget_request_schema = cls(
            equipment=equipment,
            parent=parent,
        ...
        subrentalequipment_itemget_request_schema.additional_properties = d
        return subrentalequipment_itemget_request_schema
