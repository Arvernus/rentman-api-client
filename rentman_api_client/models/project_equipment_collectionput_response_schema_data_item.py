...
from ..models.project_equipment_collectionput_response_schema_data_item_custom import (
    ProjectEquipmentCollectionputResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectEquipmentCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectEquipmentCollectionputResponseSchemaDataItem:
    """ """

    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ProjectEquipmentCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectEquipmentCollectionputResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        project_equipment_collectionput_response_schema_data_item = cls(
            created=created,
            creator=creator,
            custom=custom,
        ...
        project_equipment_collectionput_response_schema_data_item.additional_properties = d
        return project_equipment_collectionput_response_schema_data_item
