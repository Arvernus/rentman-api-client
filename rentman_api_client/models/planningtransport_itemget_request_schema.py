...
from ..models.planningtransport_itemget_request_schema_custom import PlanningtransportItemgetRequestSchemaCustom
from ..models.planningtransport_itemget_request_schema_transport import PlanningtransportItemgetRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningtransportItemgetRequestSchema")


@attr.s(auto_attribs=True)
class PlanningtransportItemgetRequestSchema:
    """ """

    vehicle: str
    cost_rate: Union[Unset, None, str] = UNSET
    transport: Union[Unset, PlanningtransportItemgetRequestSchemaTransport] = UNSET
    ...
    custom: Union[Unset, PlanningtransportItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningtransportItemgetRequestSchemaTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningtransportItemgetRequestSchemaCustom.from_dict(_custom)

        planningtransport_itemget_request_schema = cls(
            vehicle=vehicle,
            cost_rate=cost_rate,
            transport=transport,
        ...
        planningtransport_itemget_request_schema.additional_properties = d
        return planningtransport_itemget_request_schema
