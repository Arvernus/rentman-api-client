...
from ..models.repair_collectionpost_response_schema_data_item_custom import (
    RepairCollectionpostResponseSchemaDataItemCustom,
)
from ..models.repair_collectionpost_response_schema_data_item_is_usable import (
    RepairCollectionpostResponseSchemaDataItemIsUsable,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RepairCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class RepairCollectionpostResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, RepairCollectionpostResponseSchemaDataItemCustom] = UNSET
    displayname: Union[Unset, str] = UNSET
    equipment: Union[Unset, str] = UNSET
    external_repairer: Union[Unset, None, str] = UNSET
    id: Union[Unset, int] = UNSET
    is_usable: Union[Unset, RepairCollectionpostResponseSchemaDataItemIsUsable] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = RepairCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = RepairCollectionpostResponseSchemaDataItemIsUsable(_is_usable)
        ...
        repair_collectionpost_response_schema_data_item = cls(
            amount=amount,
            assignee=assignee,
        ...
        repair_collectionpost_response_schema_data_item.additional_properties = d
        return repair_collectionpost_response_schema_data_item
