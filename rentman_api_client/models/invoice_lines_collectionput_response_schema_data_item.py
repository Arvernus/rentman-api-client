...
T = TypeVar("T", bound="InvoiceLinesCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InvoiceLinesCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_lines_collectionput_response_schema_data_item = cls(
            base=base,
            created=created,
            creator=creator,
        ...
        invoice_lines_collectionput_response_schema_data_item.additional_properties = d
        return invoice_lines_collectionput_response_schema_data_item
