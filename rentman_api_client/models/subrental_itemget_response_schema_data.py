...
from ..models.subrental_itemget_response_schema_data_custom import SubrentalItemgetResponseSchemaDataCustom
from ..models.subrental_itemget_response_schema_data_type import SubrentalItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubrentalItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class SubrentalItemgetResponseSchemaData:
    ...
    custom: Union[Unset, SubrentalItemgetResponseSchemaDataCustom] = UNSET
    ...
    type: Union[Unset, SubrentalItemgetResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = SubrentalItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = SubrentalItemgetResponseSchemaDataType(_type)
        ...
        subrental_itemget_response_schema_data = cls(
        ...
        subrental_itemget_response_schema_data.additional_properties = d
        return subrental_itemget_response_schema_data
