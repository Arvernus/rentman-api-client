...
from ..models.projectvehicle_itemput_response_schema_data_custom import ProjectvehicleItemputResponseSchemaDataCustom
from ..models.projectvehicle_itemput_response_schema_data_transport import (
    ProjectvehicleItemputResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectvehicleItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectvehicleItemputResponseSchemaData:
    ...
    transport: Union[Unset, ProjectvehicleItemputResponseSchemaDataTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleItemputResponseSchemaDataTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleItemputResponseSchemaDataCustom.from_dict(_custom)

        projectvehicle_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectvehicle_itemput_response_schema_data.additional_properties = d
        return projectvehicle_itemput_response_schema_data
