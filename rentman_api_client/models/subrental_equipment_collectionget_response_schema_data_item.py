...
T = TypeVar("T", bound="SubrentalEquipmentCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class SubrentalEquipmentCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrental_equipment_collectionget_response_schema_data_item = cls(
            created=created,
            creator=creator,
            discount=discount,
        ...
        subrental_equipment_collectionget_response_schema_data_item.additional_properties = d
        return subrental_equipment_collectionget_response_schema_data_item
