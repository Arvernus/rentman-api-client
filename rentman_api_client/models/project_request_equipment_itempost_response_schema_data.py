...
T = TypeVar("T", bound="ProjectRequestEquipmentItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectRequestEquipmentItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_request_equipment_itempost_response_schema_data = cls(
            created=created,
            creator=creator,
            discount=discount,
        ...
        project_request_equipment_itempost_response_schema_data.additional_properties = d
        return project_request_equipment_itempost_response_schema_data
