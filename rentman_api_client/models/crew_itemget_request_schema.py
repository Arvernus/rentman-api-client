...
from ..models.crew_itemget_request_schema_country import CrewItemgetRequestSchemaCountry
from ..models.crew_itemget_request_schema_custom import CrewItemgetRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewItemgetRequestSchema")


@attr.s(auto_attribs=True)
class CrewItemgetRequestSchema:
    """ """
    ...
    country: Union[Unset, CrewItemgetRequestSchemaCountry] = UNSET
    custom: Union[Unset, CrewItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = CrewItemgetRequestSchemaCountry(_country)

        custom: Union[Unset, CrewItemgetRequestSchemaCustom] = UNSET
        _custom = d.pop("custom", UNSET)
        if not isinstance(_custom, Unset):
            custom = CrewItemgetRequestSchemaCustom.from_dict(_custom)
        ...
        crew_itemget_request_schema = cls(
            active=active,
        ...
        crew_itemget_request_schema.additional_properties = d
        return crew_itemget_request_schema
