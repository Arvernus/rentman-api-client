...
from ..models.crew_availability_itemput_response_schema_data_recurrence_interval_unit import (
    CrewAvailabilityItemputResponseSchemaDataRecurrenceIntervalUnit,
)
from ..models.crew_availability_itemput_response_schema_data_status import (
    CrewAvailabilityItemputResponseSchemaDataStatus,
)
...
class CrewAvailabilityItemputResponseSchemaData:
    ...
    recurrence_interval_unit: Union[Unset, CrewAvailabilityItemputResponseSchemaDataRecurrenceIntervalUnit] = UNSET
    recurrent_group: Union[Unset, int] = UNSET
    remark: Union[Unset, str] = UNSET
    start: Union[Unset, None, datetime.datetime] = UNSET
    status: Union[Unset, CrewAvailabilityItemputResponseSchemaDataStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = CrewAvailabilityItemputResponseSchemaDataRecurrenceIntervalUnit(
        ...
        if not isinstance(_status, Unset):
            status = CrewAvailabilityItemputResponseSchemaDataStatus(_status)

        crew_availability_itemput_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        return crew_availability_itemput_response_schema_data
