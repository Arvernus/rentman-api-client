...
class ProjectequipmentgroupItempostRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipmentgroup_itempost_request_schema = cls(
            subproject=subproject,
        ...
        projectequipmentgroup_itempost_request_schema.additional_properties = d
        return projectequipmentgroup_itempost_request_schema
