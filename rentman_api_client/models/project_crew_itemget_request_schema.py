...
from ..models.project_crew_itemget_request_schema_custom import ProjectCrewItemgetRequestSchemaCustom
from ..models.project_crew_itemget_request_schema_transport import ProjectCrewItemgetRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCrewItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ProjectCrewItemgetRequestSchema:
    """ """

    crewmember: str
    cost_rate: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ProjectCrewItemgetRequestSchemaCustom] = UNSET
    ...
    transport: Union[Unset, ProjectCrewItemgetRequestSchemaTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectCrewItemgetRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectCrewItemgetRequestSchemaTransport(_transport)

        visible = d.pop("visible", UNSET)

        project_crew_itemget_request_schema = cls(
            crewmember=crewmember,
            cost_rate=cost_rate,
            custom=custom,
        ...
        project_crew_itemget_request_schema.additional_properties = d
        return project_crew_itemget_request_schema
