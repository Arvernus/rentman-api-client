...
from ..models.voertuig_itemget_response_schema_data_custom import VoertuigItemgetResponseSchemaDataCustom
from ..models.voertuig_itemget_response_schema_data_multiple import VoertuigItemgetResponseSchemaDataMultiple
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class VoertuigItemgetResponseSchemaData:
    ...
    multiple: Union[Unset, VoertuigItemgetResponseSchemaDataMultiple] = UNSET
    ...
    custom: Union[Unset, VoertuigItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigItemgetResponseSchemaDataMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigItemgetResponseSchemaDataCustom.from_dict(_custom)

        voertuig_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voertuig_itemget_response_schema_data.additional_properties = d
        return voertuig_itemget_response_schema_data
