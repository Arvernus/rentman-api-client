...
from ..models.project_equipment_itemget_response_schema_data_custom import (
    ProjectEquipmentItemgetResponseSchemaDataCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectEquipmentItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectEquipmentItemgetResponseSchemaData:
    """All the data about the requested items"""

    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ProjectEquipmentItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectEquipmentItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        project_equipment_itemget_response_schema_data = cls(
            created=created,
            creator=creator,
            custom=custom,
        ...
        project_equipment_itemget_response_schema_data.additional_properties = d
        return project_equipment_itemget_response_schema_data
