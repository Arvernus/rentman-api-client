...
from ..models.planningmateriaal_itempost_response_schema_data_custom import (
    PlanningmateriaalItempostResponseSchemaDataCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningmateriaalItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class PlanningmateriaalItempostResponseSchemaData:
    ...
    custom: Union[Unset, PlanningmateriaalItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningmateriaalItempostResponseSchemaDataCustom.from_dict(_custom)

        planningmateriaal_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningmateriaal_itempost_response_schema_data.additional_properties = d
