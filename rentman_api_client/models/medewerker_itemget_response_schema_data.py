...
from ..models.medewerker_itemget_response_schema_data_country import MedewerkerItemgetResponseSchemaDataCountry
from ..models.medewerker_itemget_response_schema_data_custom import MedewerkerItemgetResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="MedewerkerItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class MedewerkerItemgetResponseSchemaData:
    ...
    country: Union[Unset, MedewerkerItemgetResponseSchemaDataCountry] = UNSET
    ...
    custom: Union[Unset, MedewerkerItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = MedewerkerItemgetResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = MedewerkerItemgetResponseSchemaDataCustom.from_dict(_custom)

        medewerker_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        medewerker_itemget_response_schema_data.additional_properties = d
        return medewerker_itemget_response_schema_data
