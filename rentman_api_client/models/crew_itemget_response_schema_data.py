...
from ..models.crew_itemget_response_schema_data_country import CrewItemgetResponseSchemaDataCountry
from ..models.crew_itemget_response_schema_data_custom import CrewItemgetResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class CrewItemgetResponseSchemaData:
    ...
    country: Union[Unset, CrewItemgetResponseSchemaDataCountry] = UNSET
    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, CrewItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = CrewItemgetResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = CrewItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        crew_itemget_response_schema_data = cls(
            active=active,
        ...
        return crew_itemget_response_schema_data
