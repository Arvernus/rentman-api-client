...
from ..models.contactperson_collectionput_response_schema_data_item_country import (
    ContactpersonCollectionputResponseSchemaDataItemCountry,
)
from ..models.contactperson_collectionput_response_schema_data_item_custom import (
    ContactpersonCollectionputResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactpersonCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ContactpersonCollectionputResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, ContactpersonCollectionputResponseSchemaDataItemCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    tags: Union[Unset, str] = UNSET
    custom: Union[Unset, ContactpersonCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = ContactpersonCollectionputResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactpersonCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        contactperson_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        contactperson_collectionput_response_schema_data_item.additional_properties = d
