...
from ..models.project_crew_itempost_request_schema_custom import ProjectCrewItempostRequestSchemaCustom
from ..models.project_crew_itempost_request_schema_transport import ProjectCrewItempostRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCrewItempostRequestSchema")


@attr.s(auto_attribs=True)
class ProjectCrewItempostRequestSchema:
    """ """

    crewmember: str
    cost_rate: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ProjectCrewItempostRequestSchemaCustom] = UNSET
    ...
    transport: Union[Unset, ProjectCrewItempostRequestSchemaTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectCrewItempostRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectCrewItempostRequestSchemaTransport(_transport)

        visible = d.pop("visible", UNSET)

        project_crew_itempost_request_schema = cls(
            crewmember=crewmember,
            cost_rate=cost_rate,
            custom=custom,
        ...
        project_crew_itempost_request_schema.additional_properties = d
        return project_crew_itempost_request_schema
