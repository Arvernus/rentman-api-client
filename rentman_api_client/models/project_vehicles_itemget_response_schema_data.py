...
from ..models.project_vehicles_itemget_response_schema_data_custom import ProjectVehiclesItemgetResponseSchemaDataCustom
from ..models.project_vehicles_itemget_response_schema_data_transport import (
    ProjectVehiclesItemgetResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectVehiclesItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectVehiclesItemgetResponseSchemaData:
    ...
    custom: Union[Unset, ProjectVehiclesItemgetResponseSchemaDataCustom] = UNSET
    ...
    transport: Union[Unset, ProjectVehiclesItemgetResponseSchemaDataTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectVehiclesItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectVehiclesItemgetResponseSchemaDataTransport(_transport)

        vehicle = d.pop("vehicle", UNSET)

        project_vehicles_itemget_response_schema_data = cls(
            cost_rate=cost_rate,
            costs=costs,
            created=created,
            creator=creator,
        ...
        project_vehicles_itemget_response_schema_data.additional_properties = d
        return project_vehicles_itemget_response_schema_data
