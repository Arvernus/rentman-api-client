...
from ..models.cost_collectionput_response_schema_data_item_custom import CostCollectionputResponseSchemaDataItemCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CostCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class CostCollectionputResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, CostCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = CostCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        cost_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        cost_collectionput_response_schema_data_item.additional_properties = d
        return cost_collectionput_response_schema_data_item
