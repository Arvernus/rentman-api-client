...
from ..models.equipment_sets_content_itempost_response_schema_data_is_fixed import (
    EquipmentSetsContentItempostResponseSchemaDataIsFixed,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentSetsContentItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class EquipmentSetsContentItempostResponseSchemaData:
    ...
    is_fixed: Union[Unset, EquipmentSetsContentItempostResponseSchemaDataIsFixed] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_fixed, Unset):
            is_fixed = EquipmentSetsContentItempostResponseSchemaDataIsFixed(_is_fixed)
        ...
        equipment_sets_content_itempost_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        equipment_sets_content_itempost_response_schema_data.additional_properties = d
        return equipment_sets_content_itempost_response_schema_data
