...
from ..models.reparatie_collectionget_response_schema_data_item_custom import (
    ReparatieCollectiongetResponseSchemaDataItemCustom,
)
from ..models.reparatie_collectionget_response_schema_data_item_is_usable import (
    ReparatieCollectiongetResponseSchemaDataItemIsUsable,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReparatieCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ReparatieCollectiongetResponseSchemaDataItem:
    """ """
    ...
    is_usable: Union[Unset, ReparatieCollectiongetResponseSchemaDataItemIsUsable] = UNSET
    ...
    custom: Union[Unset, ReparatieCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = ReparatieCollectiongetResponseSchemaDataItemIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = ReparatieCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        reparatie_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        reparatie_collectionget_response_schema_data_item.additional_properties = d
        return reparatie_collectionget_response_schema_data_item
