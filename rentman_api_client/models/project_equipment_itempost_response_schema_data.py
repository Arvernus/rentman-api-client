...
from ..models.project_equipment_itempost_response_schema_data_custom import (
    ProjectEquipmentItempostResponseSchemaDataCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectEquipmentItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectEquipmentItempostResponseSchemaData:
    """All the data about the requested items"""

    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ProjectEquipmentItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectEquipmentItempostResponseSchemaDataCustom.from_dict(_custom)
        ...
        project_equipment_itempost_response_schema_data = cls(
            created=created,
            creator=creator,
            custom=custom,
        ...
        project_equipment_itempost_response_schema_data.additional_properties = d
        return project_equipment_itempost_response_schema_data
