...
from ..models.planningtransport_itemput_request_schema_custom import PlanningtransportItemputRequestSchemaCustom
from ..models.planningtransport_itemput_request_schema_transport import PlanningtransportItemputRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningtransportItemputRequestSchema")


@attr.s(auto_attribs=True)
class PlanningtransportItemputRequestSchema:
    """ """

    vehicle: str
    cost_rate: Union[Unset, None, str] = UNSET
    transport: Union[Unset, PlanningtransportItemputRequestSchemaTransport] = UNSET
    ...
    custom: Union[Unset, PlanningtransportItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningtransportItemputRequestSchemaTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningtransportItemputRequestSchemaCustom.from_dict(_custom)

        planningtransport_itemput_request_schema = cls(
            vehicle=vehicle,
            cost_rate=cost_rate,
            transport=transport,
        ...
        planningtransport_itemput_request_schema.additional_properties = d
