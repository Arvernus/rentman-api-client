...
from ..models.exemplaar_itemput_response_schema_data_custom import ExemplaarItemputResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExemplaarItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class ExemplaarItemputResponseSchemaData:
    ...
    custom: Union[Unset, ExemplaarItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ExemplaarItemputResponseSchemaDataCustom.from_dict(_custom)

        exemplaar_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        exemplaar_itemput_response_schema_data.additional_properties = d
        return exemplaar_itemput_response_schema_data
