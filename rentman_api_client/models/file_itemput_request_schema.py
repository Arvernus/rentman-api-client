...
from ..models.file_itemput_request_schema_previewstatus import FileItemputRequestSchemaPreviewstatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="FileItemputRequestSchema")


@attr.s(auto_attribs=True)
class FileItemputRequestSchema:
    """ """
    ...
    previewstatus: Union[Unset, FileItemputRequestSchemaPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FileItemputRequestSchemaPreviewstatus(_previewstatus)

        file_item = d.pop("file_item", UNSET)

        file_itemtype = d.pop("file_itemtype", UNSET)

        file_itemput_request_schema = cls(
        ...
        file_itemput_request_schema.additional_properties = d
        return file_itemput_request_schema
