...
from ..models.project_function_group_itemget_response_schema_data_planperiod_end_schedule_is_start import (
    ProjectFunctionGroupItemgetResponseSchemaDataPlanperiodEndScheduleIsStart,
)
from ..models.project_function_group_itemget_response_schema_data_planperiod_start_schedule_is_start import (
    ProjectFunctionGroupItemgetResponseSchemaDataPlanperiodStartScheduleIsStart,
)
from ..models.project_function_group_itemget_response_schema_data_usageperiod_end_schedule_is_start import (
    ProjectFunctionGroupItemgetResponseSchemaDataUsageperiodEndScheduleIsStart,
)
from ..models.project_function_group_itemget_response_schema_data_usageperiod_start_schedule_is_start import (
...
class ProjectFunctionGroupItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_function_group_itemget_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        project_function_group_itemget_response_schema_data.additional_properties = d
        return project_function_group_itemget_response_schema_data
