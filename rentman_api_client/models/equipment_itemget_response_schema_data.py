...
from ..models.equipment_itemget_response_schema_data_country_of_origin import (
    EquipmentItemgetResponseSchemaDataCountryOfOrigin,
)
from ..models.equipment_itemget_response_schema_data_custom import EquipmentItemgetResponseSchemaDataCustom
from ..models.equipment_itemget_response_schema_data_is_physical import EquipmentItemgetResponseSchemaDataIsPhysical
from ..models.equipment_itemget_response_schema_data_rental_sales import EquipmentItemgetResponseSchemaDataRentalSales
from ..models.equipment_itemget_response_schema_data_stock_management import (
    EquipmentItemgetResponseSchemaDataStockManagement,
)
from ..models.equipment_itemget_response_schema_data_type import EquipmentItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class EquipmentItemgetResponseSchemaData:
    ...
    type: Union[Unset, EquipmentItemgetResponseSchemaDataType] = UNSET
    rental_sales: Union[Unset, EquipmentItemgetResponseSchemaDataRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, EquipmentItemgetResponseSchemaDataStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, EquipmentItemgetResponseSchemaDataCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, EquipmentItemgetResponseSchemaDataIsPhysical] = UNSET
    ...
    current_quantity_excl_cases: Union[Unset, int] = UNSET
    current_quantity: Union[Unset, int] = UNSET
    quantity_in_cases: Union[Unset, int] = UNSET
    custom: Union[Unset, EquipmentItemgetResponseSchemaDataCustom] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        tags = self.tags
        current_quantity_excl_cases = self.current_quantity_excl_cases
        current_quantity = self.current_quantity
        quantity_in_cases = self.quantity_in_cases
        ...
        if current_quantity_excl_cases is not UNSET:
            field_dict["current_quantity_excl_cases"] = current_quantity_excl_cases
        if current_quantity is not UNSET:
            field_dict["current_quantity"] = current_quantity
        if quantity_in_cases is not UNSET:
            field_dict["quantity_in_cases"] = quantity_in_cases
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = EquipmentItemgetResponseSchemaDataType(_type)

        rental_sales: Union[Unset, EquipmentItemgetResponseSchemaDataRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = EquipmentItemgetResponseSchemaDataRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = EquipmentItemgetResponseSchemaDataStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = EquipmentItemgetResponseSchemaDataCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = EquipmentItemgetResponseSchemaDataIsPhysical(_is_physical)
        ...
        current_quantity_excl_cases = d.pop("current_quantity_excl_cases", UNSET)

        current_quantity = d.pop("current_quantity", UNSET)

        quantity_in_cases = d.pop("quantity_in_cases", UNSET)

        custom: Union[Unset, EquipmentItemgetResponseSchemaDataCustom] = UNSET
        _custom = d.pop("custom", UNSET)
        if not isinstance(_custom, Unset):
            custom = EquipmentItemgetResponseSchemaDataCustom.from_dict(_custom)

        equipment_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
            ...
            tags=tags,
            current_quantity_excl_cases=current_quantity_excl_cases,
            current_quantity=current_quantity,
            quantity_in_cases=quantity_in_cases,
            custom=custom,
        )

        equipment_itemget_response_schema_data.additional_properties = d
        return equipment_itemget_response_schema_data
