...
from ..models.planningpersoneel_itemput_response_schema_data_custom import (
    PlanningpersoneelItemputResponseSchemaDataCustom,
)
from ..models.planningpersoneel_itemput_response_schema_data_transport import (
    PlanningpersoneelItemputResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningpersoneelItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class PlanningpersoneelItemputResponseSchemaData:
    ...
    transport: Union[Unset, PlanningpersoneelItemputResponseSchemaDataTransport] = UNSET
    ...
    custom: Union[Unset, PlanningpersoneelItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningpersoneelItemputResponseSchemaDataTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningpersoneelItemputResponseSchemaDataCustom.from_dict(_custom)

        planningpersoneel_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningpersoneel_itemput_response_schema_data.additional_properties = d
        return planningpersoneel_itemput_response_schema_data
