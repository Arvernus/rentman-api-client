...
T = TypeVar("T", bound="VoorraadmutatieItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class VoorraadmutatieItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        voorraadmutatie_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voorraadmutatie_itempost_response_schema_data.additional_properties = d
        return voorraadmutatie_itempost_response_schema_data
