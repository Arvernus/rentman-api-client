...
from ..models.subrental_itempost_request_schema_custom import SubrentalItempostRequestSchemaCustom
from ..models.subrental_itempost_request_schema_type import SubrentalItempostRequestSchemaType
...
class SubrentalItempostRequestSchema:
    """ """
    ...
    type: Union[Unset, SubrentalItempostRequestSchemaType] = UNSET
    ...
    custom: Union[Unset, SubrentalItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = SubrentalItempostRequestSchemaType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = SubrentalItempostRequestSchemaCustom.from_dict(_custom)

        subrental_itempost_request_schema = cls(
            name=name,
        ...
        subrental_itempost_request_schema.additional_properties = d
        return subrental_itempost_request_schema
