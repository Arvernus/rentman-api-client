...
from ..models.exemplaar_collectionpost_response_schema_data_item_custom import (
    ExemplaarCollectionpostResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExemplaarCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ExemplaarCollectionpostResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, ExemplaarCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ExemplaarCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        exemplaar_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        exemplaar_collectionpost_response_schema_data_item.additional_properties = d
        return exemplaar_collectionpost_response_schema_data_item
