...
from ..models.projectcrew_itemput_response_schema_data_custom import ProjectcrewItemputResponseSchemaDataCustom
from ..models.projectcrew_itemput_response_schema_data_transport import ProjectcrewItemputResponseSchemaDataTransport
...
class ProjectcrewItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectcrew_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectcrew_itemput_response_schema_data.additional_properties = d
