...
class TimeRegistrationActivityCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_registration_activity_collectionget_response_schema_data_item = cls(
            created=created,
            creator=creator,
        ...
        time_registration_activity_collectionget_response_schema_data_item.additional_properties = d
        return time_registration_activity_collectionget_response_schema_data_item
