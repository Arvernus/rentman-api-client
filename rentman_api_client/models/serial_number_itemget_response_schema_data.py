...
from ..models.serial_number_itemget_response_schema_data_custom import SerialNumberItemgetResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="SerialNumberItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class SerialNumberItemgetResponseSchemaData:
    ...
    custom: Union[Unset, SerialNumberItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = SerialNumberItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        serial_number_itemget_response_schema_data = cls(
            active=active,
        ...
        serial_number_itemget_response_schema_data.additional_properties = d
        return serial_number_itemget_response_schema_data
