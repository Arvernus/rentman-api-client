...
T = TypeVar("T", bound="InhuurgroepCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InhuurgroepCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurgroep_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurgroep_collectionpost_response_schema_data_item.additional_properties = d
        return inhuurgroep_collectionpost_response_schema_data_item
