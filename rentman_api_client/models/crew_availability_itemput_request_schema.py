...
from ..models.crew_availability_itemput_request_schema_recurrence_interval_unit import (
    CrewAvailabilityItemputRequestSchemaRecurrenceIntervalUnit,
)
from ..models.crew_availability_itemput_request_schema_status import CrewAvailabilityItemputRequestSchemaStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewAvailabilityItemputRequestSchema")


@attr.s(auto_attribs=True)
class CrewAvailabilityItemputRequestSchema:
    """ """
    ...
    status: Union[Unset, CrewAvailabilityItemputRequestSchemaStatus] = UNSET
    remark: Union[Unset, str] = UNSET
    recurrence_interval_unit: Union[Unset, CrewAvailabilityItemputRequestSchemaRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = CrewAvailabilityItemputRequestSchemaStatus(_status)
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = CrewAvailabilityItemputRequestSchemaRecurrenceIntervalUnit(
        ...
        crew_availability_itemput_request_schema = cls(
        ...
        return crew_availability_itemput_request_schema
