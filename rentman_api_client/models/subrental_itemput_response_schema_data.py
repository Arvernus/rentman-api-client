...
from ..models.subrental_itemput_response_schema_data_type import SubrentalItemputResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubrentalItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class SubrentalItemputResponseSchemaData:
    ...
    type: Union[Unset, SubrentalItemputResponseSchemaDataType] = UNSET
    ...
    custom: Union[Unset, SubrentalItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = SubrentalItemputResponseSchemaDataType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = SubrentalItemputResponseSchemaDataCustom.from_dict(_custom)

        subrental_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        subrental_itemput_response_schema_data.additional_properties = d
