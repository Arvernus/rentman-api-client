...
T = TypeVar("T", bound="ProjectRequestEquipmentItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectRequestEquipmentItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_request_equipment_itemget_response_schema_data = cls(
            created=created,
            creator=creator,
            discount=discount,
        ...
        project_request_equipment_itemget_response_schema_data.additional_properties = d
        return project_request_equipment_itemget_response_schema_data
