...
T = TypeVar("T", bound="AccessoryItemputRequestSchema")


@attr.s(auto_attribs=True)
class AccessoryItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessory_itemput_request_schema = cls(
        ...
        accessory_itemput_request_schema.additional_properties = d
        return accessory_itemput_request_schema
