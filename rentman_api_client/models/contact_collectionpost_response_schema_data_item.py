...
from ..models.contact_collectionpost_response_schema_data_item_country import (
    ContactCollectionpostResponseSchemaDataItemCountry,
)
from ..models.contact_collectionpost_response_schema_data_item_custom import (
    ContactCollectionpostResponseSchemaDataItemCustom,
)
from ..models.contact_collectionpost_response_schema_data_item_invoice_country import (
    ContactCollectionpostResponseSchemaDataItemInvoiceCountry,
)
from ..models.contact_collectionpost_response_schema_data_item_mailing_country import (
    ContactCollectionpostResponseSchemaDataItemMailingCountry,
)
from ..models.contact_collectionpost_response_schema_data_item_type import (
    ContactCollectionpostResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ContactCollectionpostResponseSchemaDataItem:
    """ """
    ...
    type: Union[Unset, ContactCollectionpostResponseSchemaDataItemType] = UNSET
    ...
    mailing_country: Union[Unset, ContactCollectionpostResponseSchemaDataItemMailingCountry] = UNSET
    ...
    country: Union[Unset, ContactCollectionpostResponseSchemaDataItemCountry] = UNSET
    ...
    invoice_country: Union[Unset, ContactCollectionpostResponseSchemaDataItemInvoiceCountry] = UNSET
    ...
    custom: Union[Unset, ContactCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = ContactCollectionpostResponseSchemaDataItemType(_type)
        ...
        if not isinstance(_mailing_country, Unset):
            mailing_country = ContactCollectionpostResponseSchemaDataItemMailingCountry(_mailing_country)
        ...
        if not isinstance(_country, Unset):
            country = ContactCollectionpostResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_invoice_country, Unset):
            invoice_country = ContactCollectionpostResponseSchemaDataItemInvoiceCountry(_invoice_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        contact_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        contact_collectionpost_response_schema_data_item.additional_properties = d
        return contact_collectionpost_response_schema_data_item
