...
from ..models.project_vehicles_collectionput_response_schema_data_item_custom import (
    ProjectVehiclesCollectionputResponseSchemaDataItemCustom,
)
from ..models.project_vehicles_collectionput_response_schema_data_item_transport import (
    ProjectVehiclesCollectionputResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectVehiclesCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectVehiclesCollectionputResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, ProjectVehiclesCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    transport: Union[Unset, ProjectVehiclesCollectionputResponseSchemaDataItemTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectVehiclesCollectionputResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectVehiclesCollectionputResponseSchemaDataItemTransport(_transport)

        vehicle = d.pop("vehicle", UNSET)

        project_vehicles_collectionput_response_schema_data_item = cls(
            cost_rate=cost_rate,
            costs=costs,
            created=created,
            creator=creator,
        ...
        project_vehicles_collectionput_response_schema_data_item.additional_properties = d
        return project_vehicles_collectionput_response_schema_data_item
