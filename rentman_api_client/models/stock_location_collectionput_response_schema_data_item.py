...
from ..models.stock_location_collectionput_response_schema_data_item_country import (
    StockLocationCollectionputResponseSchemaDataItemCountry,
)
from ..models.stock_location_collectionput_response_schema_data_item_type import (
...
class StockLocationCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stock_location_collectionput_response_schema_data_item = cls(
            active=active,
            city=city,
            color=color,
            country=country,
        ...
        stock_location_collectionput_response_schema_data_item.additional_properties = d
        return stock_location_collectionput_response_schema_data_item
