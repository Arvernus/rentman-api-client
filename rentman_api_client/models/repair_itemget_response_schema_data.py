...
from ..models.repair_itemget_response_schema_data_custom import RepairItemgetResponseSchemaDataCustom
from ..models.repair_itemget_response_schema_data_is_usable import RepairItemgetResponseSchemaDataIsUsable
from ..types import UNSET, Unset

T = TypeVar("T", bound="RepairItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class RepairItemgetResponseSchemaData:
    ...
    is_usable: Union[Unset, RepairItemgetResponseSchemaDataIsUsable] = UNSET
    ...
    custom: Union[Unset, RepairItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = RepairItemgetResponseSchemaDataIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = RepairItemgetResponseSchemaDataCustom.from_dict(_custom)

        repair_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        repair_itemget_response_schema_data.additional_properties = d
        return repair_itemget_response_schema_data
