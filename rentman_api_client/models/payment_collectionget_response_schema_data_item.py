...
from ..models.payment_collectionget_response_schema_data_item_payment_import_source import (
    PaymentCollectiongetResponseSchemaDataItemPaymentImportSource,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PaymentCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PaymentCollectiongetResponseSchemaDataItem:
    """ """
    ...
    payment_import_source: Union[Unset, PaymentCollectiongetResponseSchemaDataItemPaymentImportSource] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_payment_import_source, Unset):
            payment_import_source = PaymentCollectiongetResponseSchemaDataItemPaymentImportSource(
                _payment_import_source
            )

        payment_collectionget_response_schema_data_item = cls(
            amount=amount,
            created=created,
            creator=creator,
        ...
        payment_collectionget_response_schema_data_item.additional_properties = d
        return payment_collectionget_response_schema_data_item
