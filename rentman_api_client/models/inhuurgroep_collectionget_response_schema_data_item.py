...
T = TypeVar("T", bound="InhuurgroepCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class InhuurgroepCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurgroep_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurgroep_collectionget_response_schema_data_item.additional_properties = d
