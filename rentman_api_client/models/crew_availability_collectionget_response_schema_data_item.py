...
from ..models.crew_availability_collectionget_response_schema_data_item_recurrence_interval_unit import (
    CrewAvailabilityCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit,
)
from ..models.crew_availability_collectionget_response_schema_data_item_status import (
    CrewAvailabilityCollectiongetResponseSchemaDataItemStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewAvailabilityCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class CrewAvailabilityCollectiongetResponseSchemaDataItem:
    """ """
    ...
    recurrence_interval_unit: Union[
        Unset, CrewAvailabilityCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit
    ] = UNSET
    recurrent_group: Union[Unset, int] = UNSET
    remark: Union[Unset, str] = UNSET
    start: Union[Unset, None, datetime.datetime] = UNSET
    status: Union[Unset, CrewAvailabilityCollectiongetResponseSchemaDataItemStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = CrewAvailabilityCollectiongetResponseSchemaDataItemRecurrenceIntervalUnit(
        ...
        if not isinstance(_status, Unset):
            status = CrewAvailabilityCollectiongetResponseSchemaDataItemStatus(_status)

        crew_availability_collectionget_response_schema_data_item = cls(
            created=created,
            creator=creator,
        ...
        crew_availability_collectionget_response_schema_data_item.additional_properties = d
        return crew_availability_collectionget_response_schema_data_item
