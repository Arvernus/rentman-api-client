...
class ProjectequipmentgroupCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipmentgroup_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectequipmentgroup_collectionput_response_schema_data_item.additional_properties = d
        return projectequipmentgroup_collectionput_response_schema_data_item
