...
from ..models.projectvehicle_itempost_request_schema_custom import ProjectvehicleItempostRequestSchemaCustom
from ..models.projectvehicle_itempost_request_schema_transport import ProjectvehicleItempostRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectvehicleItempostRequestSchema")
...
class ProjectvehicleItempostRequestSchema:
    ...
    transport: Union[Unset, ProjectvehicleItempostRequestSchemaTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleItempostRequestSchemaTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleItempostRequestSchemaCustom.from_dict(_custom)

        projectvehicle_itempost_request_schema = cls(
            vehicle=vehicle,
            cost_rate=cost_rate,
            transport=transport,
        ...
        projectvehicle_itempost_request_schema.additional_properties = d
