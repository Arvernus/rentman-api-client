...
T = TypeVar("T", bound="QuoteItemputRequestSchema")


@attr.s(auto_attribs=True)
class QuoteItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        quote_itemput_request_schema = cls(
            number=number,
            customer=customer,
            contact=contact,
            date=date,
        ...
        quote_itemput_request_schema.additional_properties = d
        return quote_itemput_request_schema
