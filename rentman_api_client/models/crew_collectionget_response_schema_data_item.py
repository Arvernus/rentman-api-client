...
from ..models.crew_collectionget_response_schema_data_item_custom import CrewCollectiongetResponseSchemaDataItemCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class CrewCollectiongetResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, CrewCollectiongetResponseSchemaDataItemCountry] = UNSET
    ...
    custom: Union[Unset, CrewCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = CrewCollectiongetResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = CrewCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        crew_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        crew_collectionget_response_schema_data_item.additional_properties = d
        return crew_collectionget_response_schema_data_item
