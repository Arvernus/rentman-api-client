...
from ..models.project_function_itemget_response_schema_data_custom import ProjectFunctionItemgetResponseSchemaDataCustom
from ..models.project_function_itemget_response_schema_data_planperiod_end_schedule_is_start import (
    ProjectFunctionItemgetResponseSchemaDataPlanperiodEndScheduleIsStart,
)
from ..models.project_function_itemget_response_schema_data_planperiod_start_schedule_is_start import (
    ProjectFunctionItemgetResponseSchemaDataPlanperiodStartScheduleIsStart,
)
from ..models.project_function_itemget_response_schema_data_type import ProjectFunctionItemgetResponseSchemaDataType
from ..models.project_function_itemget_response_schema_data_usageperiod_end_schedule_is_start import (
    ProjectFunctionItemgetResponseSchemaDataUsageperiodEndScheduleIsStart,
)
from ..models.project_function_itemget_response_schema_data_usageperiod_start_schedule_is_start import (
    ProjectFunctionItemgetResponseSchemaDataUsageperiodStartScheduleIsStart,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectFunctionItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectFunctionItemgetResponseSchemaData:
    ...
    custom: Union[Unset, ProjectFunctionItemgetResponseSchemaDataCustom] = UNSET
    ...
    planperiod_start_schedule_is_start: Union[
        Unset, ProjectFunctionItemgetResponseSchemaDataPlanperiodStartScheduleIsStart
    ] = UNSET
    ...
    type: Union[Unset, ProjectFunctionItemgetResponseSchemaDataType] = UNSET
    usageperiod_end: Union[Unset, None, datetime.datetime] = UNSET
    usageperiod_end_schedule_is_start: Union[
        Unset, ProjectFunctionItemgetResponseSchemaDataUsageperiodEndScheduleIsStart
    ] = UNSET
    usageperiod_start: Union[Unset, None, datetime.datetime] = UNSET
    usageperiod_start_schedule_is_start: Union[
        Unset, ProjectFunctionItemgetResponseSchemaDataUsageperiodStartScheduleIsStart
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectFunctionItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_planperiod_start_schedule_is_start, Unset):
            planperiod_start_schedule_is_start = ProjectFunctionItemgetResponseSchemaDataPlanperiodStartScheduleIsStart(
        ...
        if not isinstance(_type, Unset):
            type = ProjectFunctionItemgetResponseSchemaDataType(_type)
        ...
        if not isinstance(_usageperiod_end_schedule_is_start, Unset):
            usageperiod_end_schedule_is_start = ProjectFunctionItemgetResponseSchemaDataUsageperiodEndScheduleIsStart(
        ...
        project_function_itemget_response_schema_data = cls(
            amount=amount,
            break_=break_,
            cost_rate=cost_rate,
        ...
        project_function_itemget_response_schema_data.additional_properties = d
        return project_function_itemget_response_schema_data
