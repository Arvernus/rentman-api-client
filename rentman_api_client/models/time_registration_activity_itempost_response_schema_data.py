...
T = TypeVar("T", bound="TimeRegistrationActivityItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class TimeRegistrationActivityItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        time_registration_activity_itempost_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        time_registration_activity_itempost_response_schema_data.additional_properties = d
        return time_registration_activity_itempost_response_schema_data
