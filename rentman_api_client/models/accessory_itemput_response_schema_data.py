...
T = TypeVar("T", bound="AccessoryItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class AccessoryItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessory_itemput_response_schema_data = cls(
        ...
        accessory_itemput_response_schema_data.additional_properties = d
