...
from ..models.contact_itemput_response_schema_data_country import ContactItemputResponseSchemaDataCountry
from ..models.contact_itemput_response_schema_data_custom import ContactItemputResponseSchemaDataCustom
from ..models.contact_itemput_response_schema_data_invoice_country import ContactItemputResponseSchemaDataInvoiceCountry
from ..models.contact_itemput_response_schema_data_mailing_country import ContactItemputResponseSchemaDataMailingCountry
from ..models.contact_itemput_response_schema_data_type import ContactItemputResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class ContactItemputResponseSchemaData:
    ...
    country: Union[Unset, ContactItemputResponseSchemaDataCountry] = UNSET
    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ContactItemputResponseSchemaDataCustom] = UNSET
    ...
    invoice_country: Union[Unset, ContactItemputResponseSchemaDataInvoiceCountry] = UNSET
    ...
    mailing_country: Union[Unset, ContactItemputResponseSchemaDataMailingCountry] = UNSET
    ...
    type: Union[Unset, ContactItemputResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = ContactItemputResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactItemputResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_invoice_country, Unset):
            invoice_country = ContactItemputResponseSchemaDataInvoiceCountry(_invoice_country)
        ...
        if not isinstance(_mailing_country, Unset):
            mailing_country = ContactItemputResponseSchemaDataMailingCountry(_mailing_country)
        ...
        if not isinstance(_type, Unset):
            type = ContactItemputResponseSchemaDataType(_type)
        ...
        contact_itemput_response_schema_data = cls(
        ...
        contact_itemput_response_schema_data.additional_properties = d
        return contact_itemput_response_schema_data
