...
from ..models.equipmentsetscontent_collectionpost_response_schema_data_item_is_fixed import (
...
class EquipmentsetscontentCollectionpostResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        equipmentsetscontent_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        equipmentsetscontent_collectionpost_response_schema_data_item.additional_properties = d
        return equipmentsetscontent_collectionpost_response_schema_data_item
