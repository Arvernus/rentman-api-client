...
from ..models.projectcrew_itempost_request_schema_transport import ProjectcrewItempostRequestSchemaTransport
...
class ProjectcrewItempostRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectcrew_itempost_request_schema = cls(
            crewmember=crewmember,
            cost_rate=cost_rate,
            visible=visible,
        ...
        return projectcrew_itempost_request_schema
