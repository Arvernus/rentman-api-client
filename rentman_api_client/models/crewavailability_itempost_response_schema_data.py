...
from ..models.crewavailability_itempost_response_schema_data_recurrence_interval_unit import (
    CrewavailabilityItempostResponseSchemaDataRecurrenceIntervalUnit,
)
from ..models.crewavailability_itempost_response_schema_data_status import (
...
class CrewavailabilityItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        crewavailability_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        crewavailability_itempost_response_schema_data.additional_properties = d
