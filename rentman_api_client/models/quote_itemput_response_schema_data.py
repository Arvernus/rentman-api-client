...
T = TypeVar("T", bound="QuoteItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class QuoteItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        quote_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return quote_itemput_response_schema_data
