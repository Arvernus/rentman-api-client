...
T = TypeVar("T", bound="InvoiceCollectionputResponseSchemaDataItem")
...
class InvoiceCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        invoice_collectionput_response_schema_data_item.additional_properties = d
        return invoice_collectionput_response_schema_data_item
