...
from ..models.beschikbaarheid_itemput_response_schema_data_recurrence_interval_unit import (
    BeschikbaarheidItemputResponseSchemaDataRecurrenceIntervalUnit,
)
from ..models.beschikbaarheid_itemput_response_schema_data_status import BeschikbaarheidItemputResponseSchemaDataStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="BeschikbaarheidItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class BeschikbaarheidItemputResponseSchemaData:
    ...
    status: Union[Unset, BeschikbaarheidItemputResponseSchemaDataStatus] = UNSET
    remark: Union[Unset, str] = UNSET
    recurrence_interval_unit: Union[Unset, BeschikbaarheidItemputResponseSchemaDataRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = BeschikbaarheidItemputResponseSchemaDataStatus(_status)
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = BeschikbaarheidItemputResponseSchemaDataRecurrenceIntervalUnit(
        ...
        beschikbaarheid_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        beschikbaarheid_itemput_response_schema_data.additional_properties = d
