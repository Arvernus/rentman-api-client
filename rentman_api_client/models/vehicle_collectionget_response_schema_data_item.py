...
from ..models.vehicle_collectionget_response_schema_data_item_custom import (
    VehicleCollectiongetResponseSchemaDataItemCustom,
)
from ..models.vehicle_collectionget_response_schema_data_item_multiple import (
    VehicleCollectiongetResponseSchemaDataItemMultiple,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VehicleCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class VehicleCollectiongetResponseSchemaDataItem:
    """ """
    ...
    multiple: Union[Unset, VehicleCollectiongetResponseSchemaDataItemMultiple] = UNSET
    ...
    custom: Union[Unset, VehicleCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VehicleCollectiongetResponseSchemaDataItemMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VehicleCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        vehicle_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return vehicle_collectionget_response_schema_data_item
