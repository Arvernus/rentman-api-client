...
from ..models.voertuig_itemput_request_schema_custom import VoertuigItemputRequestSchemaCustom
from ..models.voertuig_itemput_request_schema_multiple import VoertuigItemputRequestSchemaMultiple
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigItemputRequestSchema")


@attr.s(auto_attribs=True)
class VoertuigItemputRequestSchema:
    """ """
    ...
    multiple: Union[Unset, VoertuigItemputRequestSchemaMultiple] = UNSET
    image: Union[Unset, None, str] = UNSET
    custom: Union[Unset, VoertuigItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigItemputRequestSchemaMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigItemputRequestSchemaCustom.from_dict(_custom)

        voertuig_itemput_request_schema = cls(
            folder=folder,
            name=name,
            cost_rate=cost_rate,
        ...
        voertuig_itemput_request_schema.additional_properties = d
        return voertuig_itemput_request_schema
