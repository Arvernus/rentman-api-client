...
from ..models.projectequipment_collectionget_response_schema_data_item_custom import (
...
class ProjectequipmentCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectequipment_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectequipment_collectionget_response_schema_data_item.additional_properties = d
        return projectequipment_collectionget_response_schema_data_item
