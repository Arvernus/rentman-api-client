...
from ..models.files_itemget_response_schema_data_previewstatus import FilesItemgetResponseSchemaDataPreviewstatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="FilesItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class FilesItemgetResponseSchemaData:
    ...
    previewstatus: Union[Unset, FilesItemgetResponseSchemaDataPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FilesItemgetResponseSchemaDataPreviewstatus(_previewstatus)
        ...
        files_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        files_itemget_response_schema_data.additional_properties = d
        return files_itemget_response_schema_data
