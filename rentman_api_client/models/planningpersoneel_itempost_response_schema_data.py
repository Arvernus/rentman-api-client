...
from ..models.planningpersoneel_itempost_response_schema_data_custom import (
    PlanningpersoneelItempostResponseSchemaDataCustom,
)
from ..models.planningpersoneel_itempost_response_schema_data_transport import (
    PlanningpersoneelItempostResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningpersoneelItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class PlanningpersoneelItempostResponseSchemaData:
    ...
    transport: Union[Unset, PlanningpersoneelItempostResponseSchemaDataTransport] = UNSET
    ...
    custom: Union[Unset, PlanningpersoneelItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningpersoneelItempostResponseSchemaDataTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningpersoneelItempostResponseSchemaDataCustom.from_dict(_custom)

        planningpersoneel_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningpersoneel_itempost_response_schema_data.additional_properties = d
        return planningpersoneel_itempost_response_schema_data
