...
from ..models.payment_itempost_response_schema_data_payment_import_source import (
    PaymentItempostResponseSchemaDataPaymentImportSource,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PaymentItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class PaymentItempostResponseSchemaData:
    ...
    payment_import_source: Union[Unset, PaymentItempostResponseSchemaDataPaymentImportSource] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_payment_import_source, Unset):
            payment_import_source = PaymentItempostResponseSchemaDataPaymentImportSource(_payment_import_source)

        payment_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        payment_itempost_response_schema_data.additional_properties = d
        return payment_itempost_response_schema_data
