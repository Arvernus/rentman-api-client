...
from ..models.subrental_itempost_response_schema_data_custom import SubrentalItempostResponseSchemaDataCustom
from ..models.subrental_itempost_response_schema_data_type import SubrentalItempostResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubrentalItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class SubrentalItempostResponseSchemaData:
    ...
    type: Union[Unset, SubrentalItempostResponseSchemaDataType] = UNSET
    ...
    custom: Union[Unset, SubrentalItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = SubrentalItempostResponseSchemaDataType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = SubrentalItempostResponseSchemaDataCustom.from_dict(_custom)

        subrental_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return subrental_itempost_response_schema_data
