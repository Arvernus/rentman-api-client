...
from ..models.voertuig_collectionpost_response_schema_data_item_custom import (
    VoertuigCollectionpostResponseSchemaDataItemCustom,
)
from ..models.voertuig_collectionpost_response_schema_data_item_multiple import (
    VoertuigCollectionpostResponseSchemaDataItemMultiple,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class VoertuigCollectionpostResponseSchemaDataItem:
    """ """
    ...
    multiple: Union[Unset, VoertuigCollectionpostResponseSchemaDataItemMultiple] = UNSET
    ...
    custom: Union[Unset, VoertuigCollectionpostResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigCollectionpostResponseSchemaDataItemMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigCollectionpostResponseSchemaDataItemCustom.from_dict(_custom)

        voertuig_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        voertuig_collectionpost_response_schema_data_item.additional_properties = d
