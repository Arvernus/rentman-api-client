...
from ..models.file_collectionget_response_schema_data_item_previewstatus import (
    FileCollectiongetResponseSchemaDataItemPreviewstatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FileCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FileCollectiongetResponseSchemaDataItem:
    """ """
    ...
    previewstatus: Union[Unset, FileCollectiongetResponseSchemaDataItemPreviewstatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_previewstatus, Unset):
            previewstatus = FileCollectiongetResponseSchemaDataItemPreviewstatus(_previewstatus)
        ...
        file_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        file_collectionget_response_schema_data_item.additional_properties = d
