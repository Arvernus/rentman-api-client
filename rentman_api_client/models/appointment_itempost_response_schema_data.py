...
T = TypeVar("T", bound="AppointmentItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class AppointmentItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        appointment_itempost_response_schema_data = cls(
            color=color,
            created=created,
            creator=creator,
        ...
        appointment_itempost_response_schema_data.additional_properties = d
        return appointment_itempost_response_schema_data
