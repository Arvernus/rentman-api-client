...
from ..models.equipment_sets_content_itemput_response_schema_data_is_fixed import (
...
class EquipmentSetsContentItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        equipment_sets_content_itemput_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        equipment_sets_content_itemput_response_schema_data.additional_properties = d
        return equipment_sets_content_itemput_response_schema_data
