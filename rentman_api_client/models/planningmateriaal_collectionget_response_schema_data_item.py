...
from ..models.planningmateriaal_collectionget_response_schema_data_item_custom import (
    PlanningmateriaalCollectiongetResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningmateriaalCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PlanningmateriaalCollectiongetResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, PlanningmateriaalCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningmateriaalCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        planningmateriaal_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningmateriaal_collectionget_response_schema_data_item.additional_properties = d
        return planningmateriaal_collectionget_response_schema_data_item
