...
T = TypeVar("T", bound="InvoicelineItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class InvoicelineItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoiceline_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        invoiceline_itemput_response_schema_data.additional_properties = d
        return invoiceline_itemput_response_schema_data
