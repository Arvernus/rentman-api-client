...
from ..models.beschikbaarheid_itempost_response_schema_data_recurrence_interval_unit import (
    BeschikbaarheidItempostResponseSchemaDataRecurrenceIntervalUnit,
)
from ..models.beschikbaarheid_itempost_response_schema_data_status import (
    BeschikbaarheidItempostResponseSchemaDataStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="BeschikbaarheidItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class BeschikbaarheidItempostResponseSchemaData:
    ...
    status: Union[Unset, BeschikbaarheidItempostResponseSchemaDataStatus] = UNSET
    remark: Union[Unset, str] = UNSET
    recurrence_interval_unit: Union[Unset, BeschikbaarheidItempostResponseSchemaDataRecurrenceIntervalUnit] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = BeschikbaarheidItempostResponseSchemaDataStatus(_status)
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = BeschikbaarheidItempostResponseSchemaDataRecurrenceIntervalUnit(
        ...
        beschikbaarheid_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        beschikbaarheid_itempost_response_schema_data.additional_properties = d
        return beschikbaarheid_itempost_response_schema_data
