...
from ..models.timeregistration_itemput_response_schema_data_type import TimeregistrationItemputResponseSchemaDataType
...
class TimeregistrationItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        timeregistration_itemput_response_schema_data.additional_properties = d
        return timeregistration_itemput_response_schema_data
