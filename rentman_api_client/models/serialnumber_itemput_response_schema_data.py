...
class SerialnumberItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialnumber_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        serialnumber_itemput_response_schema_data.additional_properties = d
        return serialnumber_itemput_response_schema_data
