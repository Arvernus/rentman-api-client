...
from ..models.person_itemput_response_schema_data_country import PersonItemputResponseSchemaDataCountry
from ..models.person_itemput_response_schema_data_custom import PersonItemputResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class PersonItemputResponseSchemaData:
    ...
    country: Union[Unset, PersonItemputResponseSchemaDataCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    tags: Union[Unset, str] = UNSET
    custom: Union[Unset, PersonItemputResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = PersonItemputResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = PersonItemputResponseSchemaDataCustom.from_dict(_custom)

        person_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        person_itemput_response_schema_data.additional_properties = d
        return person_itemput_response_schema_data
