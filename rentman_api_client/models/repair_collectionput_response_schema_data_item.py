...
from ..models.repair_collectionput_response_schema_data_item_custom import (
    RepairCollectionputResponseSchemaDataItemCustom,
)
from ..models.repair_collectionput_response_schema_data_item_is_usable import (
    RepairCollectionputResponseSchemaDataItemIsUsable,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RepairCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class RepairCollectionputResponseSchemaDataItem:
    """ """
    ...
    is_usable: Union[Unset, RepairCollectionputResponseSchemaDataItemIsUsable] = UNSET
    ...
    custom: Union[Unset, RepairCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = RepairCollectionputResponseSchemaDataItemIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = RepairCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        repair_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        repair_collectionput_response_schema_data_item.additional_properties = d
        return repair_collectionput_response_schema_data_item
