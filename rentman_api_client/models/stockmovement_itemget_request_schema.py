...
from ..models.stockmovement_itemget_request_schema_type import StockmovementItemgetRequestSchemaType
...
class StockmovementItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stockmovement_itemget_request_schema = cls(
            amount=amount,
        ...
        stockmovement_itemget_request_schema.additional_properties = d
