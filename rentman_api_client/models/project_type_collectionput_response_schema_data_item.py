...
from ..models.project_type_collectionput_response_schema_data_item_type import (
...
class ProjectTypeCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_type_collectionput_response_schema_data_item = cls(
            color=color,
            created=created,
            creator=creator,
        ...
        project_type_collectionput_response_schema_data_item.additional_properties = d
        return project_type_collectionput_response_schema_data_item
