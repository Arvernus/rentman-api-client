...
T = TypeVar("T", bound="AccessoryItempostResponseSchemaData")
...
class AccessoryItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessory_itempost_response_schema_data = cls(
        ...
        accessory_itempost_response_schema_data.additional_properties = d
        return accessory_itempost_response_schema_data
