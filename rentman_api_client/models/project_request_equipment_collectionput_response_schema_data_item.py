...
T = TypeVar("T", bound="ProjectRequestEquipmentCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectRequestEquipmentCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_request_equipment_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        project_request_equipment_collectionput_response_schema_data_item.additional_properties = d
        return project_request_equipment_collectionput_response_schema_data_item
