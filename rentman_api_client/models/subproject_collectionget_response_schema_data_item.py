...
from ..models.subproject_collectionget_response_schema_data_item_custom import (
    SubprojectCollectiongetResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubprojectCollectiongetResponseSchemaDataItem")
...
class SubprojectCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return subproject_collectionget_response_schema_data_item
