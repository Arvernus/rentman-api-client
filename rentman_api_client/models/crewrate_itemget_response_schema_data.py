...
T = TypeVar("T", bound="CrewrateItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class CrewrateItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        crewrate_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return crewrate_itemget_response_schema_data
