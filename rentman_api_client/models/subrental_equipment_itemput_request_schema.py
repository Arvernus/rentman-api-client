...
T = TypeVar("T", bound="SubrentalEquipmentItemputRequestSchema")


@attr.s(auto_attribs=True)
class SubrentalEquipmentItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrental_equipment_itemput_request_schema = cls(
            discount=discount,
            equipment=equipment,
            factor=factor,
            lineprice=lineprice,
        ...
        subrental_equipment_itemput_request_schema.additional_properties = d
        return subrental_equipment_itemput_request_schema
