...
T = TypeVar("T", bound="BtwbedragItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class BtwbedragItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        btwbedrag_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        btwbedrag_itempost_response_schema_data.additional_properties = d
