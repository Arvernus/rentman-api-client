...
T = TypeVar("T", bound="ContactpersonItempostRequestSchemaCustom")


@attr.s(auto_attribs=True)
class ContactpersonItempostRequestSchemaCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        contactperson_itempost_request_schema_custom = cls()
