...
T = TypeVar("T", bound="AccessoireItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class AccessoireItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        accessoire_itemput_response_schema_data.additional_properties = d
        return accessoire_itemput_response_schema_data
