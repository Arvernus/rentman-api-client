...
from ..models.contact_collectionput_response_schema_data_item_country import (
    ContactCollectionputResponseSchemaDataItemCountry,
)
from ..models.contact_collectionput_response_schema_data_item_custom import (
    ContactCollectionputResponseSchemaDataItemCustom,
)
from ..models.contact_collectionput_response_schema_data_item_invoice_country import (
    ContactCollectionputResponseSchemaDataItemInvoiceCountry,
)
from ..models.contact_collectionput_response_schema_data_item_mailing_country import (
    ContactCollectionputResponseSchemaDataItemMailingCountry,
)
from ..models.contact_collectionput_response_schema_data_item_type import ContactCollectionputResponseSchemaDataItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ContactCollectionputResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, ContactCollectionputResponseSchemaDataItemCountry] = UNSET
    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, ContactCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    invoice_country: Union[Unset, ContactCollectionputResponseSchemaDataItemInvoiceCountry] = UNSET
    ...
    mailing_country: Union[Unset, ContactCollectionputResponseSchemaDataItemMailingCountry] = UNSET
    ...
    type: Union[Unset, ContactCollectionputResponseSchemaDataItemType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = ContactCollectionputResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactCollectionputResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_invoice_country, Unset):
            invoice_country = ContactCollectionputResponseSchemaDataItemInvoiceCountry(_invoice_country)
        ...
        if not isinstance(_mailing_country, Unset):
            mailing_country = ContactCollectionputResponseSchemaDataItemMailingCountry(_mailing_country)
        ...
        if not isinstance(_type, Unset):
            type = ContactCollectionputResponseSchemaDataItemType(_type)
        ...
        contact_collectionput_response_schema_data_item = cls(
        ...
        contact_collectionput_response_schema_data_item.additional_properties = d
        return contact_collectionput_response_schema_data_item
