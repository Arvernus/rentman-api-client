...
from ..models.project_vehicles_itemput_response_schema_data_custom import ProjectVehiclesItemputResponseSchemaDataCustom
from ..models.project_vehicles_itemput_response_schema_data_transport import (
    ProjectVehiclesItemputResponseSchemaDataTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectVehiclesItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class ProjectVehiclesItemputResponseSchemaData:
    ...
    custom: Union[Unset, ProjectVehiclesItemputResponseSchemaDataCustom] = UNSET
    ...
    transport: Union[Unset, ProjectVehiclesItemputResponseSchemaDataTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectVehiclesItemputResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectVehiclesItemputResponseSchemaDataTransport(_transport)

        vehicle = d.pop("vehicle", UNSET)

        project_vehicles_itemput_response_schema_data = cls(
            cost_rate=cost_rate,
            costs=costs,
            created=created,
            creator=creator,
        ...
        project_vehicles_itemput_response_schema_data.additional_properties = d
        return project_vehicles_itemput_response_schema_data
