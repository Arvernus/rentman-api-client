...
T = TypeVar("T", bound="AccessoireItempostRequestSchema")


@attr.s(auto_attribs=True)
class AccessoireItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_itempost_request_schema = cls(
            equipment=equipment,
            quantity=quantity,
            automatic=automatic,
            skip=skip,
        ...
        accessoire_itempost_request_schema.additional_properties = d
        return accessoire_itempost_request_schema
