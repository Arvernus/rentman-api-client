...
from ..models.timeregistration_collectionput_response_schema_data_item_custom import (
    TimeregistrationCollectionputResponseSchemaDataItemCustom,
)
from ..models.timeregistration_collectionput_response_schema_data_item_type import (
...
class TimeregistrationCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        timeregistration_collectionput_response_schema_data_item.additional_properties = d
        return timeregistration_collectionput_response_schema_data_item
