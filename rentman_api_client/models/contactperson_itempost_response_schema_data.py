...
from ..models.contactperson_itempost_response_schema_data_country import ContactpersonItempostResponseSchemaDataCountry
from ..models.contactperson_itempost_response_schema_data_custom import ContactpersonItempostResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactpersonItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class ContactpersonItempostResponseSchemaData:
    ...
    country: Union[Unset, ContactpersonItempostResponseSchemaDataCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    tags: Union[Unset, str] = UNSET
    custom: Union[Unset, ContactpersonItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = ContactpersonItempostResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactpersonItempostResponseSchemaDataCustom.from_dict(_custom)

        contactperson_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        contactperson_itempost_response_schema_data.additional_properties = d
