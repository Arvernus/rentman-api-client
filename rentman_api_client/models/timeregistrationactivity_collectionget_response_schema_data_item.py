...
class TimeregistrationactivityCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistrationactivity_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        timeregistrationactivity_collectionget_response_schema_data_item.additional_properties = d
        return timeregistrationactivity_collectionget_response_schema_data_item
