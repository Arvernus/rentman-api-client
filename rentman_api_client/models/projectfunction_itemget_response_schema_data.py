...
from ..models.projectfunction_itemget_response_schema_data_planperiod_end_schedule_is_start import (
    ProjectfunctionItemgetResponseSchemaDataPlanperiodEndScheduleIsStart,
)
from ..models.projectfunction_itemget_response_schema_data_planperiod_start_schedule_is_start import (
    ProjectfunctionItemgetResponseSchemaDataPlanperiodStartScheduleIsStart,
)
from ..models.projectfunction_itemget_response_schema_data_type import ProjectfunctionItemgetResponseSchemaDataType
from ..models.projectfunction_itemget_response_schema_data_usageperiod_end_schedule_is_start import (
    ProjectfunctionItemgetResponseSchemaDataUsageperiodEndScheduleIsStart,
)
from ..models.projectfunction_itemget_response_schema_data_usageperiod_start_schedule_is_start import (
...
class ProjectfunctionItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectfunction_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectfunction_itemget_response_schema_data.additional_properties = d
        return projectfunction_itemget_response_schema_data
