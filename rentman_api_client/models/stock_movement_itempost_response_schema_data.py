...
T = TypeVar("T", bound="StockMovementItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class StockMovementItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stock_movement_itempost_response_schema_data = cls(
            amount=amount,
            created=created,
            creator=creator,
            date=date,
        ...
        stock_movement_itempost_response_schema_data.additional_properties = d
        return stock_movement_itempost_response_schema_data
