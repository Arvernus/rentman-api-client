...
from ..models.exemplaar_collectionput_response_schema_data_item_custom import (
    ExemplaarCollectionputResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExemplaarCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ExemplaarCollectionputResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, ExemplaarCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ExemplaarCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        exemplaar_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        exemplaar_collectionput_response_schema_data_item.additional_properties = d
        return exemplaar_collectionput_response_schema_data_item
