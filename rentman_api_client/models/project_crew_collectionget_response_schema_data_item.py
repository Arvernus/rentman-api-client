...
from ..models.project_crew_collectionget_response_schema_data_item_custom import (
    ProjectCrewCollectiongetResponseSchemaDataItemCustom,
)
from ..models.project_crew_collectionget_response_schema_data_item_transport import (
    ProjectCrewCollectiongetResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCrewCollectiongetResponseSchemaDataItem")
...
class ProjectCrewCollectiongetResponseSchemaDataItem:
    ...
    custom: Union[Unset, ProjectCrewCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    transport: Union[Unset, ProjectCrewCollectiongetResponseSchemaDataItemTransport] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectCrewCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectCrewCollectiongetResponseSchemaDataItemTransport(_transport)

        visible = d.pop("visible", UNSET)

        project_crew_collectionget_response_schema_data_item = cls(
        ...
        project_crew_collectionget_response_schema_data_item.additional_properties = d
        return project_crew_collectionget_response_schema_data_item
