...
T = TypeVar("T", bound="FunctieuurCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class FunctieuurCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        functieuur_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        functieuur_collectionget_response_schema_data_item.additional_properties = d
