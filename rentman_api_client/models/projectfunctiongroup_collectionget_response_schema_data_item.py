...
from ..models.projectfunctiongroup_collectionget_response_schema_data_item_planperiod_end_schedule_is_start import (
    ProjectfunctiongroupCollectiongetResponseSchemaDataItemPlanperiodEndScheduleIsStart,
)
from ..models.projectfunctiongroup_collectionget_response_schema_data_item_planperiod_start_schedule_is_start import (
    ProjectfunctiongroupCollectiongetResponseSchemaDataItemPlanperiodStartScheduleIsStart,
)
from ..models.projectfunctiongroup_collectionget_response_schema_data_item_usageperiod_end_schedule_is_start import (
    ProjectfunctiongroupCollectiongetResponseSchemaDataItemUsageperiodEndScheduleIsStart,
)
from ..models.projectfunctiongroup_collectionget_response_schema_data_item_usageperiod_start_schedule_is_start import (
...
class ProjectfunctiongroupCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectfunctiongroup_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectfunctiongroup_collectionget_response_schema_data_item.additional_properties = d
        return projectfunctiongroup_collectionget_response_schema_data_item
