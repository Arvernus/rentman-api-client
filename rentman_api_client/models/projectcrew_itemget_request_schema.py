...
from ..models.projectcrew_itemget_request_schema_custom import ProjectcrewItemgetRequestSchemaCustom
from ..models.projectcrew_itemget_request_schema_transport import ProjectcrewItemgetRequestSchemaTransport
...
class ProjectcrewItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectcrew_itemget_request_schema = cls(
            crewmember=crewmember,
            cost_rate=cost_rate,
            visible=visible,
        ...
        projectcrew_itemget_request_schema.additional_properties = d
