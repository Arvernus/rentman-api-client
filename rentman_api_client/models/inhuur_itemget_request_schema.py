...
from ..models.inhuur_itemget_request_schema_custom import InhuurItemgetRequestSchemaCustom
from ..models.inhuur_itemget_request_schema_type import InhuurItemgetRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="InhuurItemgetRequestSchema")


@attr.s(auto_attribs=True)
class InhuurItemgetRequestSchema:
    """ """
    ...
    type: Union[Unset, InhuurItemgetRequestSchemaType] = UNSET
    ...
    custom: Union[Unset, InhuurItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = InhuurItemgetRequestSchemaType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = InhuurItemgetRequestSchemaCustom.from_dict(_custom)

        inhuur_itemget_request_schema = cls(
            name=name,
        ...
        inhuur_itemget_request_schema.additional_properties = d
        return inhuur_itemget_request_schema
