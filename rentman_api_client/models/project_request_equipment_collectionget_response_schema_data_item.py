...
T = TypeVar("T", bound="ProjectRequestEquipmentCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ProjectRequestEquipmentCollectiongetResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_request_equipment_collectionget_response_schema_data_item = cls(
            created=created,
            creator=creator,
            discount=discount,
        ...
        project_request_equipment_collectionget_response_schema_data_item.additional_properties = d
        return project_request_equipment_collectionget_response_schema_data_item
