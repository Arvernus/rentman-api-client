...
from ..models.crew_availability_collectionpost_response_schema_data_item_recurrence_interval_unit import (
    CrewAvailabilityCollectionpostResponseSchemaDataItemRecurrenceIntervalUnit,
)
from ..models.crew_availability_collectionpost_response_schema_data_item_status import (
    CrewAvailabilityCollectionpostResponseSchemaDataItemStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewAvailabilityCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class CrewAvailabilityCollectionpostResponseSchemaDataItem:
    """ """
    ...
    status: Union[Unset, CrewAvailabilityCollectionpostResponseSchemaDataItemStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = CrewAvailabilityCollectionpostResponseSchemaDataItemStatus(_status)

        crew_availability_collectionpost_response_schema_data_item = cls(
            created=created,
            creator=creator,
        ...
        crew_availability_collectionpost_response_schema_data_item.additional_properties = d
        return crew_availability_collectionpost_response_schema_data_item
