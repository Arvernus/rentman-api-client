...
from ..models.serial_number_itemput_request_schema_custom import SerialNumberItemputRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="SerialNumberItemputRequestSchema")


@attr.s(auto_attribs=True)
class SerialNumberItemputRequestSchema:
    """ """

    active: Union[Unset, bool] = UNSET
    asset_location: Union[Unset, None, str] = UNSET
    book_value: Union[Unset, float] = UNSET
    custom: Union[Unset, SerialNumberItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = SerialNumberItemputRequestSchemaCustom.from_dict(_custom)
        ...
        serial_number_itemput_request_schema = cls(
            active=active,
        ...
        serial_number_itemput_request_schema.additional_properties = d
        return serial_number_itemput_request_schema
