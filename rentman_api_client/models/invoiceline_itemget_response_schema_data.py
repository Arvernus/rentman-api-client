...
T = TypeVar("T", bound="InvoicelineItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class InvoicelineItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoiceline_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        invoiceline_itemget_response_schema_data.additional_properties = d
        return invoiceline_itemget_response_schema_data
