...
from ..models.planningpersoneel_itemput_request_schema_custom import PlanningpersoneelItemputRequestSchemaCustom
from ..models.planningpersoneel_itemput_request_schema_transport import PlanningpersoneelItemputRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningpersoneelItemputRequestSchema")


@attr.s(auto_attribs=True)
class PlanningpersoneelItemputRequestSchema:
    """ """
    ...
    transport: Union[Unset, PlanningpersoneelItemputRequestSchemaTransport] = UNSET
    ...
    custom: Union[Unset, PlanningpersoneelItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningpersoneelItemputRequestSchemaTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningpersoneelItemputRequestSchemaCustom.from_dict(_custom)

        planningpersoneel_itemput_request_schema = cls(
            crewmember=crewmember,
            cost_rate=cost_rate,
            visible=visible,
        ...
        planningpersoneel_itemput_request_schema.additional_properties = d
