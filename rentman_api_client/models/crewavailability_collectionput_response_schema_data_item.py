...
from ..models.crewavailability_collectionput_response_schema_data_item_recurrence_interval_unit import (
    CrewavailabilityCollectionputResponseSchemaDataItemRecurrenceIntervalUnit,
)
from ..models.crewavailability_collectionput_response_schema_data_item_status import (
...
class CrewavailabilityCollectionputResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        crewavailability_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        crewavailability_collectionput_response_schema_data_item.additional_properties = d
        return crewavailability_collectionput_response_schema_data_item
