...
from ..models.vehicle_itemput_request_schema_custom import VehicleItemputRequestSchemaCustom
from ..models.vehicle_itemput_request_schema_multiple import VehicleItemputRequestSchemaMultiple
...
class VehicleItemputRequestSchema:
    """ """
    ...
    multiple: Union[Unset, VehicleItemputRequestSchemaMultiple] = UNSET
    image: Union[Unset, None, str] = UNSET
    custom: Union[Unset, VehicleItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VehicleItemputRequestSchemaMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VehicleItemputRequestSchemaCustom.from_dict(_custom)

        vehicle_itemput_request_schema = cls(
            folder=folder,
            name=name,
            cost_rate=cost_rate,
        ...
        vehicle_itemput_request_schema.additional_properties = d
        return vehicle_itemput_request_schema
