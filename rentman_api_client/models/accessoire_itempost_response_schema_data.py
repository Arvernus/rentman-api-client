...
T = TypeVar("T", bound="AccessoireItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class AccessoireItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        accessoire_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        accessoire_itempost_response_schema_data.additional_properties = d
