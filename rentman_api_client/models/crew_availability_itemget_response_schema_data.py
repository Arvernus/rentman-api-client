...
from ..models.crew_availability_itemget_response_schema_data_recurrence_interval_unit import (
    CrewAvailabilityItemgetResponseSchemaDataRecurrenceIntervalUnit,
)
from ..models.crew_availability_itemget_response_schema_data_status import (
    CrewAvailabilityItemgetResponseSchemaDataStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewAvailabilityItemgetResponseSchemaData")
...
class CrewAvailabilityItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_recurrence_interval_unit, Unset):
            recurrence_interval_unit = CrewAvailabilityItemgetResponseSchemaDataRecurrenceIntervalUnit(
        ...
        return crew_availability_itemget_response_schema_data
