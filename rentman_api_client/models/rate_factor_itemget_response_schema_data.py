...
T = TypeVar("T", bound="RateFactorItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class RateFactorItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rate_factor_itemget_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        rate_factor_itemget_response_schema_data.additional_properties = d
        return rate_factor_itemget_response_schema_data
