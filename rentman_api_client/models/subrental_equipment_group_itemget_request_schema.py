...
T = TypeVar("T", bound="SubrentalEquipmentGroupItemgetRequestSchema")
...
class SubrentalEquipmentGroupItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        subrental_equipment_group_itemget_request_schema = cls(
            name=name,
            order=order,
            supplier_category=supplier_category,
        )

        subrental_equipment_group_itemget_request_schema.additional_properties = d
        return subrental_equipment_group_itemget_request_schema
