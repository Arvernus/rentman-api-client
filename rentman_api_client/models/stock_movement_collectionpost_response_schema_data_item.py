...
T = TypeVar("T", bound="StockMovementCollectionpostResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class StockMovementCollectionpostResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stock_movement_collectionpost_response_schema_data_item = cls(
            amount=amount,
            created=created,
            creator=creator,
            date=date,
        ...
        stock_movement_collectionpost_response_schema_data_item.additional_properties = d
        return stock_movement_collectionpost_response_schema_data_item
