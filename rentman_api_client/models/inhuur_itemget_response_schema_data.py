...
from ..models.inhuur_itemget_response_schema_data_custom import InhuurItemgetResponseSchemaDataCustom
from ..models.inhuur_itemget_response_schema_data_type import InhuurItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="InhuurItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class InhuurItemgetResponseSchemaData:
    ...
    type: Union[Unset, InhuurItemgetResponseSchemaDataType] = UNSET
    ...
    custom: Union[Unset, InhuurItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = InhuurItemgetResponseSchemaDataType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = InhuurItemgetResponseSchemaDataCustom.from_dict(_custom)

        inhuur_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuur_itemget_response_schema_data.additional_properties = d
