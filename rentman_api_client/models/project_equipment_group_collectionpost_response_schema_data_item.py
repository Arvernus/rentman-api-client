...
class ProjectEquipmentGroupCollectionpostResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_equipment_group_collectionpost_response_schema_data_item = cls(
        ...
        project_equipment_group_collectionpost_response_schema_data_item.additional_properties = d
        return project_equipment_group_collectionpost_response_schema_data_item
