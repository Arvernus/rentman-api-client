...
from ..models.contactperson_itemget_request_schema_country import ContactpersonItemgetRequestSchemaCountry
from ..models.contactperson_itemget_request_schema_custom import ContactpersonItemgetRequestSchemaCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactpersonItemgetRequestSchema")


@attr.s(auto_attribs=True)
class ContactpersonItemgetRequestSchema:
    """ """

    city: Union[Unset, str] = UNSET
    country: Union[Unset, ContactpersonItemgetRequestSchemaCountry] = UNSET
    custom: Union[Unset, ContactpersonItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = ContactpersonItemgetRequestSchemaCountry(_country)

        custom: Union[Unset, ContactpersonItemgetRequestSchemaCustom] = UNSET
        _custom = d.pop("custom", UNSET)
        if not isinstance(_custom, Unset):
            custom = ContactpersonItemgetRequestSchemaCustom.from_dict(_custom)
        ...
        contactperson_itemget_request_schema = cls(
            city=city,
            country=country,
            custom=custom,
            email=email,
        ...
        contactperson_itemget_request_schema.additional_properties = d
