...
from ..models.crewavailability_itemget_request_schema_recurrence_interval_unit import (
    CrewavailabilityItemgetRequestSchemaRecurrenceIntervalUnit,
)
from ..models.crewavailability_itemget_request_schema_status import CrewavailabilityItemgetRequestSchemaStatus
...
class CrewavailabilityItemgetRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        crewavailability_itemget_request_schema = cls(
        ...
        return crewavailability_itemget_request_schema
