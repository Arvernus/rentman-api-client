...
from ..models.equipment_itempost_response_schema_data_country_of_origin import (
...
from ..models.equipment_itempost_response_schema_data_is_physical import EquipmentItempostResponseSchemaDataIsPhysical
from ..models.equipment_itempost_response_schema_data_rental_sales import EquipmentItempostResponseSchemaDataRentalSales
from ..models.equipment_itempost_response_schema_data_stock_management import (
    EquipmentItempostResponseSchemaDataStockManagement,
)
from ..models.equipment_itempost_response_schema_data_type import EquipmentItempostResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EquipmentItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class EquipmentItempostResponseSchemaData:
    """All the data about the requested items"""

    can_edit_content_during_planning: Union[Unset, bool] = UNSET
    code: Union[Unset, str] = UNSET
    country_of_origin: Union[Unset, EquipmentItempostResponseSchemaDataCountryOfOrigin] = UNSET
    ...
    custom: Union[Unset, EquipmentItempostResponseSchemaDataCustom] = UNSET
    ...
    is_physical: Union[Unset, EquipmentItempostResponseSchemaDataIsPhysical] = UNSET
    ...
    rental_sales: Union[Unset, EquipmentItempostResponseSchemaDataRentalSales] = UNSET
    ...
    stock_management: Union[Unset, EquipmentItempostResponseSchemaDataStockManagement] = UNSET
    ...
    type: Union[Unset, EquipmentItempostResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = EquipmentItempostResponseSchemaDataCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_custom, Unset):
            custom = EquipmentItempostResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = EquipmentItempostResponseSchemaDataIsPhysical(_is_physical)
        ...
        if not isinstance(_rental_sales, Unset):
            rental_sales = EquipmentItempostResponseSchemaDataRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = EquipmentItempostResponseSchemaDataStockManagement(_stock_management)
        ...
        if not isinstance(_type, Unset):
            type = EquipmentItempostResponseSchemaDataType(_type)
        ...
        equipment_itempost_response_schema_data = cls(
        ...
        equipment_itempost_response_schema_data.additional_properties = d
        return equipment_itempost_response_schema_data
