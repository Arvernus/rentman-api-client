...
T = TypeVar("T", bound="StockMovementCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class StockMovementCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stock_movement_collectionput_response_schema_data_item = cls(
            amount=amount,
            created=created,
            creator=creator,
            date=date,
        ...
        stock_movement_collectionput_response_schema_data_item.additional_properties = d
        return stock_movement_collectionput_response_schema_data_item
