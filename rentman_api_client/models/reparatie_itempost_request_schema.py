...
from ..models.reparatie_itempost_request_schema_custom import ReparatieItempostRequestSchemaCustom
from ..models.reparatie_itempost_request_schema_is_usable import ReparatieItempostRequestSchemaIsUsable
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReparatieItempostRequestSchema")


@attr.s(auto_attribs=True)
class ReparatieItempostRequestSchema:
    """ """
    ...
    is_usable: Union[Unset, ReparatieItempostRequestSchemaIsUsable] = UNSET
    ...
    custom: Union[Unset, ReparatieItempostRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = ReparatieItempostRequestSchemaIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = ReparatieItempostRequestSchemaCustom.from_dict(_custom)

        reparatie_itempost_request_schema = cls(
        ...
        reparatie_itempost_request_schema.additional_properties = d
        return reparatie_itempost_request_schema
