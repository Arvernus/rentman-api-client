...
from ..models.subrental_collectionget_response_schema_data_item_custom import (
    SubrentalCollectiongetResponseSchemaDataItemCustom,
)
from ..models.subrental_collectionget_response_schema_data_item_type import (
    SubrentalCollectiongetResponseSchemaDataItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubrentalCollectiongetResponseSchemaDataItem")
...
class SubrentalCollectiongetResponseSchemaDataItem:
    ...
    type: Union[Unset, SubrentalCollectiongetResponseSchemaDataItemType] = UNSET
    ...
    custom: Union[Unset, SubrentalCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = SubrentalCollectiongetResponseSchemaDataItemType(_type)
        ...
        if not isinstance(_custom, Unset):
            custom = SubrentalCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        subrental_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
