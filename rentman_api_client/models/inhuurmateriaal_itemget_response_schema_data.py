...
T = TypeVar("T", bound="InhuurmateriaalItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class InhuurmateriaalItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        inhuurmateriaal_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        inhuurmateriaal_itemget_response_schema_data.additional_properties = d
