...
from ..models.projectcrew_itemget_response_schema_data_custom import ProjectcrewItemgetResponseSchemaDataCustom
from ..models.projectcrew_itemget_response_schema_data_transport import ProjectcrewItemgetResponseSchemaDataTransport
...
class ProjectcrewItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectcrew_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        projectcrew_itemget_response_schema_data.additional_properties = d
