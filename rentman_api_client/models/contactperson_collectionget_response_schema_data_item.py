...
from ..models.contactperson_collectionget_response_schema_data_item_country import (
    ContactpersonCollectiongetResponseSchemaDataItemCountry,
)
from ..models.contactperson_collectionget_response_schema_data_item_custom import (
    ContactpersonCollectiongetResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ContactpersonCollectiongetResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class ContactpersonCollectiongetResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, ContactpersonCollectiongetResponseSchemaDataItemCountry] = UNSET
    mobilephone: Union[Unset, str] = UNSET
    email: Union[Unset, str] = UNSET
    tags: Union[Unset, str] = UNSET
    custom: Union[Unset, ContactpersonCollectiongetResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = ContactpersonCollectiongetResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = ContactpersonCollectiongetResponseSchemaDataItemCustom.from_dict(_custom)

        contactperson_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        return contactperson_collectionget_response_schema_data_item
