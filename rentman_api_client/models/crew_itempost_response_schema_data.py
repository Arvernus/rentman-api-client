...
from ..models.crew_itempost_response_schema_data_country import CrewItempostResponseSchemaDataCountry
from ..models.crew_itempost_response_schema_data_custom import CrewItempostResponseSchemaDataCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class CrewItempostResponseSchemaData:
    ...
    country: Union[Unset, CrewItempostResponseSchemaDataCountry] = UNSET
    ...
    custom: Union[Unset, CrewItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = CrewItempostResponseSchemaDataCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = CrewItempostResponseSchemaDataCustom.from_dict(_custom)

        crew_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        crew_itempost_response_schema_data.additional_properties = d
        return crew_itempost_response_schema_data
