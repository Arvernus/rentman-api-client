...
T = TypeVar("T", bound="InvoiceItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class InvoiceItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        invoice_itempost_response_schema_data.additional_properties = d
        return invoice_itempost_response_schema_data
