...
from ..models.planningpersoneel_collectionput_response_schema_data_item_custom import (
    PlanningpersoneelCollectionputResponseSchemaDataItemCustom,
)
from ..models.planningpersoneel_collectionput_response_schema_data_item_transport import (
    PlanningpersoneelCollectionputResponseSchemaDataItemTransport,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlanningpersoneelCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class PlanningpersoneelCollectionputResponseSchemaDataItem:
    """ """
    ...
    transport: Union[Unset, PlanningpersoneelCollectionputResponseSchemaDataItemTransport] = UNSET
    ...
    custom: Union[Unset, PlanningpersoneelCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = PlanningpersoneelCollectionputResponseSchemaDataItemTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = PlanningpersoneelCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        planningpersoneel_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        planningpersoneel_collectionput_response_schema_data_item.additional_properties = d
