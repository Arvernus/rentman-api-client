...
T = TypeVar("T", bound="ProjectEquipmentGroupItempostRequestSchema")


@attr.s(auto_attribs=True)
class ProjectEquipmentGroupItempostRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_equipment_group_itempost_request_schema = cls(
            subproject=subproject,
        ...
        project_equipment_group_itempost_request_schema.additional_properties = d
        return project_equipment_group_itempost_request_schema
