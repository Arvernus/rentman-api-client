...
from ..models.stock_location_itemput_request_schema_country import StockLocationItemputRequestSchemaCountry
from ..models.stock_location_itemput_request_schema_type import StockLocationItemputRequestSchemaType
...
class StockLocationItemputRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        stock_location_itemput_request_schema = cls(
            active=active,
            city=city,
            color=color,
            country=country,
        ...
        stock_location_itemput_request_schema.additional_properties = d
        return stock_location_itemput_request_schema
