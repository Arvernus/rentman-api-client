...
from ..models.projectvehicle_itemput_request_schema_custom import ProjectvehicleItemputRequestSchemaCustom
from ..models.projectvehicle_itemput_request_schema_transport import ProjectvehicleItemputRequestSchemaTransport
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectvehicleItemputRequestSchema")


@attr.s(auto_attribs=True)
class ProjectvehicleItemputRequestSchema:
    """ """

    vehicle: str
    cost_rate: Union[Unset, None, str] = UNSET
    transport: Union[Unset, ProjectvehicleItemputRequestSchemaTransport] = UNSET
    ...
    custom: Union[Unset, ProjectvehicleItemputRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_transport, Unset):
            transport = ProjectvehicleItemputRequestSchemaTransport(_transport)
        ...
        if not isinstance(_custom, Unset):
            custom = ProjectvehicleItemputRequestSchemaCustom.from_dict(_custom)

        projectvehicle_itemput_request_schema = cls(
            vehicle=vehicle,
            cost_rate=cost_rate,
            transport=transport,
        ...
        return projectvehicle_itemput_request_schema
