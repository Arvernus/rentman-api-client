...
from ..models.serialnumber_itemput_request_schema_custom import SerialnumberItemputRequestSchemaCustom
...
class SerialnumberItemputRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        serialnumber_itemput_request_schema = cls(
            serial=serial,
        ...
        serialnumber_itemput_request_schema.additional_properties = d
        return serialnumber_itemput_request_schema
