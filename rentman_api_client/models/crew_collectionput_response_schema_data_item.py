...
from ..models.crew_collectionput_response_schema_data_item_country import CrewCollectionputResponseSchemaDataItemCountry
from ..models.crew_collectionput_response_schema_data_item_custom import CrewCollectionputResponseSchemaDataItemCustom
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class CrewCollectionputResponseSchemaDataItem:
    """ """
    ...
    country: Union[Unset, CrewCollectionputResponseSchemaDataItemCountry] = UNSET
    ...
    custom: Union[Unset, CrewCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_country, Unset):
            country = CrewCollectionputResponseSchemaDataItemCountry(_country)
        ...
        if not isinstance(_custom, Unset):
            custom = CrewCollectionputResponseSchemaDataItemCustom.from_dict(_custom)

        crew_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        crew_collectionput_response_schema_data_item.additional_properties = d
        return crew_collectionput_response_schema_data_item
