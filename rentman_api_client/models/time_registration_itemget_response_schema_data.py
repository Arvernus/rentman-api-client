...
from ..models.time_registration_itemget_response_schema_data_custom import (
    TimeRegistrationItemgetResponseSchemaDataCustom,
)
from ..models.time_registration_itemget_response_schema_data_type import TimeRegistrationItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimeRegistrationItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class TimeRegistrationItemgetResponseSchemaData:
    ...
    custom: Union[Unset, TimeRegistrationItemgetResponseSchemaDataCustom] = UNSET
    ...
    type: Union[Unset, TimeRegistrationItemgetResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = TimeRegistrationItemgetResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = TimeRegistrationItemgetResponseSchemaDataType(_type)

        time_registration_itemget_response_schema_data = cls(
        ...
        time_registration_itemget_response_schema_data.additional_properties = d
        return time_registration_itemget_response_schema_data
