...
from ..models.crewavailability_collectionpost_response_schema_data_item_recurrence_interval_unit import (
    CrewavailabilityCollectionpostResponseSchemaDataItemRecurrenceIntervalUnit,
)
from ..models.crewavailability_collectionpost_response_schema_data_item_status import (
...
class CrewavailabilityCollectionpostResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        crewavailability_collectionpost_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
