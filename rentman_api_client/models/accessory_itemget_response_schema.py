...
from ..models.accessory_itemget_response_schema_data import AccessoryItemgetResponseSchemaData
...
class AccessoryItemgetResponseSchema:
    ...
    data: Union[Unset, AccessoryItemgetResponseSchemaData] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_data, Unset):
            data = AccessoryItemgetResponseSchemaData.from_dict(_data)
        ...
        accessory_itemget_response_schema = cls(
            data=data,
        ...
        accessory_itemget_response_schema.additional_properties = d
