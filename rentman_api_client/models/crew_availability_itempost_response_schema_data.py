...
from ..models.crew_availability_itempost_response_schema_data_recurrence_interval_unit import (
    CrewAvailabilityItempostResponseSchemaDataRecurrenceIntervalUnit,
)
from ..models.crew_availability_itempost_response_schema_data_status import (
    CrewAvailabilityItempostResponseSchemaDataStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CrewAvailabilityItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class CrewAvailabilityItempostResponseSchemaData:
    ...
    recurrence_interval_unit: Union[Unset, CrewAvailabilityItempostResponseSchemaDataRecurrenceIntervalUnit] = UNSET
    recurrent_group: Union[Unset, int] = UNSET
    remark: Union[Unset, str] = UNSET
    start: Union[Unset, None, datetime.datetime] = UNSET
    status: Union[Unset, CrewAvailabilityItempostResponseSchemaDataStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_status, Unset):
            status = CrewAvailabilityItempostResponseSchemaDataStatus(_status)

        crew_availability_itempost_response_schema_data = cls(
            created=created,
            creator=creator,
        ...
        crew_availability_itempost_response_schema_data.additional_properties = d
        return crew_availability_itempost_response_schema_data
