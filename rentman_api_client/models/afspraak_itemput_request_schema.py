...
T = TypeVar("T", bound="AfspraakItemputRequestSchema")


@attr.s(auto_attribs=True)
class AfspraakItemputRequestSchema:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        afspraak_itemput_request_schema = cls(
            start=start,
            end=end,
            name=name,
            color=color,
        ...
        afspraak_itemput_request_schema.additional_properties = d
