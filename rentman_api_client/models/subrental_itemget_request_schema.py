...
from ..models.subrental_itemget_request_schema_custom import SubrentalItemgetRequestSchemaCustom
from ..models.subrental_itemget_request_schema_type import SubrentalItemgetRequestSchemaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubrentalItemgetRequestSchema")


@attr.s(auto_attribs=True)
class SubrentalItemgetRequestSchema:
    """ """
    ...
    custom: Union[Unset, SubrentalItemgetRequestSchemaCustom] = UNSET
    ...
    type: Union[Unset, SubrentalItemgetRequestSchemaType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = SubrentalItemgetRequestSchemaCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = SubrentalItemgetRequestSchemaType(_type)
        ...
        subrental_itemget_request_schema = cls(
        ...
        subrental_itemget_request_schema.additional_properties = d
        return subrental_itemget_request_schema
