...
from ..models.vehicle_itempost_response_schema_data_custom import VehicleItempostResponseSchemaDataCustom
from ..models.vehicle_itempost_response_schema_data_multiple import VehicleItempostResponseSchemaDataMultiple
from ..types import UNSET, Unset

T = TypeVar("T", bound="VehicleItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class VehicleItempostResponseSchemaData:
    """All the data about the requested items"""

    cost_rate: Union[Unset, None, str] = UNSET
    created: Union[Unset, None, datetime.datetime] = UNSET
    creator: Union[Unset, None, str] = UNSET
    custom: Union[Unset, VehicleItempostResponseSchemaDataCustom] = UNSET
    ...
    multiple: Union[Unset, VehicleItempostResponseSchemaDataMultiple] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = VehicleItempostResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_multiple, Unset):
            multiple = VehicleItempostResponseSchemaDataMultiple(_multiple)
        ...
        vehicle_itempost_response_schema_data = cls(
            cost_rate=cost_rate,
            created=created,
            creator=creator,
            custom=custom,
        ...
        vehicle_itempost_response_schema_data.additional_properties = d
        return vehicle_itempost_response_schema_data
