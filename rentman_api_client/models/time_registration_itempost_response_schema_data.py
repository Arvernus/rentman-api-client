...
from ..models.time_registration_itempost_response_schema_data_custom import (
    TimeRegistrationItempostResponseSchemaDataCustom,
)
from ..models.time_registration_itempost_response_schema_data_type import TimeRegistrationItempostResponseSchemaDataType
...
class TimeRegistrationItempostResponseSchemaData:
    ...
    custom: Union[Unset, TimeRegistrationItempostResponseSchemaDataCustom] = UNSET
    ...
    type: Union[Unset, TimeRegistrationItempostResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = TimeRegistrationItempostResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = TimeRegistrationItempostResponseSchemaDataType(_type)

        time_registration_itempost_response_schema_data = cls(
        ...
        time_registration_itempost_response_schema_data.additional_properties = d
        return time_registration_itempost_response_schema_data
