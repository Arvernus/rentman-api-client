...
from ..models.repair_itempost_response_schema_data_custom import RepairItempostResponseSchemaDataCustom
from ..models.repair_itempost_response_schema_data_is_usable import RepairItempostResponseSchemaDataIsUsable
from ..types import UNSET, Unset

T = TypeVar("T", bound="RepairItempostResponseSchemaData")


@attr.s(auto_attribs=True)
class RepairItempostResponseSchemaData:
    ...
    is_usable: Union[Unset, RepairItempostResponseSchemaDataIsUsable] = UNSET
    ...
    custom: Union[Unset, RepairItempostResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_is_usable, Unset):
            is_usable = RepairItempostResponseSchemaDataIsUsable(_is_usable)
        ...
        if not isinstance(_custom, Unset):
            custom = RepairItempostResponseSchemaDataCustom.from_dict(_custom)

        repair_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        repair_itempost_response_schema_data.additional_properties = d
