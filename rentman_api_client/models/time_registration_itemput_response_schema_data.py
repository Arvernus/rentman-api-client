...
from ..models.time_registration_itemput_response_schema_data_custom import (
    TimeRegistrationItemputResponseSchemaDataCustom,
)
from ..models.time_registration_itemput_response_schema_data_type import TimeRegistrationItemputResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="TimeRegistrationItemputResponseSchemaData")


@attr.s(auto_attribs=True)
class TimeRegistrationItemputResponseSchemaData:
    ...
    custom: Union[Unset, TimeRegistrationItemputResponseSchemaDataCustom] = UNSET
    ...
    type: Union[Unset, TimeRegistrationItemputResponseSchemaDataType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = TimeRegistrationItemputResponseSchemaDataCustom.from_dict(_custom)
        ...
        if not isinstance(_type, Unset):
            type = TimeRegistrationItemputResponseSchemaDataType(_type)

        time_registration_itemput_response_schema_data = cls(
        ...
        time_registration_itemput_response_schema_data.additional_properties = d
        return time_registration_itemput_response_schema_data
