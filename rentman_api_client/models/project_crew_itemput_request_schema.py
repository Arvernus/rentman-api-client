...
from ..models.project_crew_itemput_request_schema_custom import ProjectCrewItemputRequestSchemaCustom
from ..models.project_crew_itemput_request_schema_transport import ProjectCrewItemputRequestSchemaTransport
...
class ProjectCrewItemputRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_crew_itemput_request_schema = cls(
            crewmember=crewmember,
            cost_rate=cost_rate,
            custom=custom,
        ...
        project_crew_itemput_request_schema.additional_properties = d
        return project_crew_itemput_request_schema
