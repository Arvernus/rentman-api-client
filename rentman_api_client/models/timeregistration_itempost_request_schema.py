...
from ..models.timeregistration_itempost_request_schema_type import TimeregistrationItempostRequestSchemaType
...
class TimeregistrationItempostRequestSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_itempost_request_schema = cls(
        ...
        timeregistration_itempost_request_schema.additional_properties = d
