...
from ..models.voertuig_itemget_request_schema_custom import VoertuigItemgetRequestSchemaCustom
from ..models.voertuig_itemget_request_schema_multiple import VoertuigItemgetRequestSchemaMultiple
from ..types import UNSET, Unset

T = TypeVar("T", bound="VoertuigItemgetRequestSchema")


@attr.s(auto_attribs=True)
class VoertuigItemgetRequestSchema:
    """ """
    ...
    multiple: Union[Unset, VoertuigItemgetRequestSchemaMultiple] = UNSET
    image: Union[Unset, None, str] = UNSET
    custom: Union[Unset, VoertuigItemgetRequestSchemaCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_multiple, Unset):
            multiple = VoertuigItemgetRequestSchemaMultiple(_multiple)
        ...
        if not isinstance(_custom, Unset):
            custom = VoertuigItemgetRequestSchemaCustom.from_dict(_custom)

        voertuig_itemget_request_schema = cls(
            folder=folder,
            name=name,
            cost_rate=cost_rate,
        ...
        voertuig_itemget_request_schema.additional_properties = d
        return voertuig_itemget_request_schema
