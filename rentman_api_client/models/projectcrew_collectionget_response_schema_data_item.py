...
from ..models.projectcrew_collectionget_response_schema_data_item_custom import (
    ProjectcrewCollectiongetResponseSchemaDataItemCustom,
)
from ..models.projectcrew_collectionget_response_schema_data_item_transport import (
...
class ProjectcrewCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projectcrew_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
