...
from ..models.timeregistration_itempost_response_schema_data_custom import (
    TimeregistrationItempostResponseSchemaDataCustom,
)
from ..models.timeregistration_itempost_response_schema_data_type import TimeregistrationItempostResponseSchemaDataType
...
class TimeregistrationItempostResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_itempost_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        timeregistration_itempost_response_schema_data.additional_properties = d
        return timeregistration_itempost_response_schema_data
