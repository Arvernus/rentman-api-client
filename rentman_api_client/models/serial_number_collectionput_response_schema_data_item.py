...
from ..models.serial_number_collectionput_response_schema_data_item_custom import (
    SerialNumberCollectionputResponseSchemaDataItemCustom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SerialNumberCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class SerialNumberCollectionputResponseSchemaDataItem:
    """ """
    ...
    custom: Union[Unset, SerialNumberCollectionputResponseSchemaDataItemCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_custom, Unset):
            custom = SerialNumberCollectionputResponseSchemaDataItemCustom.from_dict(_custom)
        ...
        serial_number_collectionput_response_schema_data_item = cls(
            active=active,
        ...
        serial_number_collectionput_response_schema_data_item.additional_properties = d
        return serial_number_collectionput_response_schema_data_item
