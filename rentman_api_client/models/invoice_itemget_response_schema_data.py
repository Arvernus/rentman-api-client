...
T = TypeVar("T", bound="InvoiceItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class InvoiceItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        invoice_itemget_response_schema_data.additional_properties = d
