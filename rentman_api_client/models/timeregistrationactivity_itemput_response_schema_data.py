...
class TimeregistrationactivityItemputResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistrationactivity_itemput_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        timeregistrationactivity_itemput_response_schema_data.additional_properties = d
        return timeregistrationactivity_itemput_response_schema_data
