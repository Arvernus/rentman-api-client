...
T = TypeVar("T", bound="AppointmentCollectionputResponseSchemaDataItem")


@attr.s(auto_attribs=True)
class AppointmentCollectionputResponseSchemaDataItem:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        appointment_collectionput_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
