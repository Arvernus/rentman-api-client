...
from ..models.materiaal_itemget_response_schema_data_country_of_origin import (
    MateriaalItemgetResponseSchemaDataCountryOfOrigin,
)
from ..models.materiaal_itemget_response_schema_data_custom import MateriaalItemgetResponseSchemaDataCustom
from ..models.materiaal_itemget_response_schema_data_is_physical import MateriaalItemgetResponseSchemaDataIsPhysical
from ..models.materiaal_itemget_response_schema_data_rental_sales import MateriaalItemgetResponseSchemaDataRentalSales
from ..models.materiaal_itemget_response_schema_data_stock_management import (
    MateriaalItemgetResponseSchemaDataStockManagement,
)
from ..models.materiaal_itemget_response_schema_data_type import MateriaalItemgetResponseSchemaDataType
from ..types import UNSET, Unset

T = TypeVar("T", bound="MateriaalItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class MateriaalItemgetResponseSchemaData:
    ...
    type: Union[Unset, MateriaalItemgetResponseSchemaDataType] = UNSET
    rental_sales: Union[Unset, MateriaalItemgetResponseSchemaDataRentalSales] = UNSET
    temporary: Union[Unset, bool] = UNSET
    in_planner: Union[Unset, bool] = UNSET
    in_archive: Union[Unset, bool] = UNSET
    stock_management: Union[Unset, MateriaalItemgetResponseSchemaDataStockManagement] = UNSET
    ...
    country_of_origin: Union[Unset, MateriaalItemgetResponseSchemaDataCountryOfOrigin] = UNSET
    ...
    is_physical: Union[Unset, MateriaalItemgetResponseSchemaDataIsPhysical] = UNSET
    ...
    custom: Union[Unset, MateriaalItemgetResponseSchemaDataCustom] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_type, Unset):
            type = MateriaalItemgetResponseSchemaDataType(_type)

        rental_sales: Union[Unset, MateriaalItemgetResponseSchemaDataRentalSales] = UNSET
        _rental_sales = d.pop("rental_sales", UNSET)
        if not isinstance(_rental_sales, Unset):
            rental_sales = MateriaalItemgetResponseSchemaDataRentalSales(_rental_sales)
        ...
        if not isinstance(_stock_management, Unset):
            stock_management = MateriaalItemgetResponseSchemaDataStockManagement(_stock_management)
        ...
        if not isinstance(_country_of_origin, Unset):
            country_of_origin = MateriaalItemgetResponseSchemaDataCountryOfOrigin(_country_of_origin)
        ...
        if not isinstance(_is_physical, Unset):
            is_physical = MateriaalItemgetResponseSchemaDataIsPhysical(_is_physical)
        ...
        if not isinstance(_custom, Unset):
            custom = MateriaalItemgetResponseSchemaDataCustom.from_dict(_custom)

        materiaal_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        materiaal_itemget_response_schema_data.additional_properties = d
        return materiaal_itemget_response_schema_data
