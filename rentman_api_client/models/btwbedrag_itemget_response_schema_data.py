...
T = TypeVar("T", bound="BtwbedragItemgetResponseSchemaData")


@attr.s(auto_attribs=True)
class BtwbedragItemgetResponseSchemaData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        btwbedrag_itemget_response_schema_data = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        btwbedrag_itemget_response_schema_data.additional_properties = d
        return btwbedrag_itemget_response_schema_data
