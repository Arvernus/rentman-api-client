...
from ..models.timeregistration_collectionget_response_schema_data_item_custom import (
    TimeregistrationCollectiongetResponseSchemaDataItemCustom,
)
from ..models.timeregistration_collectionget_response_schema_data_item_type import (
...
class TimeregistrationCollectiongetResponseSchemaDataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        timeregistration_collectionget_response_schema_data_item = cls(
            id=id,
            created=created,
            modified=modified,
            creator=creator,
        ...
        timeregistration_collectionget_response_schema_data_item.additional_properties = d
        return timeregistration_collectionget_response_schema_data_item
